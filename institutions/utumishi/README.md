...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Documents at /documents/ (circular, forms, guidelines). Procurement Management Unit: /pages/procurement-management. Tender paths to be confirmed.
...
notes: |
  Category: Government. Keywords found: procurement.
  Emails: ps@utumishi.go.tz.
...
**Category:** Government
**Website:** https://utumishi.go.tz
**Tender Page:** https://utumishi.go.tz
...
```json
{{
  "tender_id": "UTUMISHI-2026-001",
  "institution": "utumishi",
  ...
  "category": "Government",
  "status": "active",
  "source_url": "https://utumishi.go.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/UTUMISHI-2026-001/original/tender_document.pdf",
