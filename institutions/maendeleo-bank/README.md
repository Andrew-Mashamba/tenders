...
scraping:
  ...
  documents:
    ...
    document_notes: |
      WordPress site — documents typically in /wp-content/uploads/ directory.
...
notes: |
  Has a dedicated tender page. WordPress-based site (index.php URL pattern).
---
