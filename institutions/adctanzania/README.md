---
institution:
  name: "ADC Tanzania Ltd"
  slug: "adctanzania"
  category: "Commercial / Private Sector"
  status: "active"
  country: "Tanzania"
  domain: "adctanzania.co.tz"

website:
  homepage: "https://www.adctanzania.co.tz/"
  tender_url: "https://www.adctanzania.co.tz/"

contact:
  email: "Info@adctanzania.co.tz"
  alternate_emails:
    - "info@adctanzania.co.tz"
  phone: "04 79 0 92"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://www.adctanzania.co.tz/ (Elementor). Check 'Our Opportunities' section for Procurement, Jobs, Consultancy. Currently shows 'There are no current procurement opportunities' - structure exists for when tenders are posted. Look for .elementor-widget, feature-content, or similar."
  selectors:
    container: "main, .elementor-section, .elementor-widget-container, .feature-content"
    tender_item: ".elementor-widget, .feature-item, article"
    title: "h2, h3, h4, h5, h6, .elementor-heading-title"
  ...
  documents:
    ...
    url_patterns:
      - "adctanzania.co.tz/wp-content/uploads/*"
      - "adctanzania.co.tz/*.pdf"
    ...
    document_notes: |
      ADC posts procurement in 'Our Opportunities'. When tenders exist, documents likely in /wp-content/uploads/ or linked from opportunity detail. Currently no active procurement - scraper should detect empty state.
...
social_media:
  linkedin: "adc-tanzania"
  instagram: "adctanzania"
...
**Category:** Commercial / Private Sector
**Website:** https://www.adctanzania.co.tz/
**Tender Page:** https://www.adctanzania.co.tz/
**Keywords Found:** procurement, rfi, rfp
...
- Phone: 0 0 288 512
- Phone: 0 0 576 512
- Phone: +255 222 664 099

## Scraping Instructions

**Strategy:** Scrape https://www.adctanzania.co.tz/ for tender/procurement notices.
**Method:** http_get
...
> ages/sketches/arrow.gif" alt="arrow gif" class="feature-gif"/> Procurement There are no current procurement opportunities. <div class="feature-content"
...
```json
{{
  "tender_id": "ADCTANZANIA-2026-001",
  "institution": "adctanzania",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ADCTANZANIA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.adctanzania.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://www.adctanzania.co.tz/storage/tender.pdf",
      "local_path": "./downloads/ADCTANZANIA-2026-001/original/tender_document.pdf",
