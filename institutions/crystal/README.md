...
website:
  homepage: "https://crystal.co.tz"
  tender_url: "https://crystal.co.tz"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape homepage https://crystal.co.tz. Crystal is a bathroom/kitchen fittings supplier (GROHE & COBRA distributor). They SUBMIT tenders/quotations for supply & installation — they do NOT publish procurement notices. No tender listings on site. Opportunity lead created when no tenders found."
  selectors:
...
notes: |
  Category: Commercial. Bathroom/kitchen fittings supplier. They submit tenders, do not publish. Email: info@crystal.co.tz
---

# Crystal

**Category:** Commercial
**Website:** https://crystal.co.tz
**Tender Page:** https://crystal.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://crystal.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/CRYSTAL-2026-001/original/tender_document.pdf",
