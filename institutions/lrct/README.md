---
institution:
  name: "Law Reform Commission of Tanzania (Tume ya Kurekebisha Sheria Tanzania)"
  slug: "lrct"
...
website:
  homepage: "https://lrct.go.tz/"
  tender_url: "https://lrct.go.tz/"
...
scraping:
  ...
  selectors:
    ...
    title: ".dropdown-item, .text-bold"
    date: ""
    document_link: 'a.dropdown-item[href*=".pdf"], a.dropdown-item[href*=".doc"], a[href*="/uploads/announcements/"]'
    pagination: ""
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "lrct.go.tz/uploads/announcements/*.pdf"
      - "lrct.go.tz/uploads/announcements/*.doc"
    ...
    document_notes: |
      Announcements (Matangazo) in navbar dropdown. Documents at /uploads/announcements/ with pattern en{timestamp}-{NAME}.pdf or .doc
...
social_media:
  instagram: "tumesheria.tanzania"

notes: |
  The Law Reform Commission of Tanzania | Tume ya Kurekebisha Sheria Tanzania
---

# LRCT |   Mwanzo

**Category:** Government Agency
**Website:** https://lrct.go.tz/
**Tender Page:** https://lrct.go.tz/
...
**Strategy:** Scrape https://lrct.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> ternal-audit'>Ukaguzi wa Ndani Manunuzi na Ugavi Sehemu ya Utawala na Rasilimali watu <a class='dropdown-item' href= 'http

### Document Links Found

- https://lrct.go.tz/uploads/announcements/en1725451558-TANGAZO.pdf
- https://lrct.go.tz/uploads/announcements/en1770625940-DODOSO VYOMBO VYA MOTO - MTANDAONI.doc
...
Known document paths: /uploads/announcements/en1725451558-TANGAZO.pdf
...
```json
{{
  "tender_id": "LRCT-2026-001",
  "institution": "lrct",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "LRCT/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://lrct.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://lrct.go.tz/storage/tender.pdf",
      "local_path": "./downloads/LRCT-2026-001/original/tender_document.pdf",
