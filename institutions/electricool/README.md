---
institution:
  name: "Electricool Tanzania Limited"
  slug: "electricool"
  category: "Energy / Mining"
  status: "active"
  country: "Tanzania"
  domain: "electricool.co.tz"

website:
  homepage: "https://electricool.co.tz/"
  tender_url: "https://electricool.co.tz/"

contact:
  phone: "+255 22 270 1575"

scraping:
  enabled: true
  method: "http_get"
  strategy: "WordPress/Elementor site. No dedicated tender page. Scrape homepage and linked pages (About Us, Services, Contact) for procurement notices. Company is prequalified with GPSA; check for tender announcements in main content area."
  selectors:
    container: ".entry-content, main#content, .elementor-widget-container, .site-content"
    tender_item: "article, .elementor-element, .wp-block-group"
    title: "h2, h3, h4, .elementor-heading-title, .wp-block-heading"
  ...
  documents:
    ...
    known_document_paths:
      - "/wp-content/uploads/"
    url_patterns:
      - "electricool.co.tz/wp-content/uploads/*"
      - "electricool.co.tz/*.pdf"
    ...
    document_notes: |
      WordPress site uses /wp-content/uploads/ for documents. No dedicated tender listing page; homepage mentions GPSA prequalification. Check About Us, Services pages for procurement-related content and document links.
...
social_media:
  facebook: "people"
  linkedin: "electricool-tanzania-ltd-16b285124"
  instagram: "electricooltanzania"

notes: |
  Organization website at electricool.co.tz. Tender keywords detected: procurement, supply.
---

# Electricool Tanzania Limited &#8211; Electricool Tanzania Limited is a local company incorporated in 2014 with its core mission to operate as a local contractor specializing in Electrical. The company

**Category:** Energy / Mining
**Website:** https://electricool.co.tz/
**Tender Page:** https://electricool.co.tz/
**Keywords Found:** procurement, supply

## Contact Information
- Phone: +255 22 270 1575
- Phone: 00063747468223
- Phone: 04 119 393 8 2
- Phone: +255 75 267 0733
- Phone: 02-08-2023 

## Scraping Instructions

**Strategy:** Scrape https://electricool.co.tz/ for tender/procurement notices.
**Method:** http_get
...
> a-angle-double-right"> Government Procurement Services Agency-GPSA (Since 2017) <span cl
...
```json
{{
  "tender_id": "ELECTRICOOL-2026-001",
  "institution": "electricool",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ELECTRICOOL/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://electricool.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://electricool.co.tz/storage/tender.pdf",
      "local_path": "./downloads/ELECTRICOOL-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "tenders@electricool.co.tz",
    "phone": "+255 22 270 1575",
    "address": "..."
  }},
