...
website:
  homepage: "https://tcaa.go.tz/"
  tender_url: "https://tcaa.go.tz/page/info?token=bd0e6acfdb63994d366a71bf0fec8b7e235e52b7d291e99c5dc41d83f046cf9457"
...
scraping:
  ...
  selectors:
    ...
    title: "td:first-child, .top-contact a span, a"
    date: "td:nth-child(2), td:nth-child(3)"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[href*="/directdocs/"], a[href*="/docs/"]'
    pagination: ".pagination a, .dataTables_paginate a"
  schedule: "daily"
  ...
  documents:
    ...
    document_notes: |
      Documents stored in /directdocs/ (e.g. directdocs/PROCEDURE_OF_DRONES_IMPORTATION.pdf) and /docs/. Some notices appear in top header banner. Tender page uses token-based URL; token may change—follow Tenders link from homepage if needed.
...
social_media:
  facebook: "tcaa.go.tz"
  twitter: "officialtcaa"
  linkedin: "tanzania-civil-aviation-authority"
  instagram: "officialtcaa"
...
**Category:** Government Agency
**Website:** https://tcaa.go.tz/
**Tender Page:** https://tcaa.go.tz/
...
**Strategy:** Scrape https://tcaa.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> e6acfdb63994d366a71bf0fec8b7e235e52b7d291e99c5dc41d83f046cf9457" > &nbsp;&nbsp;&nbsp;&nbsp;Tenders &nbsp;&nbsp;&nbsp;&nbsp;Security Alerts</sp

### Document Links Found

- https://tcaa.go.tz/docs/PROCEDURE_OF_DRONES_IMPORTATION.pdf
- https://tcaa.go.tz/directdocs/WARAKA KUHUSU MAPENDEKEZO YA TOZO KWA AJILI YA UTEKELEZAJI WA MFUMO WA TAARIFA ZA WASAFIRI KABLA YA KUWASILI.pdf
- https://tcaa.go.tz/directdocs/📢 PUBLIC NOTICE TO THE BUSINESS COMMUNITY.pdf
- https://tcaa.go.tz/directdocs/FEE ON APIS and BORDER SECURITY CASE STATEMENT 16 JUNE 2025.pdf
- https://tcaa.go.tz/directdocs/ANSCustomerSatisfactionSurveyQuestionnaires.doc
...
```json
{{
  "tender_id": "TCAA-2026-001",
  "institution": "tcaa",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TCAA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://tcaa.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://tcaa.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TCAA-2026-001/original/tender_document.pdf",
