...
website:
  homepage: "https://jandproperties.co.tz"
  tender_url: "https://jandproperties.co.tz/en/tenders"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Tender page /en/tenders returns 404. No tender content reachable. Disabled until valid URL found."
  selectors:
...
notes: |
  Category: Commercial. Keywords found: tender, tenders.
  Emails: jandpropertieslimited@gmail.com.
  Discovered by crawler on 2026-03-15.
  ANALYSIS 2026-03-15: /en/tenders returns 404. Homepage /en/ also returns 404. Scraping disabled.
---

# Page not found

**Category:** Commercial
**Website:** https://jandproperties.co.tz
**Tender Page:** https://jandproperties.co.tz/en/tenders

## Scraping Instructions

**Strategy:** Scrape /en/tenders page for tender listings, download all linked documents.
**Method:** http_get
...
```json
{{
  "tender_id": "JANDPROPERTIES-2026-001",
  "institution": "jandproperties",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://jandproperties.co.tz/en/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/JANDPROPERTIES-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "jandpropertieslimited@gmail.com",
    "phone": "",
    "address": ""
  }},
