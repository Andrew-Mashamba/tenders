---
institution:
  name: "Baraza la Manispaa Mjini (Zanzibar Municipal Council)"
  slug: "zmc"
...
website:
  homepage: "https://zmc.go.tz/"
  tender_url: "https://zmc.go.tz/procurement"

contact:
  email: "info@zmc.go.tz"
  phone: "024-2231330"
...
scraping:
  ...
  selectors:
    ...
    date: "td:nth-child(4), td:nth-child(5)"
    document_link: 'td a[href$=".pdf"], td a[href$=".doc"], td a[href*=".pdf"]'
    pagination: null
  schedule: "daily"
  ...
  documents:
    ...
    document_notes: |
      ZMC procurement page uses Bootstrap tabs. Table columns: JINA LA TENDA (tender name), NAMBA YA TENDA (ref no), TAREHE YA TENDA (tender date), MWISHO WA MAOMBI (application deadline), BEI YA TENDA (tender price). Documents may be linked from table cells. When table shows HAKUNA TAARIFA, no tenders are active.
...
social_media:
  facebook: "umczanzibar"

notes: |
  Organization website at zmc.go.tz. Tender keywords detected: manunuzi, procurement.
---

# Manispaa-Mjini

**Category:** Local Government Authority
**Website:** https://zmc.go.tz/
**Tender Page:** https://zmc.go.tz/procurement
...
**Strategy:** Scrape https://zmc.go.tz/procurement for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> manunuzi msaada <a class="nav-link scrollto" href="https://zmc.go.tz/con

### Known Tender URLs

- https://zmc.go.tz/procurement
...
```json
{{
  "tender_id": "ZMC-2026-001",
  "institution": "zmc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ZMC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://zmc.go.tz/procurement",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://zmc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/ZMC-2026-001/original/tender_document.pdf",
