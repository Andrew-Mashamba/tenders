...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "airtanzania.co.tz"

website:
  homepage: "https://airtanzania.co.tz/"
  tender_url: "https://airtanzania.co.tz/tenders"

contact:
  email: "info@airtanzania.co.tz"
  phone: "+255 748 773 900 "
...
scraping:
  ...
  selectors:
    ...
    title: "h2[itemprop='headline'], .page-header h2, a[href*='tender']"
    date: ".date, time"
  ...
  documents:
    ...
    document_notes: |
      Joomla CMS. Tender page at /tenders - articleBody div was empty on fetch. Content may load via com_content or require JS. Document paths TBD when tender content is available.
...
social_media:
  facebook: "airtanzania"
  twitter: "airtanzania"
  linkedin: "air-tanzania-company-limited"
  instagram: "airtanzania_atcl"

notes: |
  Organization website at airtanzania.co.tz. Tender keywords detected: rfi, tender, tenders.
---

# Air Tanzania | The Wings Of Kilimanjaro

**Category:** Commercial / Private Sector
**Website:** https://airtanzania.co.tz/
**Tender Page:** https://airtanzania.co.tz/tenders
**Keywords Found:** rfi, tender, tenders

## Contact Information
- Email: info@airtanzania.co.tz
- Phone: +255 748 773 900 
- Phone: 06450333789172

## Scraping Instructions

**Strategy:** Scrape https://airtanzania.co.tz/tenders for tender/procurement notices.
**Method:** http_get
...
> > Careers Tenders Videos <div class="c

### Known Tender URLs

- https://airtanzania.co.tz/tenders
...
```json
{{
  "tender_id": "AIRTANZANIA-2026-001",
  "institution": "airtanzania",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "AIRTANZANIA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://airtanzania.co.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://airtanzania.co.tz/storage/tender.pdf",
      "local_path": "./downloads/AIRTANZANIA-2026-001/original/tender_document.pdf",
