...
website:
  homepage: "https://www.tadb.co.tz/"
  tender_url: "https://www.taneps.go.tz/epps/prepareViewCAOrganisation.do?id=4736"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Government agricultural bank. All procurement via TANePS. Documents may require TANePS login.
...
notes: |
  Government agricultural bank. No dedicated tender page on own website. Uses TANePS for all procurement.
---
...
**Tender Page:** https://www.taneps.go.tz/epps/prepareViewCAOrganisation.do?id=4736  
