...
website:
  homepage: "https://kapital.co.tz"
  tender_url: "https://kapital.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    Account suspended by hosting provider. Page returns "This Account has been suspended."
    Re-enable when site is restored.
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Site unreachable (account suspended). Re-enable when restored.
...
**Category:** Commercial
**Website:** https://kapital.co.tz
**Tender Page:** https://kapital.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://kapital.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KAPITAL-2026-001/original/tender_document.pdf",
