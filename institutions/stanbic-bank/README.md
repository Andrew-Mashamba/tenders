...
website:
  homepage: "https://www.stanbicbank.co.tz/"
  tender_url: "null"

scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. Part of Standard Bank Group (South Africa)."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
  ...
  documents:
    ...
    url_patterns:
      - "www.stanbicbank.co.tz/*.pdf"
      - "www.stanbicbank.co.tz/*.docx"
      - "www.stanbicbank.co.tz/*.xlsx"
...
notes: |
  No tender page found. Part of Standard Bank Group. Procurement may be centralized.
---
