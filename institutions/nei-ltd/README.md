...
website:
  homepage: "https://nei-ltd.co.tz"
  tender_url: "http://nei-ltd.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Homepage redirects to nei-ltd.com. No tender listing - company site with RFQ/sustainability content. Scrape main content area for document links. One PDF found: Sustainability Report at nei-ltd.com/wp-content/uploads/2025/06/."
  selectors:
    container: "main, .content, .entry-content, article"
    tender_item: "article, .card, section"
  ...
  documents:
    ...
    known_document_paths:
      ...
      - "nei-ltd.com/wp-content/uploads/"

    url_patterns:
      - "nei-ltd.com/wp-content/uploads/2025/06/*.pdf"
      - "nei-ltd.co.tz/*"
    ...
    document_notes: |
      Site redirects nei-ltd.co.tz → nei-ltd.com. Documents at nei-ltd.com/wp-content/uploads/2025/06/ (e.g. NEI-ESG-Report-2024-FINAL-2nc.pdf). No traditional tender table - scan for RFQ/supply document links.
...
notes: |
  Category: Commercial. Keywords found: rfq.
  Emails: None found yet.
  Discovered by crawler on 2026-03-15.
---

# Sustainably Sourced Industrial Ingredients

**Category:** Commercial
**Website:** https://nei-ltd.co.tz
**Tender Page:** http://nei-ltd.co.tz
...
Known document paths: /wp-content/uploads/2025/06/
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "http://nei-ltd.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/NEI-LTD-2026-001/original/tender_document.pdf",
