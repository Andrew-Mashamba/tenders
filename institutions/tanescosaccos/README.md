---
institution:
  name: "TANESCO SACCOS LTD – Suluhisho la Mtaji"
  slug: "tanescosaccos"
  category: "NGO / Non-Profit Organization"
  status: "active"
  country: "Tanzania"
  domain: "tanescosaccos.or.tz"

website:
  homepage: "https://tanescosaccos.or.tz/"
  tender_url: "https://tanescosaccos.or.tz/zabuni/"

contact:
  email: "info.saccos@tanescosaccos.or.tz"
  phone: "01 0 0 0-"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://tanescosaccos.or.tz/zabuni/ for tender/procurement notices. WordPress site; zabuni page has minimal content (address, Machapisho link). Documents in /wp-content/uploads/. Check Machapisho (machapisho/) for publications. Loan Calculator at /wp-content/uploads/2022/11/LOAN-CALCULATOR.xls."
  selectors:
    container: ".entry-content, .wp-block-post-content, main, .page-content, article"
    tender_item: "article, .wp-block-group, .wp-block-column, a[href*='/machapisho/']"
    title: "h2, h3, h4, .tender-title, a"
    date: ".date, .closing-date, .published, time"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[href$=".xls"], a[href*="/wp-content/uploads/"]'
  ...
  documents:
    ...
    url_patterns:
      - "tanescosaccos.or.tz/wp-content/uploads/"
      - "tanescosaccos.or.tz/wp-content/uploads/2022/11/LOAN-CALCULATOR.xls"
    ...
    document_notes: |
      WordPress site. Documents in /wp-content/uploads/ (e.g. /wp-content/uploads/2022/11/LOAN-CALCULATOR.xls). Zabuni page is minimal; Machapisho (machapisho/) may have publications. No traditional tender listing table.
...
social_media:
  facebook: "Tanesco"
  twitter: "tanescosaccos"
  instagram: "tanescosaccos_officialpage"

notes: |
  Organization website at tanescosaccos.or.tz. Tender keywords detected: bid, quotation, rfi, zabuni.
---

# TANESCO SACCOS LTD &#8211; Suluhisho la Mtaji

**Category:** NGO / Non-Profit Organization
**Website:** https://tanescosaccos.or.tz/
**Tender Page:** https://tanescosaccos.or.tz/zabuni/
**Keywords Found:** bid, quotation, rfi, zabuni
...
**Strategy:** Scrape https://tanescosaccos.or.tz/zabuni/ for tender/procurement notices.
**Method:** http_get
...
> menu-item-type-post_type menu-item-object-page menu-item-2659"> Zabuni <div id="footer-widgets-middle" class="footer-widgets widgets-area footer-m

### Known Tender URLs

- https://tanescosaccos.or.tz/zabuni/

### Document Links Found

- https://tanescosaccos.or.tz/wp-content/uploads/2022/11/LOAN-CALCULATOR.xls
...
Known document paths: /wp-content/uploads/2022/11/LOAN-CALCULATOR.xls
...
```json
{{
  "tender_id": "TANESCOSACCOS-2026-001",
  "institution": "tanescosaccos",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TANESCOSACCOS/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://tanescosaccos.or.tz/zabuni/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://tanescosaccos.or.tz/storage/tender.pdf",
      "local_path": "./downloads/TANESCOSACCOS-2026-001/original/tender_document.pdf",
