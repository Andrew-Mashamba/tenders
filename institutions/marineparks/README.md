---
institution:
  name: "Marine Parks and Reserves Unit (MPR)"
  slug: "marineparks"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "marineparks.go.tz"

website:
  homepage: "https://marineparks.go.tz/"
  tender_url: "https://marineparks.go.tz/publications/tenders"

contact:
  email: "marineparks@marineparks.go.tz"
  phone: "0515726301"
...
scraping:
  ...
  selectors:
    ...
    title: "a"
    date: "text preceding link (DD Mon, YYYY format)"
    document_link: 'a[href*="/uploads/documents/"], a[href$=".pdf"], a[href$=".xls"], a[href$=".xlsx"]'
    pagination: null 
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/uploads/documents/"
    url_patterns:
      - "marineparks.go.tz/uploads/documents/*"
      - "marineparks.go.tz/*.pdf"
      - "marineparks.go.tz/*.xls"
      - "marineparks.go.tz/*.xlsx"
    ...
    document_notes: |
      Documents at marineparks.go.tz/uploads/documents/ with sw-{timestamp}-{filename} naming (e.g. sw-1684760447-Annual%20Procurement%20Plan%20TANeps.%202022-23.%20GPN.xls). Include .xls, .xlsx for procurement plans.
...
social_media:
  facebook: "Marineparksandreservesunit"
  twitter: "ParksReserves"
  instagram: "marineparks_and_reserves_tz"
...
**Category:** Government Agency
**Website:** https://marineparks.go.tz/
**Tender Page:** https://marineparks.go.tz/publications/tender1
...
**Strategy:** Scrape https://marineparks.go.tz/publications/tender1 for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> ass='list-inline-item'> Zabuni Nafasi za kazi <a class=

### Known Tender URLs

- https://marineparks.go.tz/publications/tender1
- https://marineparks.go.tz/publications/tenders
...
```json
{{
  "tender_id": "MARINEPARKS-2026-001",
  "institution": "marineparks",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MARINEPARKS/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://marineparks.go.tz/publications/tender1",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://marineparks.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MARINEPARKS-2026-001/original/tender_document.pdf",
