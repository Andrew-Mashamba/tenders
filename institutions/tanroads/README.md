...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "tanroads.go.tz"

website:
  homepage: "https://tanroads.go.tz/"
  tender_url: "https://tanroads.go.tz/tenders/open"

contact:
  phone: "01667684071834"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://tanroads.go.tz/tenders/open for Open Tenders. Yii framework. Table with columns #, Name, Tender No., Region, Deadline. Click Name link to /tenders/view/{id} for details. Documents via /tenders/download/{id}."
  selectors:
    container: "#w1.grid-view, .projects-search, .main .content"
    tender_item: "table.table tbody tr"
    title: "td:nth-child(2) a"
    date: "td:nth-child(5)"
    document_link: 'a[href*="/tenders/download/"], a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"]'
  ...
  documents:
    ...
    known_document_paths:
      ...
      - "/common/attachments/"
    url_patterns:
      - "tanroads.go.tz/tenders/download/*"
      - "tanroads.go.tz/uploads/files/*"
      - "tanroads.go.tz/common/attachments/*"
    ...
    document_notes: |
      Tender documents via /tenders/download/{id} on detail page. General files in /uploads/files/ and /common/attachments/. Follow Name link to /tenders/view/{id} for ATTACHMENT download link.
...
social_media:
  facebook: "p"
  instagram: "tanroadshq"

notes: |
  Organization website at tanroads.go.tz. Tender keywords detected: bid, procurement, rfi, tender, tenders, zabuni.
---

# TANROADS Official Website :: Home

**Category:** Government Agency
**Website:** https://tanroads.go.tz/
**Tender Page:** https://tanroads.go.tz/tenders/open
**Keywords Found:** bid, procurement, rfi, tender, tenders, zabuni

## Contact Information
- Phone: 01667684071834
- Phone: +255 22 2926000
- Phone: +255 22 2926001
- Phone: 00082776587845

## Scraping Instructions

**Strategy:** Scrape https://tanroads.go.tz/tenders/open for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> Open Tenders Awarded Tenders<

### Known Tender URLs

- https://tanroads.go.tz/tenders/open
- https://tanroads.go.tz/tenders/tor
- https://tanroads.go.tz/tenders/archive
- https://tanroads.go.tz/tenders/addenda-clarifications-minutes-of-pre-bid-meeting
- https://tanroads.go.tz/tenders
- https://tanroads.go.tz/tenders/view/496
- https://tanroads.go.tz/projects/under-procurement
- https://tanroads.go.tz/directorates/5/procurement-and-contracts
- https://tanroads.go.tz/tenders/disclosure
- https://tanroads.go.tz/tenders/awarded

### Document Links Found

- https://tanroads.go.tz/common/attachments/vacancy/ce35f7f02efb93a96ee47a2e9990b55d.pdf
- https://tanroads.go.tz/common/attachments/road_networks/trunk_roads_map.pdf
- https://tanroads.go.tz/uploads/files/Trunk_and_Regional_Road_Map.pdf
- https://tanroads.go.tz/common/attachments/vacancy/7b5e8c3a377f518cf2fdc96c12ed295d.pdf
- https://tanroads.go.tz/uploads/files/Tanzania_Road_Distance_Chart.pdf
- https://tanroads.go.tz/common/attachments/vacancy/5435e925283584ce8a50ad42a3461984.pdf
- https://tanroads.go.tz/common/attachments/vacancy/44e47884e226b544e55ced059279e4ac.pdf
...
Known document paths: /uploads/files/Tanzania_Road_Distance_Chart.pdf, /uploads/files/Trunk_and_Regional_Road_Map.pdf
...
```json
{{
  "tender_id": "TANROADS-2026-001",
  "institution": "tanroads",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TANROADS/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://tanroads.go.tz/tenders/open",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://tanroads.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TANROADS-2026-001/original/tender_document.pdf",
