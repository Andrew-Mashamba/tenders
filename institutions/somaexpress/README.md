...
website:
  homepage: "https://somaexpress.co.tz"
  tender_url: "https://somaexpress.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Homepage has no tender/procurement content. Soma General Traders is a logistics/trading company. No tender listings found. Disable until dedicated tender page is discovered."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender documents on homepage. /images/ may hold marketing assets. No procurement section found.
...
notes: |
  ...
  Emails: info@soma.co.tz.
  Discovered by crawler on 2026-03-15.
---

# Soma General Traders

**Category:** Commercial
**Website:** https://somaexpress.co.tz
**Tender Page:** https://somaexpress.co.tz
...
```json
{{
  "tender_id": "SOMAEXPRESS-2026-001",
  "institution": "somaexpress",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://somaexpress.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/SOMAEXPRESS-2026-001/original/tender_document.pdf",
