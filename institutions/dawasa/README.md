---
institution:
  name: "DAWASA - Mamlaka ya Maji Safi na Usafi wa Mazingira Dar es Salaam"
  slug: "dawasa"
...
website:
  homepage: "https://dawasa.go.tz/"
  tender_url: "https://nest.go.tz/tenders/published-tenders?peUuid=909213a5-d69b-433f-aa3b-e4b753fb8ce5"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "DAWASA tenders are hosted on NeST (National e-Procurement System). The page is an Angular SPA - content loads via JavaScript. Use headless browser (Puppeteer/Playwright) or wait for API calls. Tenders appear in a dynamic table/card list after page load. Filter by peUuid=909213a5-d69b-433f-aa3b-e4b753fb8ce5 for DAWASA-specific notices."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      NeST is a government e-procurement portal. Document URLs are generated dynamically. Tender documents may be attached to individual tender records in the SPA. Check API responses or rendered DOM for document links after page load.
...
# DAWASA |   Mamlaka ya Majisafi na Usafi wa Mazingira Dar es Salaam (DAWASA) - Mwanzo

**Category:** Water Utility
**Website:** https://dawasa.go.tz/
**Tender Page:** https://nest.go.tz/tenders/published-tenders?peUuid=909213a5-d69b-433f-aa3b-e4b753fb8ce5
**Keywords Found:** supply, tender, tenders, zabuni
...
**Strategy:** Scrape https://nest.go.tz/tenders/published-tenders?peUuid=909213a5-d69b-433f-aa3b-e4b753fb8ce5 for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> er' href='https://nest.go.tz/tenders/published-tenders?peUuid=909213a5-d69b-433f-aa3b-e4b753fb8ce5'>Zabuni Barua Pepe za Wafanyakazi <a href='https:

### Known Tender URLs

- https://nest.go.tz/tenders/published-tenders?peUuid=909213a5-d69b-433f-aa3b-e4b753fb8ce5
...
```json
{{
  "tender_id": "DAWASA-2026-001",
  "institution": "dawasa",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "DAWASA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://nest.go.tz/tenders/published-tenders?peUuid=909213a5-d69b-433f-aa3b-e4b753fb8ce5",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://dawasa.go.tz/storage/tender.pdf",
      "local_path": "./downloads/DAWASA-2026-001/original/tender_document.pdf",
