...
website:
  homepage: "https://ths.or.tz"
  tender_url: "https://ths.or.tz"

scraping:
  enabled: true
  method: "http_get"
  strategy: |
    WordPress site. No dedicated tender listing page - tenders/documents appear on
    homepage and subpages. Documents in /wp-content/uploads/YYYY/MM/. Follow
    document links (e.g. impact_THS.pdf) and program pages (conference, medical-expo).
  selectors:
    container: "main, .entry-content, .page-content, article, .elementor-widget-container"
    tender_item: "article, .tender-item, .card, a[href$='.pdf']"
  ...
  documents:
    ...
    url_patterns:
      - "ths.or.tz/wp-content/uploads/2022/06/*.pdf"
      - "ths.or.tz/wp-content/uploads/2023/09/*.pdf"
      - "ths.or.tz/wp-content/uploads/2024/09/*.pdf"
      - "ths.or.tz/wp-content/uploads/2025/10/*.pdf"
      - "ths.or.tz/wp-content/uploads/2026/02/*.pdf"
    ...
    document_notes: |
      Documents found under /wp-content/uploads/2022/06/, /wp-content/uploads/2023/09/, /wp-content/uploads/2024/09/. Check for additional paths during scraping.
...
**Category:** NGO/Non-Profit
**Website:** https://ths.or.tz
**Tender Page:** https://ths.or.tz
...
Known document paths: /wp-content/uploads/2022/06/, /wp-content/uploads/2023/09/, /wp-content/uploads/2024/09/, /wp-content/uploads/2025/10/, /wp-content/uploads/2026/02/
...
{{
  ...
  "category": "NGO/Non-Profit",
  "status": "active",
  "source_url": "https://ths.or.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/THS-2026-001/original/tender_document.pdf",
