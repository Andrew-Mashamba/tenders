---
institution:
  name: "GCLA | MAMLAKA YA MAABARA YA MKEMIA MKUU WA SERIKALI - Mwanzo"
  slug: "gcla"
...
website:
  homepage: "https://gcla.go.tz/"
  tender_url: "https://gcla.go.tz/announcements"
...
scraping:
  ...
  selectors:
    ...
    title: "h2, h3, h4, .announcement-title, .tender-title, a"
    date: ".date, .closing-date, .published, time"
    document_link: 'a[href$=".pdf"], a[href*="portal.gcla.go.tz/jarida/"], a[href$=".doc"], a[href$=".docx"], a[download]'
    pagination: ".pagination a, a.next, .nav-links a, a[href*='View All']" 
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "portal.gcla.go.tz/jarida/"
    url_patterns:
      - "gcla.go.tz/announcements/*"
      - "portal.gcla.go.tz/jarida/*.pdf"
    ...
    document_notes: |
      Government Chemist (GCLA). Matangazo (announcements) at /announcements. PDFs at portal.gcla.go.tz/jarida/ (e.g. newsletter, price lists).
...
social_media:
  facebook: "gclatanzania"
  twitter: "gcla1895"
  instagram: "gcla_official"

notes: |
  Mamlaka ya Mabaara ya Mkemia Mkuu wa Serikali (MMS) ilianzishwa chini ya Sheria ya Mamlaka ya Maabara ya Mkemia Mkuu wa Serikali Na.8 ya Mwaka 2016 | MAMLAKA YA MAABARA YA MKEMIA MKUU WA SERIKALI - Mwanzo
---

# GCLA | MAMLAKA YA MAABARA YA MKEMIA MKUU WA SERIKALI - Mwanzo

**Category:** Government Agency
**Website:** https://gcla.go.tz/
**Tender Page:** https://gcla.go.tz/
...
- Phone: 0262161630
- Phone: +255 27 2506394   

## Scraping Instructions

**Strategy:** Scrape https://gcla.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> tengo cha Taifa cha Kudhibiti Sumu Kitengo cha Usimamizi wa Ununuzi Kitengo cha Udhibiti Ubora

### Document Links Found

- https://portal.gcla.go.tz/jarida/FINAL_MKEMIA_NEWSLETTER_2024_2025.pdf
...
```json
{{
  "tender_id": "GCLA-2026-001",
  "institution": "gcla",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "GCLA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://gcla.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://gcla.go.tz/storage/tender.pdf",
      "local_path": "./downloads/GCLA-2026-001/original/tender_document.pdf",
