...
website:
  homepage: "https://tdb.go.tz/"
  tender_url: "https://tdb.go.tz/"

contact:
  email: "barua@tdb.go.tz"
  phone: "+255 734 312 428"

scraping:
  enabled: false
  method: "http_get"
  strategy: "TDB (Tanzania Dairy Board) posts tenders on Facebook (FURSA Zabuni). Main site tdb.go.tz has no dedicated tender page. Facebook cannot be scraped via HTTP. Scrape tdb.go.tz homepage for any tender links; check nav for Zabuni/Nafasi za Kazi."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Tenders posted on Facebook. Main site tdb.go.tz has no tender listing. Scraping disabled until tender page is available on tdb.go.tz.
...
notes: |
  Tanzania Dairy Board | Bodi ya Maziwa Tanzania
---

# TDB |   JAMHURI YA MUUNGANO WA TANZANIA, - MWANZO

**Category:** Government Agency
**Website:** https://tdb.go.tz/
**Tender Page:** https://m.facebook.com/story.php?story_fbid=pfbid0GUUPUDcwQRYLnU5r2NtUHKNZK8gBqXdHZcZMFzvNUmrQZhWh4NxUZFvWthhNdxpYl&amp;id=100066659524164
...
- Phone: 0 25 0 0 43
- Phone: 0690426963
- Phone: 00066659524164
- Phone: 0 0 25 0 75 43

## Scraping Instructions

**Strategy:** Scrape https://m.facebook.com/story.php?story_fbid=pfbid0GUUPUDcwQRYLnU5r2NtUHKNZK8gBqXdHZcZMFzvNUmrQZhWh4NxUZFvWthhNdxpYl&amp;id=100066659524164 for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> ef='#' class='nav-link' data-toggle='drop'>FURSA Zabuni Nafasi za Kazi <!-- <div class="position-absolute search-toggle top-right text-white text-hover-secondary h

### Known Tender URLs

- https://m.facebook.com/story.php?story_fbid=pfbid0GUUPUDcwQRYLnU5r2NtUHKNZK8gBqXdHZcZMFzvNUmrQZhWh4NxUZFvWthhNdxpYl&amp;id=100066659524164
...
```json
{{
  "tender_id": "TDB-2026-001",
  "institution": "tdb",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TDB/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://m.facebook.com/story.php?story_fbid=pfbid0GUUPUDcwQRYLnU5r2NtUHKNZK8gBqXdHZcZMFzvNUmrQZhWh4NxUZFvWthhNdxpYl&amp;id=100066659524164",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://tdb.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TDB-2026-001/original/tender_document.pdf",
