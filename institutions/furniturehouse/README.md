...
website:
  homepage: "https://furniturehouse.co.tz"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      No tender documents. Site is furniture e-commerce only. Scraping disabled.
...
notes: |
  Category: Commercial. Website analysis (2026-03-15): furniturehouse.co.tz is a furniture e-commerce site (WooCommerce/Elementor). No tender or procurement content. Scraping disabled.
  Emails: dodoma@furniturehouse.co.tz, arusha@furniturehouse.co.tz, nyanza@furniturehouse.co.tz, info@furniturehouse.co.tz, geita@furniturehouse.co.tz.
...
**Category:** Commercial
**Website:** https://furniturehouse.co.tz
**Tender Page:** https://furniturehouse.co.tz
...
```json
{{
  "tender_id": "FURNITUREHOUSE-2026-001",
  "institution": "furniturehouse",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://furniturehouse.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/FURNITUREHOUSE-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "dodoma@furniturehouse.co.tz",
    "phone": "",
    "address": ""
  }},
