---
institution:
  name: "Mzumbe University (MU), Tanzania"
  slug: "mzumbe"
  category: "Academic"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://mzumbe.ac.tz"
  tender_url: "https://mzumbe.ac.tz"
...
scraping:
  ...
  documents:
    ...
    url_patterns:
      - "mzumbe.ac.tz/media/filer_public/*.doc"
      - "mzumbe.ac.tz/media/filer_public/*.pdf"
    ...
    document_notes: |
      Documents found under /media/filer_public/. Check for additional paths during scraping.
...
notes: |
  ...
  Emails: mu@mu.acetz, mu@mu.ac.tz, barua@mu.ac.tz.
...
**Category:** Academic
**Website:** https://mzumbe.ac.tz
**Tender Page:** https://mzumbe.ac.tz
...
Known document paths: /media/filer_public/
...
{{
  ...
  "category": "Academic",
  "status": "active",
  "source_url": "https://mzumbe.ac.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MZUMBE-2026-001/original/tender_document.pdf",
