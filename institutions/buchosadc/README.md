...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "buchosadc.go.tz"

website:
  homepage: "https://buchosadc.go.tz/"
  tender_url: "https://buchosadc.go.tz/tenders"

contact:
  email: "ded@buchosadc.go.tz"
  phone: "017-07-27"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://buchosadc.go.tz/tenders. Uses OctoberCMS/GWF table layout. Parse table.table.table-striped tbody tr for each tender; td[1]=title, td[2]=date added, td[3]=expire date, td[4] a=document link. Documents at /storage/app/uploads/public/."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "buchosadc.go.tz/storage/app/uploads/public/*"
    ...
    document_notes: |
      OctoberCMS/GWF layout. Documents stored at /storage/app/uploads/public/{hash}/{hash}.{ext}. Pattern: /storage/app/uploads/public/XXX/XXX/XXX/filename.pdf. Supports PDF, JPG. Each table row has one Download link in 4th column.
...
# Home &#124; Buchosa District Council

**Category:** Local Government Authority
**Website:** https://buchosadc.go.tz/
**Tender Page:** https://buchosadc.go.tz/tenders
...
**Strategy:** Scrape https://buchosadc.go.tz/tenders for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> ome-page-title">Zabuni Soma zaidi Jina La Zabuni

### Known Tender URLs

- https://buchosadc.go.tz/tenders
...
Known document paths: /storage/app/uploads/public/667/d64/963/667d649639df3613803168.pdf, /storage/app/uploads/public/5de/1ae/654/5de1ae654cb2f326088574.pdf, /storage/app/uploads/public/59c/b9e/13a/59cb9e13a71e1854195128.pdf
...
```json
{{
  "tender_id": "BUCHOSADC-2026-001",
  "institution": "buchosadc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "BUCHOSADC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://buchosadc.go.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://buchosadc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/BUCHOSADC-2026-001/original/tender_document.pdf",
