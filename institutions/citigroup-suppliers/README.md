---
institution:
  name: "Citigroup Global Suppliers Portal"
  slug: "citigroup-suppliers"
  category: "Global Procurement Portal"
  status: "active"
  country: "International"

website:
  homepage: "https://www.citigroup.com/"
  tender_url: "https://www.citigroup.com/global/our-impact/suppliers"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape the global Citigroup suppliers page. Filter for Tanzania or Africa-related procurement. Citibank Tanzania is a branch of Citigroup — local procurement flows through this global portal. Expect structured, corporate procurement format."
  selectors:
    container: ".suppliers, .content, main, .procurement"
    tender_item: "article, .card, .opportunity, .listing-item"
    title: "h2, h3, .title"
    date: ".date, .deadline"
    region_filter: "Tanzania, Africa, Sub-Saharan Africa"
    document_link: "a[href$='.pdf'], a[download]"
  schedule: "weekly"
  ...
  documents:
    ...
    document_notes: |
      Corporate portal. Rare Tanzania-specific documents.
...
notes: |
  Global supplier portal for Citigroup/Citibank worldwide operations. Citibank Tanzania
  does not have its own local tender page — all procurement is handled centrally through
  this global portal. Tanzania-specific opportunities are rare but high-value when they appear.
  Filter by region (Africa/Sub-Saharan Africa/Tanzania).
  Related institution folder: citibank
  UPDATE 2026-03-15: tender_url https://www.citigroup.com/global/our-impact/suppliers returned 404.
  Suppliers page may have been moved or restructured.
---

# Citigroup Global Suppliers Portal

**Category:** Global Procurement Portal
**Website:** https://www.citigroup.com/
**Tender Page:** https://www.citigroup.com/global/our-impact/suppliers

## Scraping Instructions

**Strategy:** Scrape global suppliers page, filter for Tanzania/Africa region.
**Method:** http_get (may require JavaScript rendering)

## Relationship to Citibank Tanzania

- Citibank Tanzania (see `citibank` folder) has no local tender page
- All procurement goes through this global Citigroup suppliers portal
- Tanzania-specific tenders are infrequent but high-value

## Notes

Corporate portal. May require JavaScript rendering. Rate limit to avoid blocks.
...
{{
  ...
  "institution": "citigroup-suppliers",
