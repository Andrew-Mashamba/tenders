...
website:
  homepage: "https://www.tuwasa.go.tz/"
  tender_url: "https://www.tuwasa.go.tz/publications/tender"

contact:
  email: "maji@tuwasa.go.tz"
  phone: "0800780063"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://www.tuwasa.go.tz/publications/tender for government tender notices. Government sites often post zabuni/manunuzi."
  selectors:
...
social_media:
  facebook: "tuwasa.tabora.3"
  instagram: "tuwasa_tabora"

notes: |
  Tabora Urban Water and Sanitation Authority (TUWASA) was established for supplying water and sanitation services in Tabora region. | Mamlaka ya Majisafi na Usafi wa Mazingira Mjini Tabora (TUWASA) ilianzishwa kwa ajili ya kusambaza huduma za majisafi na usafi wa mazingira mkoani Tabora.
---

# TUWASA |   Mwanzo

**Category:** Water Utility
**Website:** https://www.tuwasa.go.tz/
**Tender Page:** https://www.tuwasa.go.tz/publications/tender
**Keywords Found:** supply, tender, zabuni
...
> >Wasiliana Nasi Zabuni Barua Pepe

### Known Tender URLs

- https://www.tuwasa.go.tz/publications/tender
...
```json
{{
  "tender_id": "TUWASA-2026-001",
  "institution": "tuwasa",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TUWASA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.tuwasa.go.tz/publications/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://www.tuwasa.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TUWASA-2026-001/original/tender_document.pdf",
