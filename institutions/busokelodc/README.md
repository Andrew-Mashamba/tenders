...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "busokelodc.go.tz"

website:
  homepage: "https://busokelodc.go.tz/"
  tender_url: "https://busokelodc.go.tz/procurement-and-supplies"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Site migrated to GWF CORE React SPA (2026-06). /tenders and /procurement-and-supplies render client-side; scrape JSON APIs instead: /api/announcements (local zabuni) and /api/from-tamisemi (TAMISEMI feed). Filter category=Zabuni. Documents at /minio/busokelodc.go.tz/attachments/ and /minio/tamisemi.go.tz/attachments/."
  selectors:
    container: "#root"
  ...
  documents:
    ...
    known_document_paths:
      - "/minio/busokelodc.go.tz/attachments/"
      - "/minio/tamisemi.go.tz/attachments/"
    url_patterns:
      - "busokelodc.go.tz/minio/busokelodc.go.tz/attachments/*"
      - "busokelodc.go.tz/minio/tamisemi.go.tz/attachments/*"
    download_rules:
      max_file_size_mb: 50
      timeout_seconds: 60
      retry_attempts: 3
    ...
    document_notes: |
      GWF CORE SPA as of 2026-06. Use REST APIs for tender data. Local docs at /minio/busokelodc.go.tz/attachments/; TAMISEMI syndicated docs at /minio/tamisemi.go.tz/attachments/.
...
social_media:
  facebook: "ded.busokelo"

notes: |
  A default home page
---

# Home &#124; Busokelo District Council

**Category:** Local Government Authority
**Website:** https://busokelodc.go.tz/
**Tender Page:** https://busokelodc.go.tz/procurement-and-supplies
...
**Strategy:** Scrape https://busokelodc.go.tz/procurement-and-supplies for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> me-page-title">Zabuni Zaidi Jina la Zabuni

### Known Tender URLs

- https://busokelodc.go.tz/procurement-and-supplies
- https://busokelodc.go.tz/tenders

### Document Links Found

- https://busokelodc.go.tz/storage/app/uploads/public/684/15d/748/68415d748b8b7565079505.pdf
- https://busokelodc.go.tz/storage/app/uploads/public/59b/659/b4d/59b659b4dfee3362835390.pdf
- https://busokelodc.go.tz/storage/app/uploads/public/628/5dd/e22/6285dde222327481253266.pdf
- https://busokelodc.go.tz/storage/app/uploads/public/5a6/222/338/5a62223384714648821154.pdf
- https://busokelodc.go.tz/storage/app/uploads/public/666/198/ecb/666198ecbdc4e859026186.pdf
- https://busokelodc.go.tz/storage/app/uploads/public/58d/e57/9b9/58de579b9c018160952337.pdf
- https://busokelodc.go.tz/storage/app/uploads/public/59b/a6b/425/59ba6b4250a9c467724778.pdf
...
Known document paths: /storage/app/uploads/public/628/5dd/e22/6285dde222327481253266.pdf, /storage/app/uploads/public/666/198/ecb/666198ecbdc4e859026186.pdf, /storage/app/uploads/public/684/15d/748/68415d748b8b7565079505.pdf
...
```json
{{
  "tender_id": "BUSOKELODC-2026-001",
  "institution": "busokelodc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "BUSOKELODC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://busokelodc.go.tz/procurement-and-supplies",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://busokelodc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/BUSOKELODC-2026-001/original/tender_document.pdf",
...
- **Signal Strength:** Strong (GWF API; no local announcements as of 2026-06-10)
