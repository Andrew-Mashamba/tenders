...
website:
  homepage: "http://watsaccos.or.tz/"
  tender_url: "null"

scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. One of Tanzania's largest SACCOs."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
  ...
  documents:
    ...
    url_patterns:
      - "watsaccos.or.tz/*.pdf"
      - "watsaccos.or.tz/*.docx"
      - "watsaccos.or.tz/*.xlsx"
...
notes: |
  One of the largest SACCOs in Tanzania. Workplace-based. No tender page found.
---

# WAT SACCOS

**Category:** SACCO  
**Website:** http://watsaccos.or.tz/  
**Tender Page:** null  
