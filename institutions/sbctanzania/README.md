...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "sbctanzania.co.tz"

website:
  homepage: "https://sbctanzania.co.tz/"
  tender_url: "https://sbctanzania.co.tz/"

contact:
  email: "pepsi@sbctz.com"
  alternate_emails:
    - "customerservice@sbc.co.tz"
  phone: "+2550222860782"

scraping:
  enabled: false
  method: "http_get"
  strategy: "DISABLED: SBC Tanzania (Pepsi) corporate site. Sections: Company Profile, Brands, News & Media, Careers. No tender or procurement page. Keywords in README were from general text, not tender listings (2026-03-15)."
  selectors:
    container: ".container, .section, main"
    tender_item: ".gallery_product, .media-item, article"
    title: "h1, h2, .h1-section-com"
    date: ".date, time"
...
social_media:
  facebook: "pepsitz"
  twitter: "pepsi_tz"
  linkedin: "sbc-tanzania-ltd--pepsi-"
  instagram: "pepsi_tz"

notes: |
  Organization website at sbctanzania.co.tz. Tender keywords detected: eoi, rfi, tender, tenders.
---

# SBC - Pepsi

**Category:** Commercial / Private Sector
**Website:** https://sbctanzania.co.tz/
**Tender Page:** https://sbctanzania.co.tz/
**Keywords Found:** eoi, rfi, tender, tenders

## Contact Information
- Email: pepsi@sbctz.com
- Email: customerservice@sbc.co.tz
- Phone: +2550222860782
- Phone: +255272549234
- Phone: +255232604922
- Phone: +255252502957
- Phone: +255 22 2865648 --

## Scraping Instructions

**Strategy:** Scrape https://sbctanzania.co.tz/ for tender/procurement notices.
**Method:** http_get
...
> vive the Pepsi Cola business in Tanzania and to transform Pepsi brands into sizeable and serious contenders for volume and share of mind in the Tanzanian market." Our Vision calls for us to <strong
...
```json
{{
  "tender_id": "SBCTANZANIA-2026-001",
  "institution": "sbctanzania",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "SBCTANZANIA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://sbctanzania.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://sbctanzania.co.tz/storage/tender.pdf",
      "local_path": "./downloads/SBCTANZANIA-2026-001/original/tender_document.pdf",
