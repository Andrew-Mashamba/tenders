...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Multi-country aggregator. Filter for Tanzania financial sector.
...
alternative_sources:
  - name: "TenderSoko Tanzania"
    url: "https://www.tendersoko.com/tanzania/tender"
  - name: "TenderSoko Tenders (main)"
    url: "https://tendersoko.com/tenders"

notes: |
  Multi-country tender aggregator. Filter for Tanzania and financial services category. tender_url /tanzania/tender returns 404; use https://tendersoko.com/tenders with country filter instead.
---

# TenderSoko

**Category:** Tender Aggregator  
**Website:** https://www.tendersoko.com/tanzania/tender  
**Tender Page:** https://www.tendersoko.com/tanzania/tender  
...
Multi-country tender aggregator. Filter for Tanzania and financial services category.
