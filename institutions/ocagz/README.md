...
website:
  homepage: "https://ocagz.go.tz/"
  tender_url: "https://eprocurement.zppda.go.tz/"

contact:
  email: "info@ocagz.go.tz"
  phone: "0 0 1 10 14"

scraping:
  enabled: false
  method: "http_get"
  strategy: "eprocurement.zppda.go.tz redirects to /esop/guest/login.do — requires authentication. No public tender listing accessible via HTTP."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "ocagz.go.tz/documents/OCAGZ_Act_2023.pdf"
      - "ocagz.go.tz/documents/OCAGZ_SP.pdf"
    ...
    document_notes: |
      OCAGZ tender page redirects to login. Known document paths on ocagz.go.tz: /documents/OCAGZ_Act_2023.pdf, /documents/OCAGZ_SP.pdf (institutional docs, not tenders).
...
notes: |
  Office of the Controller and Auditor General of Zanzibar
---

# OCAGZ

**Category:** Government Agency
**Website:** https://ocagz.go.tz/
...
> ail E-Proz Quick Links MURU <a class="hov
...
- https://ocagz.go.tz/documents/OCAGZ_SP.pdf
- https://ocagz.go.tz/documents/OCAGZ_Act_2023.pdf
...
Known document paths: /documents/OCAGZ_Act_2023.pdf, /documents/OCAGZ_SP.pdf
...
{{
  ...
  "documents": [
    {{
      ...
      "original_url": "https://ocagz.go.tz/storage/tender.pdf",
      "local_path": "./downloads/OCAGZ-2026-001/original/tender_document.pdf",
