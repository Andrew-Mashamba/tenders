...
website:
  homepage: "https://makumira.ac.tz"
  tender_url: "https://makumira.ac.tz"
...
scraping:
  ...
  selectors:
    ...
    title: "h2, h3, h4, .fusion-post-title a, .entry-title"
    date: ".date, .fusion-meta-info, time"
  ...
  documents:
    ...
    url_patterns:
      - "makumira.ac.tz/wp-content/uploads/*.pdf"
    ...
    document_notes: |
      Documents found under /docs/. Check for additional paths during scraping.
...
notes: |
  Category: Academic. Keywords found: tender.
  Emails: ict@makumira.ac.tz, vc@makumira.ac.tz.
...
**Tender Page:** http://makumira.ac.tz

## Scraping Instructions

**Strategy:** Scrape homepage and linked pages for tender/procurement documents. 16 document links discovered.
**Method:** http_get
...
```json
{{
  "tender_id": "MAKUMIRA-2026-001",
  "institution": "makumira",
  ...
  "category": "Academic",
  "status": "active",
  "source_url": "http://makumira.ac.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MAKUMIRA-2026-001/original/tender_document.pdf",
