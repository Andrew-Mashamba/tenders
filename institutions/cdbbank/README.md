...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "cdbbank.co.tz"

website:
  homepage: "https://cdbbank.co.tz/"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      EOI and tender documents appear in the homepage marquee. Documents are hosted at chinadashengbank.co.tz/uploads/ (same bank, different domain). No dedicated tender listing page; scrape main content for announcement links.
...
notes: |
  Organization website at cdbbank.co.tz. Tender keywords detected: expression of interest.
---

# China Dasheng Bank | Smart Banking

**Category:** Bank
**Website:** https://cdbbank.co.tz/
**Tender Page:** https://cdbbank.co.tz/
...
**Strategy:** Scrape https://cdbbank.co.tz/ for banking tender notices and EOIs. Banks post frequently.
**Method:** http_get
...
```json
{{
  "tender_id": "CDBBANK-2026-001",
  "institution": "cdbbank",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "CDBBANK/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://cdbbank.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://cdbbank.co.tz/storage/tender.pdf",
      "local_path": "./downloads/CDBBANK-2026-001/original/tender_document.pdf",
