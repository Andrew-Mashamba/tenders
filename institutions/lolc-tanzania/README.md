---
institution:
  name: "LOLC Tanzania (formerly Tujijenge)"
  slug: "lolc-tanzania"
...
website:
  homepage: "https://www.tujijenge.or.tz/"
  tender_url: "null"

scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. Renamed from Tujijenge to LOLC Tanzania (Nov 2024)."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
  ...
  documents:
    ...
    url_patterns:
      - "www.tujijenge.or.tz/*.pdf"
      - "www.tujijenge.or.tz/*.docx"
      - "www.tujijenge.or.tz/*.xlsx"
...
notes: |
  Renamed to LOLC Tanzania Financial Services Limited in November 2024. No tender page found.
---

# LOLC Tanzania (formerly Tujijenge)

**Category:** Microfinance Institution  
**Website:** https://www.tujijenge.or.tz/  
**Tender Page:** null  
