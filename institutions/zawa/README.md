---
institution:
  name: "Zanzibar Water Authorities"
  slug: "zawa"
...
website:
  homepage: "https://zawa.go.tz/"
  tender_url: "https://zawa.go.tz/"

contact:
  email: "info@zawa.go.tz"
  phone: "00066491859846"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Documents in /PDF/ path (e.g. https://zawa.go.tz/PDF/usaili.pdf). Tender content under Water Tariffs Tenders Jobs. Follow document links from tender listing/detail pages.
...
social_media:
  ...
  twitter: "water_zanzibar"
  instagram: "tv"

notes: |
  Organization website at zawa.go.tz. Tender keywords detected: tender, tenders.
---

# Zanzibar Water Authorities

**Category:** Government Agency
**Website:** https://zawa.go.tz/
**Tender Page:** https://zawa.go.tz/
...
**Strategy:** Scrape https://zawa.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> opdown-item">Water Tarrifs Tenders Jobs

### Document Links Found

- https://zawa.go.tz/PDF/usaili.pdf
...
{{
  ...
  "reference_number": "ZAWA/T/2026/001",
  ...
  "documents": [
    {{
      ...
      "original_url": "https://zawa.go.tz/storage/tender.pdf",
      "local_path": "./downloads/ZAWA-2026-001/original/tender_document.pdf",
