...
website:
  homepage: "https://www.nbc.co.tz/"
  tender_url: "https://www.nbc.co.tz/en/procurement/"
...
scraping:
  ...
  selectors:
    ...
    title: "a"
    date: ""
    document_link: 'a[href*="/content/dam/nbc/"], a[href$=".pdf"]'
    pagination: ""
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/content/dam/nbc/tanzania/pdf/procurement/"
      - "/content/dam/nbc/tanzania/pdf/"
    url_patterns:
      - "nbc.co.tz/content/dam/nbc/tanzania/pdf/procurement/*.pdf"
      - "nbc.co.tz/content/dam/nbc/tanzania/pdf/*.pdf"
    ...
    document_notes: |
      Procurement page: direct list of PDF links. Path /content/dam/nbc/tanzania/pdf/procurement/. Includes RFP (nbc-rfp-credit.pdf), supplier code of conduct, policy docs (Data Privacy, EUDA, People Screening, etc). No traditional tender table.
...
notes: |
  Welcome to the National Bank of Commerce (NBC) Limited Tanzania. we offer a range of personal, retail, business, corporate and investment banking, wealth management products and services.
---

# NBC ǀ Personal Banking

**Category:** Commercial / Private Sector
**Website:** https://www.nbc.co.tz/
**Tender Page:** https://www.nbc.co.tz/en/procurement/
...
**Strategy:** Scrape https://www.nbc.co.tz/en/procurement/ for tender/procurement notices.
**Method:** http_get
...
> .nbc.co.tz/en/vacancies/">NBC vacancies Procurement News and events <

### Known Tender URLs

- https://www.nbc.co.tz/en/procurement/

### Document Links Found

- https://www.nbc.co.tz/content/dam/nbc/tanzania/pdf/forex/nbc-forward-contract-quotes.pdf
- https://www.nbc.co.tz/content/dam/nbc/tanzania/pdf/terms_and_conditions/NBC-email-disclaimer.pdf
...
Known document paths: /content/dam/nbc/tanzania/pdf/forex/nbc-forward-contract-quotes.pdf, /content/dam/nbc/tanzania/pdf/terms_and_conditions/NBC-email-disclaimer.pdf
...
{{
  ...
  "reference_number": "NBC/T/2026/001",
  ...
  "documents": [
    {{
      ...
      "original_url": "https://www.nbc.co.tz/storage/tender.pdf",
      "local_path": "./downloads/NBC-2026-001/original/tender_document.pdf",
