...
website:
  homepage: "https://kiazikitamu.co.tz"
  tender_url: "https://kiazikitamu.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    DISABLED: The /about-us/tender page (https://kiazikitamu.co.tz/about-us/tender) exists but is EMPTY.
    Kiazi kitamu is a bus booking platform (Bus Bora). No tender content found. Re-enable if they add
    procurement tenders.
  selectors:
...
**Category:** Commercial
**Website:** https://kiazikitamu.co.tz
**Tender Page:** https://kiazikitamu.co.tz/about-us/tender
...
```json
{{
  "tender_id": "KIAZIKITAMU-2026-001",
  "institution": "kiazikitamu",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://kiazikitamu.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KIAZIKITAMU-2026-001/original/tender_document.pdf",
