...
website:
  homepage: "https://tracellfinance.co.tz"
  tender_url: "https://tracellfinance.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Homepage only - no dedicated tender page found. Site describes microfinance products. 'Procurement' mentioned in services but no tender listings. Monitor for future tender pages."
  selectors:
...
**Category:** Commercial
**Website:** https://tracellfinance.co.tz
**Tender Page:** https://tracellfinance.co.tz
...
```json
{{
  "tender_id": "TRACELLFINANCE-2026-001",
  "institution": "tracellfinance",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://tracellfinance.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/TRACELLFINANCE-2026-001/original/tender_document.pdf",
