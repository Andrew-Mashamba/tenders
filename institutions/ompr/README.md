---
institution:
  name: "Ofisi ya Makamu wa Pili wa Rais - Zanzibar"
  slug: "ompr"
...
website:
  homepage: "https://ompr.go.tz/"
  tender_url: "https://ompr.go.tz/ufunguzi-wa-mfumo-wa-manunuzi-mtandao/"

contact:
  email: "info@ompr.go.tz"
  phone: "00 408 258 167"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Page is a news article about e-procurement system launch. Links to ppra.go.tz for actual tenders. No tender listing on this page."
  selectors:
    container: ".elementor-411, .entry-content, article.post"
    tender_item: ".elementor-widget-container, .elementor-column"
    title: ".entry-title, .elementor-heading-title, h1"
    date: ".entry-meta, .posted-on, time"
    document_link: 'a[href$=".pdf"], a[href*="ppra.go.tz"]'
    pagination: null
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "ompr.go.tz/wp-content/uploads/*.pdf"
      - "ppra.go.tz/*"
    ...
    document_notes: |
      News article only. Tenders posted at ppra.go.tz. wp-content/uploads/ for any PDFs on this site.
...
social_media:
  ...
  instagram: "ofisimakamupilirais"

notes: |
  Organization website at ompr.go.tz. Tender keywords detected: manunuzi, procurement.
---

# Ofisi ya Makamu wa Pili wa Rais &#8211; Ofisi ya Makamu wa Pili wa Rais &#8211; Zanzibar

**Category:** Government Agency
**Website:** https://ompr.go.tz/
**Tender Page:** https://ompr.go.tz/ufunguzi-wa-mfumo-wa-manunuzi-mtandao/
...
**Strategy:** Scrape https://ompr.go.tz/ufunguzi-wa-mfumo-wa-manunuzi-mtandao/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> https://www.ppra.go.tz/" target="_blank"> Public Procurement Regulatory Authority <div class="elementor-column elementor-col-25 elementor-inner-column

### Known Tender URLs

- https://ompr.go.tz/ufunguzi-wa-mfumo-wa-manunuzi-mtandao/
- https://ompr.go.tz/mkurugenzi-wa-kujenga-uwezo-wa-mamlaka-akisisitiza-ufuataji-wa-sheria-za-manunuzi-kwa-watoa-huduma/
...
```json
{{
  "tender_id": "OMPR-2026-001",
  "institution": "ompr",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "OMPR/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://ompr.go.tz/ufunguzi-wa-mfumo-wa-manunuzi-mtandao/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://ompr.go.tz/storage/tender.pdf",
      "local_path": "./downloads/OMPR-2026-001/original/tender_document.pdf",
