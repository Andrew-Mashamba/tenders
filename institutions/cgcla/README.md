...
website:
  homepage: "https://cgcla.go.tz/"
  tender_url: "https://cgcla.go.tz/"

contact:
  email: "info@cgcla.go.tz"
  phone: "00089335290089"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Scrape cgcla.go.tz (Wakala wa Maabara - Chief Government Chemist Lab). Eprocurement link requires login. Main site has PDF forms at /image/pdf/ (DNAApplicationForm, chiefAct, etc.). These are lab registration forms, not procurement tenders. Check homepage for tender links."
  selectors:
    container: "main, .content, .container, a[href*='image/pdf']"
    tender_item: "a[href*='image/pdf'], a[href$='.pdf']"
    title: "a"
    date: null
    document_link: 'a[href*="image/pdf"], a[href$=".pdf"]'
    pagination: null
  schedule: "daily"
  ...
  documents:
    ...
    document_notes: |
      Documents at /image/pdf/ (e.g. chiefAct.pdf, DNAApplicationForm.pdf, QUALITY POLICY.pdf). These are lab forms, not procurement tenders. Eprocurement (eprocurement.zppda.go.tz) requires login. Main site may link to tender notices.
...
social_media:
  facebook: "people"
  linkedin: "cgcla-zanzibar-9b432525a"
  instagram: "cgcla.zanzibar"

notes: |
  Organization website at cgcla.go.tz. Tender keywords detected: eoi, procurement.
---

# Wakala wa Maabara

**Category:** Government Agency
**Website:** https://cgcla.go.tz/
**Tender Page:** https://eprocurement.zppda.go.tz/esop/oma-host/public/government_of_zanzibar/web/login.html?_ncp=1753522605207.1464702-1
...
**Strategy:** Scrape https://eprocurement.zppda.go.tz/esop/oma-host/public/government_of_zanzibar/web/login.html?_ncp=1753522605207.1464702-1 for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://eprocurement.zppda.go.tz/esop/oma-host/public/government_of_zanzibar/web/login.html?_ncp=1753522605207.1464702-1

### Document Links Found

- https://cgcla.go.tz/image/pdf/chiefAct.pdf
- https://cgcla.go.tz/image/pdf/customerRegistrationform.pdf
- https://cgcla.go.tz/image/pdf/QUALITY POLICY.pdf
- https://cgcla.go.tz/image/pdf/PREMISES REGISTRATION.pdf
- https://cgcla.go.tz/image/pdf/CERTIFICATE HOLDER.pdf
- https://cgcla.go.tz/image/pdf/CHEMICALREGISTRATION.pdf
- https://cgcla.go.tz/image/pdf/DNAApplicationForm.pdf
...
```json
{{
  "tender_id": "CGCLA-2026-001",
  "institution": "cgcla",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "CGCLA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://eprocurement.zppda.go.tz/esop/oma-host/public/government_of_zanzibar/web/login.html?_ncp=1753522605207.1464702-1",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://cgcla.go.tz/storage/tender.pdf",
      "local_path": "./downloads/CGCLA-2026-001/original/tender_document.pdf",
