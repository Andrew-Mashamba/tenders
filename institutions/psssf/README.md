---
institution:
  name: "PSSSF - Public Service Social Security Fund"
  slug: "psssf"
...
scraping:
  ...
  selectors:
    ...
    title: "h2, h3, h4, .tender-title, .page-title-heading, a"
    date: ".date, .closing-date, .published, time, .date_label"
  ...
  documents:
    ...
    document_notes: |
      Tender pages (current, index, award) may render empty when no tenders. Documents in Media Center: /media/publication, /media/doc-act. Yii framework - content structure may vary. Footer links to Announced Tenders at /tender/current.
...
notes: |
  Organization website at psssf.go.tz. Tender keywords detected: procurement, rfi, tender, tenders.
---

# PSSSF

**Category:** Government Agency
**Website:** https://psssf.go.tz/
**Tender Page:** https://psssf.go.tz/tender/current
**Keywords Found:** procurement, rfi, tender, tenders

## Contact Information
- Email: info@psssf.go.tz
- Phone: +255 28 2506114
- Phone: +255 26 2323338
- Phone: 0800 110040
- Phone: +255 25 2502243
- Phone: +255 22 2123848

## Scraping Instructions

**Strategy:** Scrape https://psssf.go.tz/tender/current for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> ial Investment Tenders General Procurement Notice Awarded

### Known Tender URLs

- https://psssf.go.tz/tender/current
- https://psssf.go.tz/tender/index
- https://psssf.go.tz/tender/award
...
```json
{{
  "tender_id": "PSSSF-2026-001",
  "institution": "psssf",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "PSSSF/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://psssf.go.tz/tender/current",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://psssf.go.tz/storage/tender.pdf",
      "local_path": "./downloads/PSSSF-2026-001/original/tender_document.pdf",
