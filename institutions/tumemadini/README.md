---
institution:
  name: "TUME YA MADINI - Official Website"
  slug: "tumemadini"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "tumemadini.go.tz"

website:
  homepage: "https://tumemadini.go.tz/"
  tender_url: "https://tumemadini.go.tz/publications/tenders/"

contact:
  email: "staff@tumemadini.go.tz"
  alternate_emails:
    - "ceo@tumemadini.go.tz"
  phone: "0351083982"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Known document paths: /media/uploads/quarterly_prices/colored_gemstones/2026/02/15/MINING_COMMISSION_COLOURED_GEMSTON_kfrFuPg.pdf, /media/uploads/quarterly_prices/building_metallic/2026/01/28/BEI_ELEKEZI_YA_MADINI_UJENZI_VIWAN_c5g0YiD.pdf
...
**Category:** Government Agency
**Website:** https://tumemadini.go.tz/
**Tender Page:** https://tumemadini.go.tz/publications/tenders/
**Keywords Found:** procurement, tender, tenders

## Contact Information
- Email: staff@tumemadini.go.tz
- Email: ceo@tumemadini.go.tz
- Phone: 0351083982
- Phone: +255 262323827
- Phone: 0606943677
...
**Strategy:** Scrape https://tumemadini.go.tz/publications/tenders/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> oggle">Procurements Tenders Governmental Procurement Notice <

### Known Tender URLs

- https://tumemadini.go.tz/publications/tenders/
- https://tumemadini.go.tz/publications/procurement-notices/

### Document Links Found

- https://tumemadini.go.tz/media/uploads/quarterly_prices/building_metallic/2026/01/28/BEI_ELEKEZI_YA_MADINI_UJENZI_VIWAN_c5g0YiD.pdf
- https://tumemadini.go.tz/media/uploads/quarterly_prices/colored_gemstones/2026/02/15/MINING_COMMISSION_COLOURED_GEMSTON_kfrFuPg.pdf
...
```json
{{
  "tender_id": "TUMEMADINI-2026-001",
  "institution": "tumemadini",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TUMEMADINI/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://tumemadini.go.tz/publications/tenders/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://tumemadini.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TUMEMADINI-2026-001/original/tender_document.pdf",
