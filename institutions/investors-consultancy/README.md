---
institution:
  name: "GLOBAL INVESTORS CONSULTATION CENTRE/E.A (GICC/E.A)"
  slug: "investors-consultancy"
  category: "Investment / Securities"
  status: "active"
  country: "Tanzania"
  domain: "investors-consultancy.co.tz"

website:
  homepage: "https://investors-consultancy.co.tz/"
  tender_url: "https://investors-consultancy.co.tz/"
...
scraping:
  enabled: false
  method: "http_get"
  strategy: "Investment consultancy (GICC/E.A). Homepage has no tender listing or procurement notices. Disabled until tender content is identified."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "investors-consultancy.co.tz/*.pdf"
...
social_media:
  facebook: "pages"
  twitter: "FinbizAuditors"

notes: |
  GLOBAL INVESTORS CONSULTATION CENTRE
---

# GLOBAL INVESTORS CONSULTATION CENTRE/E.A (GICC/E.A)

**Category:** Investment / Securities
**Website:** https://investors-consultancy.co.tz/
**Tender Page:** https://investors-consultancy.co.tz/
...
**Strategy:** Scrape https://investors-consultancy.co.tz/ for tender/procurement notices.
**Method:** http_get
...
> nzania's Laws & Regulations including the Income Tax Act, Employment & Labour Relations Act, Public Procurement Act, Companies Act, EPZ Act , TIC Act & IFRS. • Executive Search & Recruitment (Tanzanians as well as hiring expatriates from India) • Busi
...
```json
{{
  "tender_id": "INVESTORS-CONSULTANCY-2026-001",
  "institution": "investors-consultancy",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "INVESTORS-CONSULTANCY/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://investors-consultancy.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://investors-consultancy.co.tz/storage/tender.pdf",
      "local_path": "./downloads/INVESTORS-CONSULTANCY-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "tenders@investors-consultancy.co.tz",
    "phone": "059808419",
    "address": "..."
  }},
