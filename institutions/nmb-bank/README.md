...
website:
  homepage: "https://www.nmbbank.co.tz/"
  tender_url: "https://www.nmbbank.co.tz/tenders"
...
scraping:
  ...
  selectors:
    ...
    date: ".date, .closing-date, .deadline"
  ...
  documents:
    ...
    document_notes: |
      One of Tanzania's largest banks. High volume of tender documents. Check for both inline PDFs and downloadable attachments.
...
notes: |
  One of Tanzania's largest banks by branch network. High tender volume. Check for pagination and PDF downloads.
---
...
**Tender Page:** https://www.nmbbank.co.tz/tenders  
