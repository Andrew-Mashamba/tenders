---
institution:
  name: "MES Engineering Consultancy Limited"
  slug: "mes-engineering"
  category: "Commercial"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://mes-engineering.co.tz"
  tender_url: "https://mes-engineering.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "No dedicated tender/procurement page found. Site is company info (services, about, projects). No tender listings or document links detected."
  selectors:
    container: "main.main, .container, section"
    tender_item: "article, .service-item, .col-lg-4"
    title: "h2, h3, .stretched-link"
    date: ".date, time"
  ...
  documents:
    ...
    document_notes: |
      No tender documents found. Site structure: Bootstrap template (main.main, section#services, .service-item). No procurement/tender section. Disabled until tender page is added.
...
notes: |
  Category: Commercial. Keywords found: rfp.
...
**Category:** Commercial
**Website:** https://mes-engineering.co.tz
**Tender Page:** https://mes-engineering.co.tz
...
```json
{{
  "tender_id": "MES-ENGINEERING-2026-001",
  "institution": "mes-engineering",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://mes-engineering.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MES-ENGINEERING-2026-001/original/tender_document.pdf",
