---
institution:
  name: "Tanzania Telecommunications Corporation (TTCL)"
  slug: "ttcl"
...
website:
  homepage: "https://ttcl.co.tz/"
  tender_url: "https://ttcl.co.tz/ttcl-tenders"

contact:
  email: "info@ttcl.co.tz"
  phone: "023-10-18-09-0"
...
scraping:
  ...
  selectors:
    ...
    title: ".column-title-small, h3, h4, .tender-title"
    date: ".date, time"
  ...
  documents:
    ...
    known_document_paths:
      - "/uploads/"
    url_patterns:
      - "ttcl.co.tz/uploads/*.pdf"
      - "ttcl.co.tz/ttcl-tenders"
    ...
    document_notes: |
      Tenders page can be empty when no active tenders. Documents in /uploads/ (e.g. uploads/website-images/). Bootstrap/Laravel structure. Check for dynamically loaded content.
...
social_media:
  facebook: "ttcltanzania"
  twitter: "ttclcorporation"
  instagram: "ttcl_corporation"

notes: |
  Organization website at ttcl.co.tz. Tender keywords detected: tender, tenders.
---

# TTCL | Home

**Category:** Commercial / Private Sector
**Website:** https://ttcl.co.tz/
**Tender Page:** https://ttcl.co.tz/ttcl-tenders
**Keywords Found:** tender, tenders

## Contact Information
- Email: info@ttcl.co.tz
- Phone: 023-10-18-09-0
- Phone: 026-03-09-07-5
- Phone: 026-02-27-02-0
- Phone: 026-03-03-09-4
- Phone: 026-03-09-12-4

## Scraping Instructions

**Strategy:** Scrape https://ttcl.co.tz/ttcl-tenders for tender/procurement notices.
**Method:** http_get
...
```json
{{
  "tender_id": "TTCL-2026-001",
  "institution": "ttcl",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TTCL/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://ttcl.co.tz/ttcl-tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://ttcl.co.tz/storage/tender.pdf",
      "local_path": "./downloads/TTCL-2026-001/original/tender_document.pdf",
