...
scraping:
  ...
  selectors:
    ...
    title: "h2, h3, .tender-title, td:first-child"
    date: ".date, .closing-date, td:nth-child(2)"
  ...
  documents:
    ...
    url_patterns:
      - "bankofbaroda.co.tz/*.pdf"
      - "bankofbaroda.co.tz/writereaddata/*.pdf"
    ...
    document_notes: |
      Indian bank — may use /writereaddata/ path pattern common to Bank of Baroda sites globally.
...
notes: |
  Has a dedicated tenders-notice page. Indian parent bank, may follow structured format.
---

# Bank of Baroda Tanzania

**Category:** Commercial Bank  
**Website:** https://www.bankofbaroda.co.tz/  
**Tender Page:** https://www.bankofbaroda.co.tz/tenders/tenders-notice  
