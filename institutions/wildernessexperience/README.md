...
institution:
  ...
  slug: "wildernessexperience"
  category: "Commercial"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://wildernessexperience.co.tz"
  tender_url: "https://wildernessexperience.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    DISABLED: wildernessexperience.co.tz is a safari/tourism travel agency website with no tender or procurement content.
    The site promotes safari tours, cultural tours, and travel packages. No tender listings or document links found.
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender documents. Site is a travel agency with no procurement content.
...
notes: |
  Category: Commercial (Safari/Tourism). Website analyzed 2026-03-15.
  No tender content found — site is Wilderness Experience Tanzania travel agency.
  Scraping disabled. Emails: info@travel.com.
---

# Wildernessexperience

**Category:** Commercial
**Website:** https://wildernessexperience.co.tz
**Tender Page:** https://wildernessexperience.co.tz
...
```json
{{
  "tender_id": "WILDERNESSEXPERIENCE-2026-001",
  "institution": "wildernessexperience",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://wildernessexperience.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/WILDERNESSEXPERIENCE-2026-001/original/tender_document.pdf",
