---
institution:
  name: "NeST (National e-Tendering System)"
  slug: "nest"
...
website:
  homepage: "https://nest.go.tz/"
  tender_url: "https://nest.go.tz/"
...
scraping:
  ...
  selectors:
    ...
    title: "td, .tender-title"
    date: "td, .closing-date"
  ...
  documents:
    ...
    document_notes: |
      Government e-tendering. May require login. Download all tender packages.
...
notes: |
  Government e-tendering portal. Used by government-owned institutions like SELF Microfinance Fund.
---

# NeST (National e-Tendering System)

**Category:** Tender Aggregator  
**Website:** https://nest.go.tz/  
**Tender Page:** https://nest.go.tz/  
