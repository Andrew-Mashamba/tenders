---
institution:
  name: "Zanzibar Bureau of Standards"
  slug: "zbs"
...
website:
  homepage: "https://zbs.go.tz/"
  tender_url: "https://zbs.go.tz/tenders/"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "WordPress/Elementor site with ova_doc plugin. Tenders page lists documents in .ova-document-list. Each item links to /ova_doc/{slug}/. Follow item links for full documents; use .ova-download, .ova-list-attachment for attachments. Also check /v1/tenders/ and /ova_doc/ for full listing."
  selectors:
    container: ".ova-document-list, .ova_doc_wrap, .elementor-widget-ova_doc"
    tender_item: ".ova-document-list .list-doc .item, .items-doc .doc-icon-title .doc-title-item"
    title: ".list-doc .item h3.title a, .doc-title a"
    date: ".doc-meta .doc-date, .post-date, time"
    document_link: 'a.ova-download, .ova-list-attachment li a, a[href$=".pdf"], a[href*="/ova_doc/"]'
    pagination: ".ova_doc_wrap .pagination a, .page-numbers a" 
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "zbs.go.tz/ova_doc/*"
      - "zbs.go.tz/wp-content/uploads/*"
      - "zbs.go.tz/v1/tenders/*"
    ...
    document_notes: |
      ova_doc plugin: documents at /ova_doc/{slug}/. Tender items: Procurement Plan, Invitation for Tender, etc. Detail pages have .ova-list-attachment with .ova-download links. Flipbook plugin may embed PDFs—check download.php.
...
social_media:
  facebook: "Standards.Quality.Life"
  twitter: "BureauZanzibar"
  instagram: "zanzibarstandards"

notes: |
  Organization website at zbs.go.tz. Tender keywords detected: bid, eoi, tender, tenders.
---

# Home - Zanzibar Bureau of Standards

**Category:** Government Agency
**Website:** https://zbs.go.tz/
**Tender Page:** https://zbs.go.tz/tenders/
**Keywords Found:** bid, eoi, tender, tenders
...
**Strategy:** Scrape https://zbs.go.tz/tenders/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> menu-item menu-item-type-post_type menu-item-object-page menu-item-7847"> Tenders <a href="https://zbs.go.tz/vacancies/" class="elementor-sub-

### Known Tender URLs

- https://zbs.go.tz/tenders/
- https://zbs.go.tz/2025/10/21/katazo-la-uingizaji-usambazaji-na-uuzaji-wa-bidhaa-hatari-bomb-bags/
...
{{
  ...
  "documents": [
    {{
      ...
      "original_url": "https://zbs.go.tz/storage/tender.pdf",
      "local_path": "./downloads/ZBS-2026-001/original/tender_document.pdf",
