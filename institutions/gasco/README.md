---
institution:
  name: "GASCO |   Gas Company (Tanzania) Limited - Mwanzo"
  slug: "gasco"
...
scraping:
  ...
  selectors:
    ...
    title: "h2, h3, h4, .project-title, .tender-title, a"
  ...
  documents:
    ...
    document_notes: |
      GASCO projects page (Miradi Yetu) lists EPC and procurement projects. Follow each /gasco_projects/{slug}/ for documents.
...
social_media:
  ...
  twitter: "gascotanzania"
  instagram: "gascotanzania"

notes: |
  Gas Company (Tanzania) Limited |   Gas Company (Tanzania) Limited - Mwanzo
---

# GASCO |   Gas Company (Tanzania) Limited - Mwanzo

**Category:** Energy / Mining
**Website:** https://gasco.co.tz/
**Tender Page:** https://gasco.co.tz/gasco_projects/engineering-procurement-and-construction-epc-for-natural-gas-distribution-network-in-dar-es-salaam-bq-and-energo
**Keywords Found:** manunuzi, procurement, rfi, tender, tenders, zabuni
...
- Phone: 0 1 0 0-2 1 1 0

## Scraping Instructions

**Strategy:** Scrape https://gasco.co.tz/gasco_projects/engineering-procurement-and-construction-epc-for-natural-gas-distribution-network-in-dar-es-salaam-bq-and-energo for tender/procurement notices.
**Method:** http_get
...
> /publications/career'>Kazi Zabuni <div class="bg-white position-abs

### Known Tender URLs

- https://gasco.co.tz/gasco_projects/engineering-procurement-and-construction-epc-for-natural-gas-distribution-network-in-dar-es-salaam-bq-and-energo
- https://gasco.co.tz/gasco_projects/engineering-procurement-and-construction-epc-for-natural-gas-interconnection-to-tanhealth-mbezi-beach
- https://gasco.co.tz/gasco_projects/engineering-procurement-construction-of-natural-gas-interconnection-pipeline-to-puma-energies-cng-stations
...
```json
{{
  "tender_id": "GASCO-2026-001",
  "institution": "gasco",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "GASCO/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://gasco.co.tz/gasco_projects/engineering-procurement-and-construction-epc-for-natural-gas-distribution-network-in-dar-es-salaam-bq-and-energo",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://gasco.co.tz/storage/tender.pdf",
      "local_path": "./downloads/GASCO-2026-001/original/tender_document.pdf",
