...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape /en/about-us/tender (or /about-us/tender). Bootstrap accordion: #accordionExample contains tender items. Each div[id^='tenderAccordion'] has title in .accordion-button, deadline in span.font-bold, document in a.pdf-icon. Documents at /storage/app/media/Tender/."
  selectors:
    container: "#accordionExample, .accordion, main, section.main"
    tender_item: "div[id^='tenderAccordion'], .accordion-item"
    title: ".accordion-button, h2.accordion-header"
    date: "span.font-bold"
    document_link: "a.pdf-icon, a[href*='storage/app/media/Tender'], a[href$='.pdf']"
    pagination: ""
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/storage/app/media/Tender/"
    
    url_patterns:
      - "crdbbank.co.tz/storage/app/media/Tender/*.pdf"
      - "crdbbank.co.tz/storage/app/media/*.pdf"
    ...
    document_notes: |
      CRDB stores tender documents under /storage/app/media/Tender/. URLs are percent-encoded (e.g. %20 for space). Each accordion item has title, description, deadline, and PDF link. 'Tender is closed' badge on expired items. No pagination — all tenders on single page.
...
alternative_sources:
  ...
  - name: "Mabumbe"
    url: "https://mabumbe.net/"

notes: |
  One of Tanzania's largest banks. High volume of tenders. Check for pagination. PDFs are common.
---
...
**Tender Page:** https://crdbbank.co.tz/en/about-us/tender  

## Scraping Instructions

**Strategy:** Scrape /en/about-us/tender page. CRDB is one of Tanzania's largest banks — expect frequent tender postings with PDFs.  
**Method:** http_get  
...
CRDB stores tender documents under /storage/app/media/Tender/. URLs are percent-encoded. Filenames contain the tender title.
