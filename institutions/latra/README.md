---
institution:
  name: "Land Transport Regulatory Authority (LATRA)"
  slug: "latra"
...
website:
  homepage: "https://latra.go.tz/"
  tender_url: "https://nest.go.tz/tenders/published-tenders?search=land%20transport%20regulatory%20authority"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "NeST (nest.go.tz) is an Angular SPA. Content loads via JavaScript; static HTML shows only app-root and loading. Use headless browser (Puppeteer/Playwright) or NeST API if available. Search param filters LATRA tenders."
  selectors:
...
notes: |
  Mamlaka ya Udhibiti Usafiri Ardhini (LATRA) ni Mamlaka ya Udhibiti wa Serikali iliyoanzishwa kwa Sheria ya Bunge namba 3 ya mwaka 2019. Sheria hiyo ni mbadala wa  sheria ya zamani ya Mamlaka ya Udhibiti wa Usafiri wa Nchi Kavu na Majini (SUMATRA). Mamlaka imedhamiria kudhibiti sekta za usafiri wa nchi kavu hususan, usafirishaji wa mizigo na abiria (mabasi ya abiria, mabasi yaendayo kasi, mizigo ya kubeba magari, teksi, pikipiki na baisikeli), reli na usafiri wa kebo. LATRA ina Ofisi yake Kuu jij
---

# LATRA |   Mamlaka ya Udhibiti Usafiri Ardhini - Mwanzo

**Category:** Government Agency
**Website:** https://latra.go.tz/
**Tender Page:** https://nest.go.tz/tenders/published-tenders?search=land%20transport%20regulatory%20authority
**Keywords Found:** procurement, tender, tenders, zabuni

## Contact Information
- Email: info@latra.go.tz
- Phone: 0 0 1916 200
- Phone: +255 262 323 930
- Phone: 0800110020 
- Phone: 0 0 1871 151
- Phone: 0800110020
...
**Strategy:** Scrape https://nest.go.tz/tenders/published-tenders?search=land%20transport%20regulatory%20authority for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://nest.go.tz/tenders/published-tenders?search=land%20transport%20regulatory%20authority
...
```json
{{
  "tender_id": "LATRA-2026-001",
  "institution": "latra",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "LATRA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://nest.go.tz/tenders/published-tenders?search=land%20transport%20regulatory%20authority",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://latra.go.tz/storage/tender.pdf",
      "local_path": "./downloads/LATRA-2026-001/original/tender_document.pdf",
