...
scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page found."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
  ...
  documents:
    ...
    url_patterns:
      ...
      - "mwalimubank.co.tz/*.docx"
      - "mwalimubank.co.tz/*.xlsx"
...
notes: |
  No tender page found. Owned by Tanzania Teachers Union.
---
...
{{
  ...
  "institution": "mwalimu-commercial-bank",
