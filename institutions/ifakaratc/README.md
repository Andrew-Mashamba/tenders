...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "ifakaratc.go.tz"

website:
  homepage: "https://ifakaratc.go.tz/"
  tender_url: "https://ifakaratc.go.tz/procurement-and-supply"

contact:
  email: "td@ifakaratc.go.tz"
  alternate_emails:
    - "info@ifakaratc.go.tz"
  phone: "001748552"
...
scraping:
  ...
  selectors:
    ...
    title: "a[href*='single-announcement'], a[href*='singel-event'], h4, h3"
    date: ".date, time, small, span"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[href*="/storage/"]'
    pagination: "a[href*='announcements'], a[href*='events'], .pagination a" 
  schedule: "daily"
  ...
  documents:
    ...
    document_notes: |
      Documents in /storage/app/uploads/public/ (hash-style paths like /586/4d8/384/filename.pdf). Follow links from announcement and event detail pages. PDFs often attached to procurement-related announcements.
...
# Home &#124; Ifakara Town Council

**Category:** Local Government Authority
**Website:** https://ifakaratc.go.tz/
**Tender Page:** https://ifakaratc.go.tz/procurement-and-supply
**Keywords Found:** manunuzi, procurement, supply

## Contact Information
- Email: td@ifakaratc.go.tz
- Email: info@ifakaratc.go.tz
- Phone: 001748552

## Scraping Instructions

**Strategy:** Scrape https://ifakaratc.go.tz/procurement-and-supply for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://ifakaratc.go.tz/procurement-and-supply

### Document Links Found

- https://ifakaratc.go.tz/storage/app/uploads/public/5bb/c3f/8a1/5bbc3f8a15b58149473594.pdf
- https://ifakaratc.go.tz/storage/app/uploads/public/5bb/b3d/25e/5bbb3d25e3abe758413473.pdf
- https://ifakaratc.go.tz/storage/app/uploads/public/586/4d8/384/5864d8384338d609446298.pdf
...
Known document paths: /storage/app/uploads/public/586/4d8/384/5864d8384338d609446298.pdf, /storage/app/uploads/public/5bb/c3f/8a1/5bbc3f8a15b58149473594.pdf, /storage/app/uploads/public/5bb/b3d/25e/5bbb3d25e3abe758413473.pdf
...
```json
{{
  "tender_id": "IFAKARATC-2026-001",
  "institution": "ifakaratc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "IFAKARATC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://ifakaratc.go.tz/procurement-and-supply",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://ifakaratc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/IFAKARATC-2026-001/original/tender_document.pdf",
