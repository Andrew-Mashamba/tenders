---
institution:
  name: "Zanzibar Examinations Council (ZEC)"
  slug: "bmz"
...
website:
  homepage: "https://bmz.go.tz/"
  tender_url: "https://eprocurement.zppda.go.tz/"

contact:
  email: "info@bmz.go.tz"
  phone: "026-01-07"

scraping:
  enabled: false
  method: "http_get"
  strategy: "eprocurement.zppda.go.tz redirects to /esop/guest/login.do - requires login. Cannot scrape without authentication. Tender URL points to Zanzibar e-procurement portal."
  selectors:
...
social_media:
  facebook: "barazalamitihaniznz"

notes: |
  Zanzibar Examinations Council official website. bmz.go.tz is ZEC homepage. tender_url (eprocurement.zppda.go.tz) requires login - redirects to guest login page. Disabled until scraping with auth is supported.
---

# Home &bull; ZEC

**Category:** Government Agency
**Website:** https://bmz.go.tz/
...
Zanzibar Examinations Council official website

### Tender Content Preview

> target="_blank">E-office E-ProZ <a href="https://zgamis.trosmz.go.tz/" rel="noopener noreferrer" tar
...
{{
  ...
  "documents": [
    {{
      ...
      "original_url": "https://bmz.go.tz/storage/tender.pdf",
      "local_path": "./downloads/BMZ-2026-001/original/tender_document.pdf",
