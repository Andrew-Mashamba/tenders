...
website:
  homepage: "https://kmh.co.tz"
  tender_url: "https://kmh.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Site requires login (Laravel auth.login). Homepage redirects to login; no public tender content. Disable until tender page is publicly accessible."
  selectors:
...
notes: |
  Category: Commercial (Auto Garage). Site requires authentication; no public tender page. Disable scraping. Re-enable if tender section becomes public.
---

# Auto Garage

**Category:** Commercial
**Website:** https://kmh.co.tz
**Tender Page:** https://kmh.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://kmh.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KMH-2026-001/original/tender_document.pdf",
