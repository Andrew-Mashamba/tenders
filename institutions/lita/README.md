---
institution:
  name: "Mwanzo |WAKALA WA VYUO VYA MAFUNZO YA MIFUGO (LITA)"
  slug: "lita"
...
website:
  homepage: "https://lita.go.tz/"
  tender_url: "https://lita.go.tz/"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://lita.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi."
  selectors:
...
**Category:** Government Agency
**Website:** https://lita.go.tz/
**Tender Page:** https://lita.go.tz/
**Keywords Found:** manunuzi, procurement

## Contact Information
- Email: daniel.chikaka@ega.go.tz
- Email: info@lita.go.tz
- Phone: 023
         
- Phone: +255 022 2861910

- Phone: 026
         
- Phone: 025-04-16 
- Phone: +255 022 2861908
...
> f='#'>Vitengo Kitengo cha manunuzi Kitengo cha tehama na takwimu <a href= 'h
...
```json
{{
  "tender_id": "LITA-2026-001",
  "institution": "lita",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "LITA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://lita.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://lita.go.tz/storage/tender.pdf",
      "local_path": "./downloads/LITA-2026-001/original/tender_document.pdf",
