---
institution:
  name: "Bright line (Bus Company)"
  slug: "brightline"
  category: "Commercial"
  status: "active"
  country: "Tanzania"
  domain: "brightline.co.tz"

website:
  homepage: "https://brightline.co.tz"
  tender_url: "https://brightline.co.tz/about-us/tender"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://brightline.co.tz/about-us/tender. Main content in .l-main-container, .container. Page structure has .page_title (h1) and p - may be empty or JS-populated. Bus booking platform - tender page exists under About."
  selectors:
    container: ".l-main-container, .container.my-4, .col-lg-12"
    tender_item: ".col-lg-12, article, .tender-item"
    title: "h1.page_title, h2, h3, .title"
...
**Category:** Commercial
**Website:** https://brightline.co.tz
**Tender Page:** https://brightline.co.tz/about-us/tender
...
```json
{{
  "tender_id": "BRIGHTLINE-2026-001",
  "institution": "brightline",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://brightline.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/BRIGHTLINE-2026-001/original/tender_document.pdf",
