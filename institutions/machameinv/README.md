...
website:
  homepage: "https://machameinv.co.tz"
  tender_url: "https://machameinv.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: "/about-us/tender is About Us page for Machame Inv bus company (bus booking). No tender content. Disabled."
  selectors:
...
notes: |
  machameinv.co.tz is a bus booking platform (Machame Inv / Busbora). /about-us/tender shows About Us, not tenders. Disabled.
...
**Category:** Commercial
**Website:** https://machameinv.co.tz
**Tender Page:** https://machameinv.co.tz/about-us/tender
...
```json
{{
  "tender_id": "MACHAMEINV-2026-001",
  "institution": "machameinv",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://machameinv.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MACHAMEINV-2026-001/original/tender_document.pdf",
