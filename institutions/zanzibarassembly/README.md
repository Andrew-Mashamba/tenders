---
institution:
  name: "House of Representatives, Zanzibar"
  slug: "zanzibarassembly"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "zanzibarassembly.go.tz"

website:
  homepage: "http://zanzibarassembly.go.tz/"
  tender_url: "http://zanzibarassembly.go.tz/"

contact:
  email: "info@zanzibarassembly.go.tz"
  alternate_emails:
    - "zahore@zanzibarassembly.go.tz"
  phone: "+255 24 2230602"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape homepage and follow Documents & Information menu links. Tender-related content in Bills, Budgets, Order Papers, Vacancies. Documents served from /storage/. Follow links to /en/bills, /en/orderpapers, /en/ministerial-budgets, /en/workingdocuments, /en/Hansard-reports. Extract all PDF links from document listing pages."
  selectors:
    container: ".m-menu, .cour-mm, .m-menu-inn, main, .content"
    tender_item: ".mm1-cour-com ul li, .m-menu ul li"
    title: "h4, .mm1-cour-com h4, a"
    date: ".date, time"
  ...
  documents:
    ...
    known_document_paths:
      - "/storage/documents/Budgets/all/"
      - "/storage/documents/orderpapers/all/"
      - "/storage/documents/bills/all/"
      - "/storage/documents/Chairpersons/all/"
      - "/storage/documents/Committees/all/"
      - "/storage/members/profiles/All/"
      - "/storage/documents/"

    url_patterns:
      - "zanzibarassembly.go.tz/storage/documents/*"
      - "zanzibarassembly.go.tz/storage/members/*"
    ...
    document_notes: |
      Documents in /storage/documents/ with subdirs: Budgets, orderpapers, bills, Chairpersons, Committees. PDFs use numeric filenames. Follow category pages from Documents & Information mega menu. Vacancies may contain tender notices.
...
**Category:** Government Agency
**Website:** http://zanzibarassembly.go.tz/
**Tender Page:** http://zanzibarassembly.go.tz/
**Keywords Found:** procurement

## Contact Information
- Email: info@zanzibarassembly.go.tz
- Email: zahore@zanzibarassembly.go.tz
- Phone: +255 24 2230602
- Phone: 00072609066929

## Scraping Instructions

**Strategy:** Scrape http://zanzibarassembly.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> ts/bills/all/1762849360.pdf" target="_blank" style="color: #203245; line-height: 24px;">The Public Procurement Bill

### Document Links Found

- http://zanzibarassembly.go.tz/storage/documents/orderpapers/all/1771909171.pdf
- http://zanzibarassembly.go.tz/storage/documents/Chairpersons/all/1709117816.pdf
- http://zanzibarassembly.go.tz/storage/documents/Chairpersons/all/1709614598.pdf
- http://zanzibarassembly.go.tz/storage/documents/Committees/all/1759403768.pdf
- http://zanzibarassembly.go.tz/storage/documents/Budgets/all/1759318421.pdf
- http://zanzibarassembly.go.tz/storage/documents/bills/all/1762849360.pdf
- http://zanzibarassembly.go.tz/storage/documents/orderpapers/all/1771823028.pdf
- http://zanzibarassembly.go.tz/storage/documents/Chairpersons/all/1708927585.pdf
- http://zanzibarassembly.go.tz/storage/members/profiles/All/1668673521.pdf
- http://zanzibarassembly.go.tz/storage/documents/orderpapers/all/1771996233.pdf
...
Known document paths: /storage/members/profiles/All/1677048946.pdf, /storage/documents/Budgets/all/1759318420.pdf, /storage/documents/orderpapers/all/1772093992.pdf
...
```json
{{
  "tender_id": "ZANZIBARASSEMBLY-2026-001",
  "institution": "zanzibarassembly",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ZANZIBARASSEMBLY/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "http://zanzibarassembly.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "http://zanzibarassembly.go.tz/storage/tender.pdf",
      "local_path": "./downloads/ZANZIBARASSEMBLY-2026-001/original/tender_document.pdf",
