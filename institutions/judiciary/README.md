---
institution:
  name: "The Judiciary of Tanzania"
  slug: "judiciary"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "judiciary.go.tz"

website:
  homepage: "https://judiciary.go.tz/"
  tender_url: "https://judiciary.go.tz/"

contact:
  email: "info@judiciary.go.tz"
  phone: "+255 22 2123897"
...
scraping:
  ...
  selectors:
    ...
    title: ".whats-item .h6, a.h7"
    date: "small .text-body, .fas.fa-calendar-alt"
    document_link: 'a[href*="main_registry/announcements"][href$=".pdf"]'
    pagination: ""
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/main_registry/announcements/"

    url_patterns:
      - "judiciary.go.tz/main_registry/announcements/*.pdf"
    ...
    document_notes: |
      Tender/announcement PDFs at /main_registry/announcements/. Tenders section on homepage links
      directly to PDFs. Recent News (.whats-item) may include tender-related posts.
...
social_media:
  facebook: "The-Judiciary-of-Tanzania-654628221361656"
  twitter: "judiciarytz"

notes: |
  Organization website at judiciary.go.tz. Tender keywords detected: tender, tenders.
---

# Judiciary Of Tanzania | Home

**Category:** Government Agency
**Website:** https://judiciary.go.tz/
**Tender Page:** https://judiciary.go.tz/
...
**Strategy:** Scrape https://judiciary.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> rounded"> Tenders <div cl

### Document Links Found

- https://judiciary.go.tz/main_registry/announcements/TANGAZO_KWA_UMMA_MAONI_YA_KUHUISHA_CB_&_CPS__JANUARI,_2026..pdf
- https://judiciary.go.tz/main_registry/announcements/COMPREHENSIVE_PERFORMANCE_REPORT_2025.pdf
- https://judiciary.go.tz/main_registry/announcements/TANGAZO.pdf
...
```json
{{
  "tender_id": "JUDICIARY-2026-001",
  "institution": "judiciary",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "JUDICIARY/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://judiciary.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://judiciary.go.tz/storage/tender.pdf",
      "local_path": "./downloads/JUDICIARY-2026-001/original/tender_document.pdf",
