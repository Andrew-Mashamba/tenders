---
institution:
  name: "Demi Tours and Travel"
  slug: "demitoursandtravel"
  category: "Commercial"
  status: "inactive"
  country: "Tanzania"

website:
  homepage: "https://demitoursandtravel.co.tz"
  tender_url: "https://demitoursandtravel.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "DISABLED: Website returns 'Account Suspended' - hosting account has been suspended. Re-enable when site is restored. Check demitoursandtravel.co.tz for status."
  selectors:
...
notes: |
  ...
  Website status: Account suspended (as of 2026-03-15). Scraping disabled until site is restored.
---

# Account Suspended

**Category:** Commercial
**Website:** https://demitoursandtravel.co.tz
**Tender Page:** https://demitoursandtravel.co.tz
...
```json
{{
  "tender_id": "DEMITOURSANDTRAVEL-2026-001",
  "institution": "demitoursandtravel",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://demitoursandtravel.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/DEMITOURSANDTRAVEL-2026-001/original/tender_document.pdf",
