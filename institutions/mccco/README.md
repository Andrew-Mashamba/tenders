---
institution:
  name: "Mbozi Coffee Curing Company Limited (MCCCo)"
  slug: "mccco"
  category: "Commercial"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://mccco.co.tz"
  tender_url: "https://mccco.co.tz"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Bootstrap site. No tender/procurement page found. Site shows company info (coffee curing, mission, vision). No document links or tender listings. Disable until tender content is added."
  selectors:
...
**Category:** Commercial
**Website:** https://mccco.co.tz
**Tender Page:** https://mccco.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://mccco.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MCCCO-2026-001/original/tender_document.pdf",
