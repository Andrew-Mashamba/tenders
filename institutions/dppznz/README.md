---
institution:
  name: "Office of the Director of Public Prosecutions Zanzibar (DPP Zanzibar)"
  slug: "dppznz"
...
website:
  homepage: "https://dppznz.go.tz/"
  tender_url: "https://dppznz.go.tz/"
...
scraping:
  enabled: false
  method: "http_get"
  strategy: "Scrape dppznz.go.tz. DPP is prosecution office - NOT a procurement body. Homepage has Latest News (legal updates, community outreach), services. No tender/procurement section. News at /news/{id}. Check for any procurement unit links."
  selectors:
    container: "main, .container, .news-section, .content"
    tender_item: ".news-item, article, a[href*='/news/']"
    title: "h4, h5, .news-title, a"
    date: ".date, time, span"
  ...
  documents:
    ...
    document_notes: |
      DPP Zanzibar is criminal prosecution office. No procurement/tender function. News items (Official Opening, Legal Update, Community) - not tenders. May have procurement for office supplies - check /news/ pages for any procurement announcements.
...
notes: |
  Organization website at dppznz.go.tz. Tender keywords detected: procurement, supply.
---

# dpp znz

**Category:** Government Agency
**Website:** https://dppznz.go.tz/
**Tender Page:** https://dppznz.go.tz/
...
- Phone: +255 24 22355564
- Phone: +255 764 292 299
- Phone: +255 0763 292 299

## Scraping Instructions

**Strategy:** Scrape https://dppznz.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> Procurement Management Unit Specialized in procurement and supply chain management
...
```json
{{
  "tender_id": "DPPZNZ-2026-001",
  "institution": "dppznz",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "DPPZNZ/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://dppznz.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://dppznz.go.tz/storage/tender.pdf",
      "local_path": "./downloads/DPPZNZ-2026-001/original/tender_document.pdf",
