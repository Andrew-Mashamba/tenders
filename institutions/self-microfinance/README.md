---
institution:
  name: "SELF Microfinance Fund"
  slug: "self-microfinance"
  category: "Microfinance Institution"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://www.self.go.tz/"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Government fund. Tenders published via NeST. Documents may require NeST portal access.
...
notes: |
  Government-owned microfinance fund under Ministry of Finance. All tenders via NeST portal. Search for 'SELF' on nest.go.tz.
---

# SELF Microfinance Fund

**Category:** Microfinance Institution  
**Website:** https://www.self.go.tz/  
