---
institution:
  name: "Diamond Trust Bank (DTB) Tanzania"
...
scraping:
  ...
  documents:
    ...
    url_patterns:
      - "dtbt.dtbafrica.com/*.pdf"
      - "dtbt.dtbafrica.com/*.docx"
      - "dtbt.dtbafrica.com/*.xlsx"
...
alternative_sources:
  ...
  - name: "Email"
    url: "mailto:procurement@dtbt.dtbafrica.com"

notes: |
  No dedicated tender page. Contact procurement@dtbt.dtbafrica.com for tender info. Also check Mabumbe.
---
...
{{
  ...
  "institution": "diamond-trust-bank",
