...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Major bank (ABSA subsidiary). Procurement page likely has structured document downloads.
...
notes: |
  Major bank (ABSA/Barclays subsidiary). Dedicated procurement page. Expect structured listings.
---
