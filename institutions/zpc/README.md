---
institution:
  name: "Zanzibar Ports Cooperation"
  slug: "zpc"
...
website:
  homepage: "https://zpc.go.tz/"
  tender_url: "https://eprocurement.zppda.go.tz/"

contact:
  email: "support@zpc.go.tz"
  alternate_emails:
    - "info@zpc.go.tz"
  phone: "025-09-08"
...
scraping:
  enabled: false
  method: "http_get"
  strategy: "Scrape https://eprocurement.zppda.go.tz/ — e-procurement portal redirects to /esop/guest/login.do. Requires login. Tender page may be behind auth. ZPC main site (zpc.go.tz) has PDFs (Tarrif_zpc.pdf, 1997_act_1.pdf) but not tender listings. Consider scraping zpc.go.tz for document links; eprocurement needs JS/session."
  selectors:
    container: "main, .content, .tender-list, table"
    tender_item: "tr, .tender-item, article"
    title: "h2, h3, td, .tender-title"
    date: ".date, .closing-date, td"
    document_link: 'a[href$=".pdf"], a[href*="zpc.go.tz"]'
  ...
  documents:
    ...
    url_patterns:
      - "zpc.go.tz/*.pdf"
      - "zpc.go.tz/Tarrif_zpc.pdf"
      - "zpc.go.tz/1997_act_1.pdf"
      - "zpc.go.tz/Magazine_zpc.pdf"
    ...
    document_notes: |
      Eprocurement redirects to login. ZPC main site has PDFs at root (Tarrif_zpc.pdf, 1997_act_1.pdf, Magazine_zpc.pdf). Tender documents may be on eprocurement portal after login.
...
notes: |
  Organization website at zpc.go.tz. Tender keywords detected: procurement, rfi.
---

# Zanzibar Ports Cooperation

**Category:** Government Agency
**Website:** https://zpc.go.tz/
**Tender Page:** https://eprocurement.zppda.go.tz/
**Keywords Found:** procurement, rfi

## Contact Information
- Email: support@zpc.go.tz
- Email: info@zpc.go.tz
- Phone: 025-09-08
- Phone: 09207562149144
- Phone: 01460335605
- Phone: 025-09-09
- Phone: 08103119000
...
> iv> <div style="height:120px; display:flex; align-items:center; justify-content:center; overflow:hidden; margin-bottom:15px
...
- https://zpc.go.tz/Tarrif_zpc.pdf
- https://zpc.go.tz/1997_act_1.pdf
- https://zpc.go.tz/Magazine_zpc.pdf
...
```json
{{
  "tender_id": "ZPC-2026-001",
  "institution": "zpc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ZPC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://eprocurement.zppda.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://zpc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/ZPC-2026-001/original/tender_document.pdf",
