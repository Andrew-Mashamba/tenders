...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "acbbank.co.tz"

website:
  homepage: "https://www.acbbank.co.tz/"
  tender_url: "https://www.acbbank.co.tz/tenders"

contact:
  email: "info@acbbank.co.tz"
  phone: "0 0 0 0 0   0 0"
...
scraping:
  ...
  selectors:
    ...
    title: ".hr-tabs-nav span, .zn_text_box p"
    date: ""
    document_link: 'a.fullscreen-mode, iframe.pvfw-pdf-viewer-frame[src]'
    pagination: ""
  schedule: "daily"
  ...
  documents:
    ...
    document_notes: |
      Tenders are embedded as PDFs in iframe viewers. Fullscreen link (a.fullscreen-mode) points to direct PDF viewer URL. Pattern: https://www.acbbank.co.tz/pdfviewer/{document-slug}/. Resolve iframe src or fullscreen href to get document URL; may need to extract PDF from viewer page.
...
notes: |
  Akiba Commercial Bank PLC commenced banking operations in August 1997. as an initiative of over 300 Tanzanian entrepreneurs who were inspired to move into micro-finance, by the moral and economical concern for the light of millions of Tanzanians.
---

# Akiba Commercial Bank PLC

**Category:** Bank
**Website:** https://www.acbbank.co.tz/
**Tender Page:** https://www.acbbank.co.tz/tenders
...
**Strategy:** Scrape https://www.acbbank.co.tz/tenders for banking tender notices and EOIs. Banks post frequently.
**Method:** http_get
...
> em menu-item-type-custom menu-item-object-custom menu-item-6472"> TENDERS INTERNET BANKING <ul class="sh-com

### Known Tender URLs

- https://www.acbbank.co.tz/tenders
...
{{
  ...
  "reference_number": "ACBBANK/T/2026/001",
  ...
  "documents": [
    {{
      ...
      "original_url": "https://www.acbbank.co.tz/storage/tender.pdf",
      "local_path": "./downloads/ACBBANK-2026-001/original/tender_document.pdf",
