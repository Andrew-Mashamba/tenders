---
institution:
  name: "www.GreenHippotravels.com , Green Travel in Tanzania"
  slug: "greenhippotravels"
  category: "Commercial"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://greenhippotravels.co.tz"
  tender_url: "http://greenhippotravels.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Site is travel/tourism blog. No tender listing or procurement page found. Keywords rfp/rfq may be in blog posts but no structured tender content."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender page structure found. greenhippotravels.co.tz is a travel blog with no procurement listings. Disabled until tender page exists.
...
notes: |
  Category: Commercial. Keywords found: rfp, rfq.
  Emails: None found yet.
  Discovered by crawler on 2026-03-15.
---

# www.GreenHippotravels.com , Green Travel in Tanzania

**Category:** Commercial
**Website:** https://greenhippotravels.co.tz
**Tender Page:** http://greenhippotravels.co.tz
...
Keywords found on site: rfp, rfq
...
```json
{{
  "tender_id": "GREENHIPPOTRAVELS-2026-001",
  "institution": "greenhippotravels",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "http://greenhippotravels.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/GREENHIPPOTRAVELS-2026-001/original/tender_document.pdf",
