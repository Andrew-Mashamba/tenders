...
scraping:
  ...
  documents:
    ...
    url_patterns:
      - "muhezadc.go.tz/storage/app/uploads/public/*"
    ...
    document_notes: |
      October CMS. Documents in /storage/app/uploads/public/{hash}/ (e.g. 69a/945/593/69a9455934bfb579910734.pdf). Table has 'Tender Zaidi' header. Resolve relative hrefs to full URLs.
...
social_media:
  facebook: "muheza.tanga.9"
  instagram: "halmashauriya_wilaya_ya_muheza"

notes: |
  A default home page
---

# Home &#124; Muheza District Council

**Category:** Local Government Authority
**Website:** https://muhezadc.go.tz/
**Tender Page:** https://muhezadc.go.tz/procurement
...
**Strategy:** Scrape https://muhezadc.go.tz/procurement for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://muhezadc.go.tz/procurement
- https://muhezadc.go.tz/tenders

### Document Links Found

- https://muhezadc.go.tz/storage/app/uploads/public/69a/80d/169/69a80d16940f2008708985.pdf
- https://muhezadc.go.tz/storage/app/uploads/public/69a/946/05a/69a94605a2f2b663080297.pdf
- https://muhezadc.go.tz/storage/app/uploads/public/69a/945/593/69a9455934bfb579910734.pdf
- https://muhezadc.go.tz/storage/app/uploads/public/69a/921/409/69a9214097151746897680.pdf
- https://muhezadc.go.tz/storage/app/uploads/public/628/ca7/abd/628ca7abd2b1d967825340.pdf
- https://muhezadc.go.tz/storage/app/uploads/public/69a/924/c05/69a924c0559c6226988957.pdf
- https://muhezadc.go.tz/storage/app/uploads/public/628/ca3/b33/628ca3b33a9cb908609275.pdf
...
Known document paths: /storage/app/uploads/public/69a/945/593/69a9455934bfb579910734.pdf, /storage/app/uploads/public/69a/80d/169/69a80d16940f2008708985.pdf, /storage/app/uploads/public/69a/924/c05/69a924c0559c6226988957.pdf
...
```json
{{
  "tender_id": "MUHEZADC-2026-001",
  "institution": "muhezadc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MUHEZADC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://muhezadc.go.tz/procurement",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://muhezadc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MUHEZADC-2026-001/original/tender_document.pdf",
