---
institution:
  name: "Dar-express | Tanzania's Leading Bus Booking Platform"
  slug: "dar-express"
  category: "Commercial"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://dar-express.co.tz"
  tender_url: "https://dar-express.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: "The /about-us/tender page exists but contains no tender content—only header/nav. Dar-express is a bus booking platform (busbora.co.tz). No tender listings found."
  selectors:
...
notes: |
  ...
  Tender page unreachable or empty as of 2026-03-15. Scraping disabled until tender content is available.
---

# Dar-express

**Category:** Commercial
**Website:** https://dar-express.co.tz
**Tender Page:** https://dar-express.co.tz/about-us/tender
...
```json
{{
  "tender_id": "DAR-EXPRESS-2026-001",
  "institution": "dar-express",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://dar-express.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/DAR-EXPRESS-2026-001/original/tender_document.pdf",
