---
institution:
  name: "Mwanga District Council (Halmashauri ya Wilaya ya Mwanga)"
  slug: "mwangadc"
  category: "Local Government Authority"
  status: "active"
  country: "Tanzania"
  domain: "mwangadc.go.tz"

website:
  homepage: "https://mwangadc.go.tz/"
  tender_url: "https://mwangadc.go.tz/tenders"

contact:
  email: "ded@mwangadc.go.tz"
  phone: "0000-00-00"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://mwangadc.go.tz/tenders for zabuni. Parse table.table-striped: each tr = tender; td[1]=title, td[2]=published, td[3]=expiry, td[4]=doc link."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "mwangadc.go.tz/storage/app/uploads/public/*.pdf"
      - "mwangadc.go.tz/storage/app/uploads/public/*.doc"
      - "mwangadc.go.tz/storage/app/uploads/public/*.docx"
    ...
    document_notes: |
      Documents in table 4th column: a[href*="/storage/"] with "Pakua" (Download). Path: /storage/app/uploads/public/{hash}.pdf
...
# Home &#124; Mwanga District Council

**Category:** Local Government Authority
**Website:** https://mwangadc.go.tz/
**Tender Page:** https://mwangadc.go.tz/tenders
...
**Strategy:** Scrape https://mwangadc.go.tz/tenders for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> Tender Zaidi <table class="table table-striped

### Known Tender URLs

- https://mwangadc.go.tz/tenders
- https://mwangadc.go.tz/procurement

### Document Links Found

- https://mwangadc.go.tz/storage/app/uploads/public/661/e32/cbd/661e32cbd11ab452283703.pdf
- https://mwangadc.go.tz/storage/app/uploads/public/60d/179/f4d/60d179f4dd90b098994955.pdf
- https://mwangadc.go.tz/storage/app/uploads/public/639/c52/d2d/639c52d2d745b388366851.pdf
- https://mwangadc.go.tz/storage/app/uploads/public/661/e35/ab9/661e35ab9c886906510572.pdf
- https://mwangadc.go.tz/storage/app/uploads/public/639/c51/f42/639c51f42294f395025882.pdf
- https://mwangadc.go.tz/storage/app/uploads/public/5fd/dd4/078/5fddd4078074e884736748.pdf
- https://mwangadc.go.tz/storage/app/uploads/public/661/e97/0cc/661e970cc2d44178613042.pdf
...
Known document paths: /storage/app/uploads/public/639/c52/d2d/639c52d2d745b388366851.pdf, /storage/app/uploads/public/661/e32/cbd/661e32cbd11ab452283703.pdf, /storage/app/uploads/public/639/c51/f42/639c51f42294f395025882.pdf
...
```json
{{
  "tender_id": "MWANGADC-2026-001",
  "institution": "mwangadc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MWANGADC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://mwangadc.go.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://mwangadc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MWANGADC-2026-001/original/tender_document.pdf",
