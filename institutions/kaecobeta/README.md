...
website:
  homepage: "https://kaecobeta.co.tz"
  tender_url: "https://kaecobeta.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    KAECO Tanzania Ltd — engineering company (civil, mechanical, electrical). Homepage has company
    info, services, registrations (CRB, TCRA, GPSA). No tender listings, no procurement page.
    "Procurement" in GPSA registration context only. Disable until tender content exists.
  selectors:
...
**Category:** Commercial
**Website:** https://kaecobeta.co.tz
**Tender Page:** https://kaecobeta.co.tz
...
```json
{{
  "tender_id": "KAECOBETA-2026-001",
  "institution": "kaecobeta",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://kaecobeta.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KAECOBETA-2026-001/original/tender_document.pdf",
