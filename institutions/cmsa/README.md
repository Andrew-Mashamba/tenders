---
institution:
  name: "Capital Market and Securities Authority"
  slug: "cmsa"
...
**Category:** Government Agency
**Website:** https://cmsa.go.tz/
**Tender Page:** https://cmsa.go.tz/
**Keywords Found:** rfi, tender, tenders

## Contact Information
- Email: info@cmsa.go.tz
- Email: barua@cmsa.go.tz
- Phone: 020
         
- Phone: +255 22 2113846
- Phone: 021
         
- Phone: 024
         
- Phone: +255 22 2114959

## Scraping Instructions

**Strategy:** Scrape https://cmsa.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> some page description here"> Tenders |Capital Market and Securities Authority <link rel="stylesheet" href="https:
...
```json
{{
  "tender_id": "CMSA-2026-001",
  "institution": "cmsa",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "CMSA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://cmsa.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://cmsa.go.tz/storage/tender.pdf",
      "local_path": "./downloads/CMSA-2026-001/original/tender_document.pdf",
