---
institution:
  name: "DART |   Wakala wa Mabasi Yaendayo Haraka - MWANZO"
  slug: "dart"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Known paths: /uploads/routes/*.pdf. Site may be unreachable (SSL). Retry with -k or different client if needed.
...
social_media:
  facebook: "dartmwendokasi"
  twitter: "dartmwendokasi"
  instagram: "dartmwendokasi"

notes: |
  Government Website | Tovuti ya Serikali
---

# DART |   Wakala wa Mabasi Yaendayo Haraka - MWANZO

**Category:** Government Agency
**Website:** https://dart.go.tz/
**Tender Page:** https://dart.go.tz/
**Keywords Found:** bid, eoi, expression of interest, tender, tenders, zabuni
...
**Strategy:** Scrape https://dart.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> blications/vacancies'>Nafasi Za Kazi Zabuni Fursa za Uwekezaji
...
Known document paths: /uploads/routes/pdf-1681478780.pdf
...
```json
{{
  "tender_id": "DART-2026-001",
  "institution": "dart",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "DART/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://dart.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://dart.go.tz/storage/tender.pdf",
      "local_path": "./downloads/DART-2026-001/original/tender_document.pdf",
...
- **Signal Strength:** Strong (eoi, expression of interest, tender, tenders, zabuni)
