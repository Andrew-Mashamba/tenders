...
website:
  homepage: "https://mnyeshilaw.co.tz"
  tender_url: "https://mnyeshilaw.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Mnyeshi Law Office is a commercial law firm. Website has no tender/procurement section. Only legal services, testimonials, contact. No tender content found. Disabled until tender page is identified."
  selectors:
...
notes: |
  Category: Commercial. Law firm - no tender/procurement page. Emails: info@mnyeshilaw.co.tz.
  Scraping disabled: no tender content on mnyeshilaw.co.tz (legal services only).
---

# Mnyeshi Law Office

**Category:** Commercial
**Website:** https://mnyeshilaw.co.tz
**Tender Page:** https://mnyeshilaw.co.tz
...
```json
{{
  "tender_id": "MNYESHILAW-2026-001",
  "institution": "mnyeshilaw",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://mnyeshilaw.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MNYESHILAW-2026-001/original/tender_document.pdf",
