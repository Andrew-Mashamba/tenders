---
institution:
  name: "Idara ya Michezo Zanzibar"
  slug: "michezozanzibar"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "michezozanzibar.go.tz"

website:
  homepage: "https://michezozanzibar.go.tz/"
  tender_url: "https://michezozanzibar.go.tz/"

contact:
  email: "info@michezozanzibar.go.tz"
  phone: "0242232086 "
...
scraping:
  ...
  documents:
    ...
    url_patterns:
      - "michezozanzibar.go.tz/*.pdf"
      - "michezozanzibar.go.tz/SERA-YA-MICHEZO-ZANZIBAR.pdf"
      - "michezozanzibar.go.tz/BAJETI-*.pdf"
    ...
    document_notes: |
      PDFs at site root (e.g. SERA-YA-MICHEZO-ZANZIBAR.pdf, BAJETI-2020.pdf, HISTORIA YA MICHEZO ZANZIBAR.pdf). These are policy/budget docs, not tenders. YouTube channel in old config is not scrapable. mauyetu/ona.php may have additional content.
...
social_media:
  facebook: "Department-Of-Sports-Zanzibar-105927251749175"
  twitter: "YaMichezo"

notes: |
  Organization website at michezozanzibar.go.tz. Tender keywords detected: rfq.
---

# Idara ya Michezo Zanzibar
...
- Email: info@michezozanzibar.go.tz
- Phone: 0242232086 
- Phone: 05927251749175

## Scraping Instructions

**Strategy:** Scrape https://www.youtube.com/channel/UCM1wD05J9R_h5cXKhMoRFqg/featured for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://www.youtube.com/channel/UCM1wD05J9R_h5cXKhMoRFqg/featured

### Document Links Found

- https://michezozanzibar.go.tz/SERA-YA-MICHEZO-ZANZIBAR.pdf
- https://michezozanzibar.go.tz/BAJETI-2020.pdf
- https://michezozanzibar.go.tz/HISTORIA YA MICHEZO ZANZIBAR.pdf
...
```json
{{
  "tender_id": "MICHEZOZANZIBAR-2026-001",
  "institution": "michezozanzibar",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MICHEZOZANZIBAR/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.youtube.com/channel/UCM1wD05J9R_h5cXKhMoRFqg/featured",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://michezozanzibar.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MICHEZOZANZIBAR-2026-001/original/tender_document.pdf",
