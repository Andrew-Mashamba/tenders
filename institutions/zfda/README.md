---
institution:
  name: "Zanzibar Food and Drug Agency (ZFDA)"
  slug: "zfda"
...
website:
  homepage: "https://zfda.go.tz/"
  tender_url: "https://zfda.go.tz/tenders/"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://zfda.go.tz/tenders/ — Elementor page with single tender blocks. Each tender is in an elementor-section with call-to-action widget. Extract title from elementor-widget-heading, document link from elementor-button (a.elementor-button-link), deadline from elementor-widget-countdown. Download all PDF links from /wp-content/uploads/."
  selectors:
    container: "main#main, .site-main, .elementor-section, .elementor-widget-wrap"
    tender_item: ".elementor-widget-call-to-action, .elementor-section[data-widget_type='call-to-action.default']"
    title: ".elementor-widget-heading .elementor-heading-title, h2, h3"
    date: ".elementor-widget-countdown, .elementor-countdown"
    document_link: 'a[href$=".pdf"], a.elementor-button[href*=".pdf"], a[href*="/wp-content/uploads/"]'
    pagination: null
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/wp-content/uploads/"
    url_patterns:
      - "zfda.go.tz/wp-content/uploads/2021/05/Invitation-for-GC.pdf"
      - "zfda.go.tz/wp-content/uploads/*/*.pdf"
    ...
    document_notes: |
      ZFDA uses WordPress Download Manager. Documents in /wp-content/uploads/YYYY/MM/ (e.g. /wp-content/uploads/2021/05/Invitation-for-GC.pdf). Download links appear as elementor-button with "DOWNLOAD INVITATION" text. Tender page may show single or multiple tender blocks; each has its own PDF link.
...
notes: |
  Organization website at zfda.go.tz. Tender keywords detected: bid, bidding, supply, tender, tenders.
---

# TENDERS &#8211; ZFDA

**Category:** Government Agency
**Website:** https://zfda.go.tz/
**Tender Page:** https://zfda.go.tz/tenders/
**Keywords Found:** bid, bidding, supply, tender, tenders
...
**Strategy:** Scrape https://zfda.go.tz/tenders/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> n-GB"> TENDERS &#8211; ZFDA img:is([sizes="auto" i], [sizes^="auto," i]) { contain-intrinsic-size: 3000px 1500px } <meta name

### Known Tender URLs

- https://zfda.go.tz/tenders/
- https://zfda.go.tz/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fzfda.go.tz%2Ftenders%2F
- https://zfda.go.tz/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fzfda.go.tz%2Ftenders%2F&#038;format=xml

### Document Links Found

- https://zfda.go.tz/wp-content/uploads/2021/05/Invitation-for-GC.pdf
...
Known document paths: /wp-content/uploads/2021/05/Invitation-for-GC.pdf
...
{{
  ...
  "reference_number": "ZFDA/T/2026/001",
  ...
  "documents": [
    {{
      ...
      "original_url": "https://zfda.go.tz/storage/tender.pdf",
      "local_path": "./downloads/ZFDA-2026-001/original/tender_document.pdf",
...
- **Signal Strength:** Strong (bidding, tender, tenders)
