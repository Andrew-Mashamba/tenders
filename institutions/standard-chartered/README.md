...
website:
  homepage: "https://www.sc.com/tz/"
  tender_url: "https://www.sc.com/en/suppliers/"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Global supplier page. Filter for Tanzania-specific opportunities."
  selectors:
...
alternative_sources:
  - name: "SC Global Suppliers"
    url: "https://www.sc.com/en/suppliers/"

notes: |
  Global supplier portal. Retail arm transferred to Access Bank (May 2025). Remaining operations are corporate/institutional.
---
