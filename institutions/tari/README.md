...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Page unreachable during analysis. Content preview showed Matangazo (announcements) and procurement menu items. Verify tender URL and document paths on first successful scrape.
...
# TARI |     TAASISI YA UTAFITI WA KILIMO TANZANIA - Mwanzo

**Category:** Government Agency
**Website:** https://tari.go.tz/
**Tender Page:** https://tari.go.tz/
**Keywords Found:** bid, procurement, zabuni

## Contact Information
- Email: dg@tari.go.tz
- Phone: 016 - 2026
- Phone: 05135339923152
- Phone: 026
         

## Scraping Instructions

**Strategy:** Scrape https://tari.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> > Ukaguzi wa Ndani Ugavi Tehama <a href='#' class='nav-link' data-toggle='dro
...
```json
{{
  "tender_id": "TARI-2026-001",
  "institution": "tari",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TARI/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://tari.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://tari.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TARI-2026-001/original/tender_document.pdf",
...
- **Signal Strength:** Strong (procurement, zabuni)
