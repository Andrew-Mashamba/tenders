...
website:
  homepage: "https://pc.go.tz/"
  tender_url: "https://pc.go.tz/tenders/"

contact:
  email: "barua@pc.go.tz"
  alternate_emails:
    - "info@pc.go.tz"
  phone: "026-02-11"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://pc.go.tz/tenders/ — Bootstrap layout. Page shows notavailable.webp when no tenders. When tenders exist, check main content area. Documents at /files/ and /site/uploads/newsletters/."
  selectors:
    container: ".col-md-10, .container, main"
    tender_item: "article, .tender-item, .card, .row, .dropdown-menu .dropdown-item"
  ...
  documents:
    ...
    known_document_paths:
      - "/files/"
      - "/site/uploads/newsletters/"

    url_patterns:
      - "pc.go.tz/files/*"
      - "pc.go.tz/site/uploads/newsletters/*"
    ...
    document_notes: |
      Documents at /files/ (e.g. file_69a9a4fd2931a1.06052959.pdf) and /site/uploads/newsletters/. Tenders page may show placeholder when empty.
...
social_media:
  facebook: "people"
  twitter: "Pharm_Council"
  instagram: "pharmacy_council_tanzania"

notes: |
  Baraza la Famasi | Pharmacy Council
---

# PC | Home

**Category:** Government Agency
**Website:** https://pc.go.tz/
**Tender Page:** https://pc.go.tz/tenders/
...
- Phone: 0595871849
- Phone: 0800 11 00 15 
- Phone: 02109280656252

## Scraping Instructions

**Strategy:** Scrape https://pc.go.tz/tenders/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> a class="dropdown-item" href="vacancies/"> Vacancies Tenders Consultancy <li class

### Known Tender URLs

- https://pc.go.tz/tenders/

### Document Links Found

- https://pc.go.tz/files/file_69a9a4fd2931a1.06052959.pdf
- https://pc.go.tz/site/uploads/newsletters/Pharmacy Council Newsletter Vol.4 Issue 4.pdf
- https://pc.go.tz/site/uploads/newsletters/PharmacyCouncilNewsletterVol.4Issue3.pdf
- https://pc.go.tz/files/file_698c8e2062e483.83475826.pdf
- https://pc.go.tz/files/file_69691674f21951.66710406.pdf
- https://pc.go.tz/site/uploads/newsletters/Pharmacy Council Newsletter Vol.5 Issue 1.pdf
...
Known document paths: /uploads/newsletters/PharmacyCouncilNewsletterVol.4Issue3.pdf
...
```json
{{
  "tender_id": "PC-2026-001",
  "institution": "pc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "PC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://pc.go.tz/tenders/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://pc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/PC-2026-001/original/tender_document.pdf",
