---
institution:
  name: "Tanzania Health Promotion Support"
  slug: "thps"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      WordPress site with Download Manager. Documents likely in /wp-content/uploads/ or
      via wpdm plugin. /tenders/ returns 404 - discover links from homepage/sitemap.
...
{{
  ...
  "category": "NGO/Non-Profit",
  "status": "active",
  "source_url": "https://thps.or.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/THPS-2026-001/original/tender_document.pdf",
