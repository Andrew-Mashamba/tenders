...
website:
  homepage: "https://kreative.co.tz"
  tender_url: "https://kreative.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Account suspended (hosting). Page shows 'This Account has been suspended.' No tender content reachable. Re-enable when site is restored."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Account suspended. No documents accessible. Disabled until site is restored.
...
**Category:** Commercial
**Website:** https://kreative.co.tz
**Tender Page:** https://kreative.co.tz
...
```json
{{
  "tender_id": "KREATIVE-2026-001",
  "institution": "kreative",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://kreative.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KREATIVE-2026-001/original/tender_document.pdf",
