...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "afroilgroup.co.tz"

website:
  homepage: "https://afroilgroup.co.tz/"
  tender_url: "https://afroilgroup.co.tz/"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape homepage and /news/ for procurement/RFI notices. WordPress/Elementor site. Check Latest News section and news archive for tender-related posts."
  selectors:
    container: ".elementor-widget-wrap, .elementor-section, main, .entry-content"
    tender_item: "article, .elementor-post, .qode-news-item"
    title: "h2, h3, h4, .elementor-post__title a, .qode-news-title a"
    date: ".elementor-post-date, .qode-news-date, .date"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[download]'
    pagination: ".pagination a, a.next, .nav-links a, .elementor-pagination"
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/wp-content/uploads/"
    url_patterns:
      - "afroilgroup.co.tz/wp-content/uploads/*.pdf"
      - "afroilgroup.co.tz/news/*"
    ...
    document_notes: |
      WordPress site. Documents typically in /wp-content/uploads/. Check /news/ for procurement notices. No dedicated tender page found; scrape news/events for RFI/supply notices.
...
social_media:
  facebook: "AfroilTanzania"
  linkedin: "afroilgroup"
  instagram: "afroiltanzania"

notes: |
  Organization website at afroilgroup.co.tz. Tender keywords detected: procurement, rfi, supply.
---

# Home - AFROIL

**Category:** Energy / Mining
**Website:** https://afroilgroup.co.tz/
**Tender Page:** https://afroilgroup.co.tz/
...
**Strategy:** Scrape https://afroilgroup.co.tz/ for tender/procurement notices.
**Method:** http_get
...
> ortation Coordinator (P.I.C. Ltd), a company formed by oil marketers in Tanzania to manage the bulk procurement of petroleum products . <section class="elementor-section elementor-inner-section elem
...
```json
{{
  "tender_id": "AFROILGROUP-2026-001",
  "institution": "afroilgroup",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "AFROILGROUP/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://afroilgroup.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://afroilgroup.co.tz/storage/tender.pdf",
      "local_path": "./downloads/AFROILGROUP-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "tenders@afroilgroup.co.tz",
    "phone": "01-3-1000",
    "address": "..."
  }},
...
- **Active Tenders:** 0
- **Signal Strength:** Weak (corporate news only, no procurement notices)
