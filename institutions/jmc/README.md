...
website:
  homepage: "https://jmc.co.tz"
  tender_url: "https://jmc.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    JMC Express (bus booking platform) has a /about-us/tender page but it is EMPTY — no tender content,
    no listings, no document links. Page shows only empty page_title and paragraph. Disable until
    JMC adds actual tender content.
  selectors:
    container: ".l-main-container, .container"
    tender_item: ""
    title: ".page_title"
    date: ""
...
**Category:** Commercial
**Website:** https://jmc.co.tz
**Tender Page:** https://jmc.co.tz/about-us/tender
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://jmc.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/JMC-2026-001/original/tender_document.pdf",
