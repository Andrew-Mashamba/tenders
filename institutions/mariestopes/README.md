---
institution:
  name: "Marie Stopes Tanzania"
  # Verified from https://mariestopes.or.tz - reproductive health NGO, no tender section found
  slug: "mariestopes"
...
website:
  homepage: "https://mariestopes.or.tz"
  tender_url: "https://mariestopes.or.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "No dedicated tender/procurement page found. Homepage is health services focused (Marie Stopes Tanzania)."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender page found. Site is WordPress (wp-content/uploads/). Scraping disabled until tender URL is identified.
...
**Category:** NGO/Non-Profit
**Website:** https://mariestopes.or.tz
**Tender Page:** https://mariestopes.or.tz
...
```json
{{
  "tender_id": "MARIESTOPES-2026-001",
  "institution": "mariestopes",
  ...
  "category": "NGO/Non-Profit",
  "status": "active",
  "source_url": "https://mariestopes.or.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MARIESTOPES-2026-001/original/tender_document.pdf",
