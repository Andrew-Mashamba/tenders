...
notes: |
  DISABLED: Site broken as of 2026-03-15. PHP fatal error. Domain may be parked or repurposed. Content appears unrelated to Tanzanian procurement. Re-enable when site is restored.
---

# ฝาก 10 รับ 100 ไม่ต้องแชร์ โปรโมชั่นสุดคุ้ม ล่าสุด 2024

**Category:** Commercial
**Website:** https://dmax.co.tz
**Tender Page:** https://dmax.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://dmax.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/DMAX-2026-001/original/tender_document.pdf",
