...
website:
  homepage: "https://tender.brac.net/"
  tender_url: "https://tender.brac.net/"
...
scraping:
  ...
  selectors:
    ...
    title: "td, h3, .title"
    date: "td, .deadline, .closing-date"
    country_filter: "Tanzania"
    document_link: "a[href$='.pdf'], a[download]"
    search_form: "form, .search, .filter"
    requires_login: true
  schedule: "daily"
  ...
  documents:
    ...
    document_notes: |
      e-Tender system. May require login to download documents. Filter for Tanzania.
...
alternative_sources:
  - name: "BRAC Procurement Portal"
    url: "https://procurement.brac.net/"

notes: |
  Separate e-tender system from the main BRAC procurement portal (procurement.brac.net).
  Currently primarily lists Bangladesh tenders. Tanzania-specific tenders may appear
  periodically. May require registration/login to access full listings.
  Related institution folder: brac-tanzania
---

# BRAC e-Tender System

**Category:** Tender Aggregator
**Website:** https://tender.brac.net/
**Tender Page:** https://tender.brac.net/

## Scraping Instructions

**Strategy:** Scrape e-tender listings, filter by country=Tanzania. May require login.
**Method:** http_get_with_auth

## Relationship to Other BRAC Sources

- **procurement.brac.net** — Main procurement portal (see `brac-tanzania` folder)
- **tender.brac.net** — This e-tender system, more structured/automated

## Notes

Currently mostly Bangladesh listings. Monitor for Tanzania entries.
