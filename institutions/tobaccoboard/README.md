---
institution:
  name: "Tanzania Tobacco Board (TTB)"
  slug: "tobaccoboard"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "tobaccoboard.go.tz"

website:
  homepage: "https://tobaccoboard.go.tz/"
  tender_url: "https://tobaccoboard.go.tz/page/procurement-management-unit"
...
scraping:
  ...
  documents:
    ...
    known_document_paths:
      - "/uploads/documents/"
    url_patterns:
      - "tobaccoboard.go.tz/uploads/documents/*.pdf"
    ...
    document_notes: |
      Documents in /uploads/documents/ (e.g. TOBACCO BUYING REPORT, TAARIFA YA MWISHO). SSL may fail on curl;
      use browser or -k for testing. Site may block automated requests.
...
social_media:
  facebook: "tanzaniatobacco.board.1"
  instagram: "tztobaccoboard"

notes: |
  Organization website at tobaccoboard.go.tz. Tender keywords detected: procurement.
---

# Bodi ya Tumbaku Tanzania - TTB

**Category:** Government Agency
**Website:** https://tobaccoboard.go.tz/
**Tender Page:** https://tobaccoboard.go.tz/page/procurement-management-unit
...
> afafa;"> Usimamizi wa Ununuzi

### Known Tender URLs

- https://tobaccoboard.go.tz/page/procurement-management-unit

### Document Links Found

- https://www.tobaccoboard.go.tz/uploads/documents/TOBACCO BUYING REPORT FOR THE WEEK ENDING 15 JUNE 2025.pdf
- https://www.tobaccoboard.go.tz/uploads/documents/TOBACCO BUYING REPORT FOR THE WEEK ENDING 01 JUNE 2025.pdf
- https://www.tobaccoboard.go.tz/uploads/documents/TAARIFA YA MWISHO YA UZALISHAJI MSIMU 2024-2025.pdf
- https://www.tobaccoboard.go.tz/uploads/documents/TOBACCO BUYING REPORT FOR THE WEEK ENDING 08 JUNE 2025.pdf
...
```json
{{
  "tender_id": "TOBACCOBOARD-2026-001",
  "institution": "tobaccoboard",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TOBACCOBOARD/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://tobaccoboard.go.tz/page/procurement-management-unit",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://tobaccoboard.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TOBACCOBOARD-2026-001/original/tender_document.pdf",
