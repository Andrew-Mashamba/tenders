...
website:
  homepage: "https://kimbinyiko.co.tz"
  tender_url: "https://kimbinyiko.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Bus company (KIMBINYIKO INT. COACH). /about-us/tender shows 'please wait' and generic About Us content with no tender listings. Page may be SPA or misconfigured. Re-enable if tender page is added."
  selectors:
...
**Category:** Commercial
**Website:** https://kimbinyiko.co.tz
**Tender Page:** https://kimbinyiko.co.tz/about-us/tender
...
```json
{{
  "tender_id": "KIMBINYIKO-2026-001",
  "institution": "kimbinyiko",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://kimbinyiko.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KIMBINYIKO-2026-001/original/tender_document.pdf",
