...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "zanefinance.co.tz"

website:
  homepage: "https://zanefinance.co.tz/"
  tender_url: "https://zanefinance.co.tz/"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://zanefinance.co.tz/ for tender/procurement notices."
  selectors:
...
notes: |
  Organization website at zanefinance.co.tz. Tender keywords detected: manunuzi, rfi.
---

# Zane Finance

**Category:** Microfinance / Financial Services
**Website:** https://zanefinance.co.tz/
**Tender Page:** https://zanefinance.co.tz/
**Keywords Found:** manunuzi, rfi

## Contact Information
- Phone: 018-01-29
- Phone: 08 779 692 767
- Phone: 04 296 221 308
- Phone: 08 521 713 504
- Phone: 00 217 708 204
...
```json
{{
  "tender_id": "ZANEFINANCE-2026-001",
  "institution": "zanefinance",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ZANEFINANCE/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://zanefinance.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://zanefinance.co.tz/storage/tender.pdf",
      "local_path": "./downloads/ZANEFINANCE-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "tenders@zanefinance.co.tz",
    "phone": "018-01-29",
    "address": "..."
  }},
