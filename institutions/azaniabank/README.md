...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "azaniabank.co.tz"

website:
  homepage: "https://azaniabank.co.tz/"
  tender_url: "https://azaniabank.co.tz/tenders/"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape /tenders/ page. Tenders are in accordion toggles (.cmsmasters_toggle_wrap). Each toggle has title in .cmsmasters_toggle_title and document link in .cmsmasters_toggle_inner p a. Extract all PDF links from toggle content."
  selectors:
    container: ".cmsmasters_toggles, .content.entry, #middle"
    tender_item: ".cmsmasters_toggle_wrap"
    title: ".cmsmasters_toggle_title a"
    date: ".cmsmasters_toggle_title"
    document_link: '.cmsmasters_toggle_inner a[href$=".pdf"], .cmsmasters_toggle_inner a[href$=".doc"], .cmsmasters_toggle_inner a[href$=".docx"]'
  ...
  documents:
    ...
    url_patterns:
      - "azaniabank.co.tz/wp-content/uploads/*/*/*.pdf"
    ...
    document_notes: |
      WordPress; documents in /wp-content/uploads/YYYY/MM/. Tender documents use Tender Document, Tender Notice, Pre-qualification Document labels. Multiple PDFs per tender possible (e.g. clarifications).
...
social_media:
  facebook: "azaniabankltd"
  instagram: "azaniabankplc"

notes: |
  Organization website at azaniabank.co.tz. Tender keywords detected: tender, tenders.
---

# Azania Bank &#8211; Banking Beyond Ordinary

**Category:** Bank
**Website:** https://azaniabank.co.tz/
**Tender Page:** https://azaniabank.co.tz/tenders/
...
**Strategy:** Scrape https://azaniabank.co.tz/tenders/ for banking tender notices and EOIs. Banks post frequently.
**Method:** http_get
...
> m menu-item-type-post_type menu-item-object-page menu-item-15135"> Tenders <a href="https://azaniabank.co.t

### Known Tender URLs

- https://azaniabank.co.tz/tenders/

### Document Links Found

- https://azaniabank.co.tz/wp-content/uploads/2022/04/personal-3.pdf
- https://azaniabank.co.tz/wp-content/uploads/2022/04/business-3.pdf
...
Known document paths: /wp-content/uploads/2022/04/personal-3.pdf, /wp-content/uploads/2022/04/business-3.pdf
...
```json
{{
  "tender_id": "AZANIABANK-2026-001",
  "institution": "azaniabank",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "AZANIABANK/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://azaniabank.co.tz/tenders/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://azaniabank.co.tz/storage/tender.pdf",
      "local_path": "./downloads/AZANIABANK-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "tenders@azaniabank.co.tz",
    "phone": "0800 110 210",
    "address": "..."
  }},
