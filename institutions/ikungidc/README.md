...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "ikungidc.go.tz"

website:
  homepage: "https://ikungidc.go.tz/"
  tender_url: "https://ikungidc.go.tz/tenders"

contact:
  email: "ded.ikungidc@singida.go.tz"
  phone: "083657594"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Two paths: /storage/app/uploads/public/ (hash-style) and /storage/app/media/ (direct filenames, may be percent-encoded). Table-based tender listing. Site may be slow—use rate_limit_seconds.
...
# Home &#124; Ikungi District Council

**Category:** Local Government Authority
**Website:** https://ikungidc.go.tz/
**Tender Page:** https://ikungidc.go.tz/tenders
...
**Strategy:** Scrape https://ikungidc.go.tz/tenders for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> Tender More <table class="table table-striped"

### Known Tender URLs

- https://ikungidc.go.tz/tenders
- https://ikungidc.go.tz/procurement

### Document Links Found

- https://ikungidc.go.tz/storage/app/media/IDADI%20YA%20WATU%20KWA%20UMRI.pdf
- https://ikungidc.go.tz/storage/app/uploads/public/630/384/ad5/630384ad5e57d083657594.pdf
- https://ikungidc.go.tz/storage/app/uploads/public/67e/a2f/dda/67ea2fdda0016596713782.pdf
- https://ikungidc.go.tz/storage/app/media/idadi%20ya%20kaya%201.pdf
- https://ikungidc.go.tz/storage/app/media/TARAFA-1.pdf
- https://ikungidc.go.tz/storage/app/media/IDADI%20YA%20SHULE-3.pdf
- https://ikungidc.go.tz/storage/app/media/TAKWIMU%20ZA%20AFYA%20IKUNGI.pdf
- https://ikungidc.go.tz/storage/app/media/Ikungi%20yetu.pdf
- https://ikungidc.go.tz/storage/app/media/graph-ya-idadi-ya-watu-ikungi-1.pdf
- https://ikungidc.go.tz/storage/app/uploads/public/5c7/cc6/ba4/5c7cc6ba4cbad189695190.pdf
...
Known document paths: /storage/app/uploads/public/630/384/ad5/630384ad5e57d083657594.pdf, /storage/app/media/MATOKEO%20YA%20SENSA%20KITAIFA%20NA%20MKOA.pdf, /storage/app/media/TAKWIMU%20ZA%20AFYA%20IKUNGI.pdf
...
```json
{{
  "tender_id": "IKUNGIDC-2026-001",
  "institution": "ikungidc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "IKUNGIDC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://ikungidc.go.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://ikungidc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/IKUNGIDC-2026-001/original/tender_document.pdf",
