...
website:
  homepage: "https://juco.ac.tz"
  tender_url: "https://juco.ac.tz"
...
scraping:
  ...
  selectors:
    ...
    date: ""
    document_link: 'a[href*="jslabtec/documents/"][href$=".pdf"]'
    pagination: ""
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "juco.ac.tz/jslabtec/documents/*.pdf"
    ...
    document_notes: |
      Documents found under /jslabtec/documents/. Check for additional paths during scraping.
...
notes: |
  ...
  Emails: admission@juco.ac.tz, info@juco.ac.tz.
...
**Category:** Academic
**Website:** https://juco.ac.tz
**Tender Page:** https://juco.ac.tz
...
Known document paths: /jslabtec/documents/
...
{{
  ...
  "category": "Academic",
  "status": "active",
  "source_url": "https://juco.ac.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/JUCO-2026-001/original/tender_document.pdf",
