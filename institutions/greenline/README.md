...
website:
  homepage: "https://greenline.co.tz"
  tender_url: "https://greenline.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Tender page /about-us/tender returns minimal content (bus booking platform). Page may be SPA or placeholder. No tender listing structure found."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender content on /about-us/tender. greenline.co.tz is a bus booking platform; tender page appears empty or JS-rendered. Disabled until tender content is available.
...
**Category:** Commercial
**Website:** https://greenline.co.tz
**Tender Page:** https://greenline.co.tz/about-us/tender
...
```json
{{
  "tender_id": "GREENLINE-2026-001",
  "institution": "greenline",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://greenline.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/GREENLINE-2026-001/original/tender_document.pdf",
