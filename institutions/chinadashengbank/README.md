...
institution:
  ...
  slug: "chinadashengbank"
  category: "Bank"
  status: "active"
  country: "Tanzania"
  domain: "chinadashengbank.co.tz"

website:
  homepage: "https://chinadashengbank.co.tz/"
  tender_url: "https://chinadashengbank.co.tz/"
...
scraping:
  ...
  selectors:
    ...
    title: "a"
    date: null
    document_link: 'a[href*="uploads/"], a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"]'
    pagination: null
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "chinadashengbank.co.tz/uploads/*.pdf"
      - "chinadashengbank.co.tz/uploads/*.doc"
    ...
    document_notes: |
      EOI and tender documents appear in the homepage marquee. Documents are hosted at /uploads/ (e.g. ExpressionOfInterest.pdf). No dedicated tender listing page; scrape main content for announcement links.
...
notes: |
  Organization website at chinadashengbank.co.tz. Tender keywords detected: expression of interest.
---

# China Dasheng Bank | Smart Banking

**Category:** Bank
**Website:** https://chinadashengbank.co.tz/
**Tender Page:** https://chinadashengbank.co.tz/
...
**Strategy:** Scrape https://chinadashengbank.co.tz/ for banking tender notices and EOIs. Banks post frequently.
**Method:** http_get
...
- https://chinadashengbank.co.tz/uploads/ExpressionOfInterest.pdf
...
Known document paths: /uploads/ExpressionOfInterest.pdf
...
```json
{{
  "tender_id": "CHINADASHENGBANK-2026-001",
  "institution": "chinadashengbank",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "CHINADASHENGBANK/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://chinadashengbank.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://chinadashengbank.co.tz/storage/tender.pdf",
      "local_path": "./downloads/CHINADASHENGBANK-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "tenders@chinadashengbank.co.tz",
    "phone": "00
          ",
    "address": "..."
  }},
