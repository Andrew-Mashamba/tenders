---
institution:
  name: "Peoples Bank of Zanzibar (PBZ)"
  slug: "pbz-bank"
...
website:
  homepage: "https://pbzbank.co.tz/"
  tender_url: "http://www.tenders.zppda.go.tz/entities/view/peoples-bank-of-zanzibar-pbz"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape the ZPPDA portal page for PBZ tenders. Zanzibar-based institution uses ZPPDA procurement system."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Tenders via ZPPDA portal. Download documents from the ZPPDA entity page.
...
**Category:** Commercial Bank  
**Website:** https://pbzbank.co.tz/  
**Tender Page:** http://www.tenders.zppda.go.tz/entities/view/peoples-bank-of-zanzibar-pbz  
