---
institution:
  name: "Dodoma Urban Water Supply and Sanitation Authority (DUWASA)"
  slug: "duwasa"
...
website:
  homepage: "https://duwasa.go.tz/"
  tender_url: "https://duwasa.go.tz/tenders"
...
scraping:
  ...
  selectors:
    ...
    title: "a"
    date: "a"
    document_link: 'a[href*="uploads/tenders"]'
    pagination: "" 
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "duwasa.go.tz/uploads/tenders/*.pdf"
      - "duwasa.go.tz/uploads/tenders/en-*.pdf"
    ...
    document_notes: |
      Documents at /uploads/tenders/ with pattern en-{timestamp}-{filename}.pdf. Title and Deadline YYYY-MM-DD are in the link text. Parse "Deadline YYYY-MM-DD" for closing_date. No pagination—all tenders on single page.
...
**Category:** Water Utility
**Website:** https://duwasa.go.tz/
**Tender Page:** https://duwasa.go.tz/tenders
**Keywords Found:** procurement, rfi, supply, tender, tenders

## Contact Information
- Email: md@duwasa.go.tz
- Phone: 025-10-08 
- Phone: 0800110078
- Phone: +255 26 2324245
- Phone: 024
...
**Strategy:** Scrape https://duwasa.go.tz/tenders for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> > Procurement General Procurement Notice <a class='dropdown-i

### Known Tender URLs

- https://duwasa.go.tz/tenders
...
```json
{{
  "tender_id": "DUWASA-2026-001",
  "institution": "duwasa",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "DUWASA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://duwasa.go.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://duwasa.go.tz/storage/tender.pdf",
      "local_path": "./downloads/DUWASA-2026-001/original/tender_document.pdf",
