---
institution:
  name: "National Board of Accountants and Auditors (NBAA)"
  slug: "nbaa"
...
website:
  homepage: "https://nbaa.go.tz/"
  tender_url: "https://nbaa.go.tz/"

contact:
  email: "info@nbaa.go.tz"
  phone: "025-10-26"

scraping:
  enabled: true
  method: "http_get"
  strategy: "NBAA posts announcements (admissions, subscriptions, notices) not traditional tenders. Scrape /announcements for procurement-related notices. Documents at /uploads/text-editor/files/ and /examinations/."
  selectors:
    container: "#particles-js ~ *, .announcements-section, main"
    tender_item: "a[href*='/announcements/']"
    title: "div, .announcement-title"
    date: ".date, small, .announcement-date"
    document_link: 'a[href*="/uploads/text-editor/"], a[href*="/examinations/"], a[href$=".pdf"]'
  ...
  documents:
    ...
    known_document_paths:
      ...
      - "/examinations/"
    url_patterns:
      - "nbaa.go.tz/uploads/text-editor/files/*.pdf"
      - "nbaa.go.tz/examinations/*.pdf"
    ...
    document_notes: |
      NBAA is accounting/audit board - posts announcements not procurement tenders. Documents: /uploads/text-editor/files/, /examinations/ (atecsyllabus.pdf, professionalsyllabus.pdf). Filter for procurement-related announcements.
...
social_media:
  facebook: "The-National-Board-of-Accountants-and-Auditors-1972-2022-102288092588795"
  twitter: "nbaa50years"
  instagram: "nbaa50yearsanniversary"

notes: |
  Government Website | Tovuti ya Serikali
---

# NBAA |     National Board of Accountants and Auditors - Home

**Category:** Government Agency
**Website:** https://nbaa.go.tz/
**Tender Page:** https://nbaa.go.tz/
**Keywords Found:** tender, tenders

## Contact Information
- Email: info@nbaa.go.tz
- Phone: 025-10-26
- Phone: +255 22 2 211890
- Phone: 025-11-13
- Phone: 026-02-02
- Phone: +255 22 2 151746

## Scraping Instructions

**Strategy:** Scrape https://nbaa.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> -Office NeST Employee Self Service <a target='_blank' rel='noopener

### Document Links Found

- https://www.nbaa.go.tz/examinations/atecsyllabus.pdf
- https://www.nbaa.go.tz/examinations/professionalsyllabus.pdf
...
Known document paths: /uploads/text-editor/files/exam_fees_structure_1770029172.pdf
...
```json
{{
  "tender_id": "NBAA-2026-001",
  "institution": "nbaa",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "NBAA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://nbaa.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://nbaa.go.tz/storage/tender.pdf",
      "local_path": "./downloads/NBAA-2026-001/original/tender_document.pdf",
