...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "boitanzania.co.tz"

website:
  homepage: "https://boitanzania.co.tz/"
  tender_url: "https://boitanzania.co.tz/"

contact:
  phone: "08623326433819"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Site protected by reCAPTCHA - blocks automated access. Cannot scrape without solving captcha. Requires browser/headless with captcha bypass."
  selectors:
...
notes: |
  BOI Tanzania. Site shows 'Checking your browser - reCAPTCHA' - blocks automated scraping. Tender keywords: bid. Disabled until captcha bypass available.
---

# Checking your browser - reCAPTCHA

**Category:** Commercial / Private Sector
**Website:** https://boitanzania.co.tz/
**Tender Page:** https://boitanzania.co.tz/
**Keywords Found:** bid
...
**Strategy:** Scrape https://boitanzania.co.tz/ for tender/procurement notices.
**Method:** http_get
...
```json
{{
  "tender_id": "BOITANZANIA-2026-001",
  "institution": "boitanzania",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "BOITANZANIA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://boitanzania.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://boitanzania.co.tz/storage/tender.pdf",
      "local_path": "./downloads/BOITANZANIA-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "tenders@boitanzania.co.tz",
    "phone": "08623326433819",
    "address": "..."
  }},
