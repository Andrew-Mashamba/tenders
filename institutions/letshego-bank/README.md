...
website:
  homepage: "https://www.letshego.com/tanzania"
  tender_url: "https://www.letshego.com/tanzania"

scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. Has supplier pre-qualification form as PDF download."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
  ...
  documents:
    ...
    url_patterns:
      - "www.letshego.com/tanzania/*.pdf"
      - "www.letshego.com/tanzania/*.docx"
      - "www.letshego.com/tanzania/*.xlsx"
...
alternative_sources:
  - name: "Letshego Supplier Form"
    url: "https://www.letshego.com/sites/default/files/u553/Letshego%20Faidika%20Bank_Supplier%20Registration%20%26%20Pre-Qualification%20Form.pdf"

notes: |
  No tender page. Supplier Registration & Pre-Qualification Form available as PDF on website.
---

# Letshego Bank Tanzania

**Category:** Commercial Bank  
**Website:** https://www.letshego.com/tanzania  
**Tender Page:** null  
