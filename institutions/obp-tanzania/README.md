---
institution:
  name: "Ocean Business Partners"
  slug: "obp-tanzania"
  category: "Commercial / Private Sector"
  status: "active"
  country: "Tanzania"
  domain: "obp-tanzania.co.tz"

website:
  homepage: "https://obp-tanzania.co.tz/"
  tender_url: "https://obp-tanzania.co.tz/ourservices.html#procurement"

contact:
  email: "info@obp-tanzania.co.tz"
...
scraping:
  ...
  selectors:
    ...
    title: ".case-study__page-content-title.obHeader, h3"
  ...
  documents:
    ...
    document_notes: |
      No tender documents found on page. Services page only; no actual tender notices or document links.
...
notes: |
  Organization website at obp-tanzania.co.tz. Tender keywords detected: bid, eoi, procurement, supply, tender.
---

# Ocean Business Partners

**Category:** Commercial / Private Sector
**Website:** https://obp-tanzania.co.tz/
**Tender Page:** https://obp-tanzania.co.tz/ourservices.html#procurement
**Keywords Found:** bid, eoi, procurement, supply, tender
...
**Strategy:** Scrape https://obp-tanzania.co.tz/ourservices.html#procurement for tender/procurement notices.
**Method:** http_get
...
> rocurement Working closely with our clients, we aim to prepare tender documents, support them in the evaluation of bids, and design contracts for project execution... SEE MORE </

### Known Tender URLs

- https://obp-tanzania.co.tz/ourservices.html#procurement
...
```json
{{
  "tender_id": "OBP-TANZANIA-2026-001",
  "institution": "obp-tanzania",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "OBP-TANZANIA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://obp-tanzania.co.tz/ourservices.html#procurement",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://obp-tanzania.co.tz/storage/tender.pdf",
      "local_path": "./downloads/OBP-TANZANIA-2026-001/original/tender_document.pdf",
