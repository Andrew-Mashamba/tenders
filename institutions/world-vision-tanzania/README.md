---
institution:
  name: "World Vision Tanzania"
  slug: "world-vision-tanzania"
  category: "NGO / Development Organization"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://www.wvi.org/tanzania"
  tender_url: "https://www.wvi.org/tanzania/tenders"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape the /tanzania/tenders page for procurement opportunities. World Vision is the parent org of VisionFund Tanzania microfinance. Drupal-based site — look for views-row pattern. Tenders include both World Vision direct and VisionFund Tanzania procurement."
  selectors:
    container: ".view-content, .content, main, .tenders"
    tender_item: ".views-row, article, .card, .tender-item"
    title: "h2, h3, .views-field-title a, .title"
    date: ".views-field-field-date, .date, time, .deadline"
    location: ".views-field-field-location, .location"
  ...
  documents:
    ...
    document_notes: |
      Drupal site. Documents in /sites/default/files/. Parent org of VisionFund Tanzania.
...
alternative_sources:
  - name: "World Vision Global Suppliers"
    url: "https://www.wvi.org/suppliers/tenders"
  - name: "TANePS"
    url: "https://www.taneps.go.tz/"

notes: |
  Parent organization of VisionFund Tanzania microfinance. VisionFund's own website
  (vftz.co.tz) is not yet live, so all tenders go through this World Vision Tanzania page.
  Drupal-based website. Tenders may cover both World Vision programs and VisionFund
  microfinance procurement needs.
  Related institution folder: visionfund
---

# World Vision Tanzania

**Category:** NGO / Development Organization
**Website:** https://www.wvi.org/tanzania
**Tender Page:** https://www.wvi.org/tanzania/tenders

## Scraping Instructions

**Strategy:** Scrape /tanzania/tenders Drupal views page. Filter for financial/microfinance-related tenders.
**Method:** http_get

## Relationship to VisionFund Tanzania

- VisionFund Tanzania (see `visionfund` folder) is a subsidiary of World Vision
- VisionFund's own site (vftz.co.tz) is not yet live
- All VisionFund procurement goes through this World Vision Tanzania tender page

## Notes

Drupal-based site. Look for `.views-row` patterns in the tender listings.
...
{{
  ...
  "institution": "world-vision-tanzania",
