---
institution:
  name: "Everlasting Business Solutions"
  slug: "ebs"
  category: "Commercial"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://ebs.co.tz"
  tender_url: "https://ebs.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Everlasting Business Solutions offers consulting, ICT, training, procurement management services. Homepage has no tender listing—only service descriptions and contact form. Company prepares tender documents for clients but does not publish open tenders."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender listing on site. EBS provides procurement management services to clients but does not publish tenders. Re-enable if ebs.co.tz adds a tender/procurement notices page.
...
notes: |
  Category: Commercial. Keywords found: tender, procurement.
  Emails: info@ebs.co.tz.
...
**Category:** Commercial
**Website:** https://ebs.co.tz
**Tender Page:** https://ebs.co.tz
...
Keywords found on site: tender, procurement
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://ebs.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/EBS-2026-001/original/tender_document.pdf",
