---
institution:
  name: "National Council for Technical and Vocational Education and Training (NACTVET)"
  slug: "nacte"
...
website:
  homepage: "https://www.nactvet.go.tz/"
  tender_url: "https://www.nactvet.go.tz/page/procurement-management"

contact:
  email: "info@nactvet.go.tz"
  alternate_emails:
    - "info@nacte.go.tz"
  phone: "025-2026 "
...
scraping:
  ...
  selectors:
    ...
    title: "td:first-child, h2, h3, .tender-title, a"
    date: "td:nth-child(2), td:nth-child(3), .date, time"
    document_link: 'a[href*="/storage/public/files/"], a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[download]'
    pagination: ".pagination a, a.next, .dataTables_paginate a"
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "nactvet.go.tz/storage/public/files/*.pdf"
      - "nactvet.go.tz/storage/public/files/*.doc"
      - "nactvet.go.tz/storage/public/files/*.docx"
    ...
    document_notes: |
      Documents stored at /storage/public/files/. Page uses DataTables - may require JS for table rendering. Check page/downloads for document links.
...
notes: |
  Organization website at nacte.go.tz. Tender keywords detected: procurement, rfi.
---

# The National Council for Technical and Vocational Education and Training (NACTVET) | Striving for world-class excellence in Technical and Vocational Education and Training

**Category:** Government Agency
**Website:** https://www.nactvet.go.tz/
**Tender Page:** https://www.nactvet.go.tz/page/procurement-management
...
- Phone: 026           
- Phone: 01005200369
- Phone: +255 22 2780 077

## Scraping Instructions

**Strategy:** Scrape https://www.nactvet.go.tz/page/procurement-management for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> nce-and-accounts">Finance and Accounts Procurement Management Internal Audit <a href="https://www.nactvet.go.tz/page/
...
- https://www.nactvet.go.tz/storage/public/files/ALMANAC_FOR_NACTVET_COUNCIL_2025_2026.pdf
- https://www.nactvet.go.tz/storage/public/files/GUIDEBOOK_FOR_ALL_NTA_2025_2026_UPDATED.pdf
- https://www.nactvet.go.tz/storage/public/files/UPDATED CALENDAR FOR ACADEMIC YEAR 2025-2026 Mdage.pdf
- https://www.nactvet.go.tz/storage/public/files/GUIDEBOOK_FOR_ALL_UNIVERSITIES_2025_2026.pdf
...
Known document paths: /storage/public/files/ALMANAC_FOR_NACTVET_COUNCIL_2025_2026.pdf, /storage/public/files/GUIDEBOOK_FOR_ALL_UNIVERSITIES_2025_2026.pdf, /storage/public/files/GUIDEBOOK_FOR_ALL_NTA_2025_2026_UPDATED.pdf
...
```json
{{
  "tender_id": "NACTE-2026-001",
  "institution": "nacte",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "NACTE/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.nactvet.go.tz/page/procurement-management",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://www.nactvet.go.tz/storage/tender.pdf",
      "local_path": "./downloads/NACTE-2026-001/original/tender_document.pdf",
