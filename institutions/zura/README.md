---
institution:
  name: "Zanzibar Utilities Regulatory Authority"
  slug: "zura"
  category: "Government"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://zura.go.tz"
  tender_url: "https://zura.go.tz/tenders/"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    Scrape https://zura.go.tz/tenders/ - WordPress/Elementor page with dedicated Tenders section.
    When tenders exist, they appear in main#main > article > .entry-content. Page may show "No Tender for now !"
    when empty. Documents typically in /wp-content/uploads/. Follow all PDF/DOC links.
  selectors:
    container: "main#main, .entry-content, .elementor-element"
    tender_item: "article.hentry, .elementor-widget-wrap"
    title: "h1, h2, h3, .elementor-widget-ct_heading, .ct-heading"
  ...
  documents:
    ...
    known_document_paths:
      - "/wp-content/uploads/"
    url_patterns:
      - "zura.go.tz/wp-content/uploads/*.pdf"
      - "zura.go.tz/wp-content/uploads/*.doc"
      - "zura.go.tz/wp-content/uploads/*.docx"
    document_notes: |
      WordPress site - documents typically in /wp-content/uploads/. Page shows "No Tender for now !"
      when empty. When tenders exist, document links appear in .entry-content.
...
notes: |
  Category: Government. Keywords found: tenders, tender.
  Emails: info@zura.go.tz.
...
**Category:** Government
**Website:** https://zura.go.tz
**Tender Page:** https://zura.go.tz
...
{{
  ...
  "category": "Government",
  "status": "active",
  "source_url": "https://zura.go.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/ZURA-2026-001/original/tender_document.pdf",
