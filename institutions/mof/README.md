---
institution:
  name: "Wizara ya Fedha (Ministry of Finance)"
  slug: "mof"
  category: "Government"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://mof.go.tz"
  tender_url: "https://mof.go.tz/pages/tenders"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Tenders page (mof.go.tz/pages/tenders) contains Laws, Regulations, Guidelines, Budget documents - NOT procurement tender notices. No active procurement tenders found. Documents in /uploads/documents/. Use -k for SSL if needed."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "mof.go.tz/uploads/documents/*.pdf"
    ...
    document_notes: |
      Documents under /uploads/documents/. Site may have SSL cert issues; scraper may need -k or retries. Check matangazo (announcements), zabuni (tenders), manunuzi (procurement) sections.
...
notes: |
  Category: Government. Keywords found: procurement, tender, ununuzi, tenders.
  Emails: info@hazina.go.tz.
...
**Category:** Government
**Website:** https://mof.go.tz
**Tender Page:** https://mof.go.tz
...
Keywords found on site: procurement, tender, ununuzi, tenders
...
{{
  ...
  "category": "Government",
  "status": "active",
  "source_url": "https://mof.go.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MOF-2026-001/original/tender_document.pdf",
