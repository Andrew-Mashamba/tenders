...
institution:
  ...
  slug: "dcb-commercial-bank"
  category: "Commercial Bank"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://www.dcb.co.tz/"
  tender_url: "null"

scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. Publishes tenders on external aggregator platforms."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
...
alternative_sources:
  ...
  - name: "Tanzania Tenders"
    url: "https://tanzaniatenders.com/"

notes: |
  No dedicated tender page. Uses tanzaniatenders.com and mabumbe.com for publishing tenders.
---

# DCB Commercial Bank

**Category:** Commercial Bank  
**Website:** https://www.dcb.co.tz/  
**Tender Page:** null  
...
{{
  ...
  "institution": "dcb-commercial-bank",
