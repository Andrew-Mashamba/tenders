...
website:
  homepage: "https://rea.go.tz/"
  tender_url: "https://rea.go.tz/"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      rea.go.tz fetch timed out during analysis. Selectors are generic. Verify tender page structure when reachable. Government sites often use /tenders/, /procurement/, or /zabuni/ paths.
...
notes: |
  Organization website at rea.go.tz. Tender keywords detected: bid, procurement, rfi, tender, tenders.
---

# Home

**Category:** Government Agency
**Website:** https://rea.go.tz/
**Tender Page:** https://rea.go.tz/
**Keywords Found:** bid, procurement, rfi, tender, tenders

## Contact Information
- Email: dg@rea.go.tz
- Email: webmaster@rea.go.tz
- Email: pmu@rea.go.tz
- Email: info@rea.go.tz
- Phone: 00851-300-200-
- Phone: 00851-300-180-
- Phone: +255 26 2323507
- Phone: 067276261906
- Phone: 00071-300-180-

## Scraping Instructions

**Strategy:** Scrape https://rea.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> EDAP Guidelines Tenders Projects Database Ne
...
```json
{{
  "tender_id": "REA-2026-001",
  "institution": "rea",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "REA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://rea.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://rea.go.tz/storage/tender.pdf",
      "local_path": "./downloads/REA-2026-001/original/tender_document.pdf",
