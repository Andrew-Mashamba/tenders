...
website:
  homepage: "https://jumintech.co.tz"
  tender_url: "https://jumintech.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    JUMINTECH Consultants — IT & IMS (ISO) consultancy. Homepage has services (IT Consulting,
    Managed IT, Cloud, Cyber Security, etc.), projects, testimonials. No tender/procurement page,
    no document listings. "Procurement" keyword was from crawler; site is commercial B2B. Disable.
  selectors:
...
**Category:** Commercial
**Website:** https://jumintech.co.tz
**Tender Page:** https://jumintech.co.tz
...
```json
{{
  "tender_id": "JUMINTECH-2026-001",
  "institution": "jumintech",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://jumintech.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/JUMINTECH-2026-001/original/tender_document.pdf",
