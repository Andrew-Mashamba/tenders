---
institution:
  name: "Zanzibar Public Private Partnership (ZPPP)"
  slug: "zppp"
...
website:
  homepage: "https://zppp.go.tz/"
  tender_url: "https://zppp.go.tz/"

contact:
  email: "webmaster@zppp.go.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Website returns 'Account Suspended' — hosting account suspended. No content accessible. Disabled until site is restored."
  selectors:
...
notes: |
  ZPPP website (zppp.go.tz) — Account Suspended. Contact webmaster@zppp.go.tz. Disabled 2026-03-15.
---

# Account Suspended

**Category:** Government Agency
**Website:** https://zppp.go.tz/
**Tender Page:** https://zppp.go.tz/
**Keywords Found:** rfp
...
**Strategy:** Scrape https://zppp.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
```json
{{
  "tender_id": "ZPPP-2026-001",
  "institution": "zppp",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ZPPP/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://zppp.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://zppp.go.tz/storage/tender.pdf",
      "local_path": "./downloads/ZPPP-2026-001/original/tender_document.pdf",
