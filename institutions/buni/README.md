...
website:
  homepage: "https://buni.or.tz"
  tender_url: "http://buni.or.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "DISABLED: Domain buni.or.tz shows 'We're getting things ready' / domain sale page. No tender content. Re-enable if site becomes operational."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Scraping disabled. Domain shows placeholder/sale page with no tender content (verified 2026-03-15).
...
**Category:** NGO/Non-Profit
**Website:** https://buni.or.tz
**Tender Page:** http://buni.or.tz
...
{{
  ...
  "category": "NGO/Non-Profit",
  "status": "active",
  "source_url": "http://buni.or.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/BUNI-2026-001/original/tender_document.pdf",
