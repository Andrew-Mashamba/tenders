---
institution:
  name: "Mfuko wa Misitu Tanzania (TaFF)"
  slug: "mfukowamisitu"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "mfukowamisitu.go.tz"

website:
  homepage: "https://mfukowamisitu.go.tz/"
  tender_url: "https://mfukowamisitu.go.tz/announcements"

contact:
  email: "info@mfukowamisitu.go.tz"
  phone: "02945454545455"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape /announcements listing page. Each announcement is a.list-item linking to /announcements/{slug}. Follow each link to get full tender details. Check page-content for document links. Also check /download-center (Vipeperushi) for downloadable documents. Images at uploads/news/."
  selectors:
    container: ".page-content, .main-container"
    tender_item: "a.list-item, .col-12.px-0 a[href*='/announcements/']"
    title: ".list-item, .border-left-secondary-thick, h4, h5"
    date: ".border-rightt, .text-center, .col-3"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[href*="/download-center"]'
    pagination: ".d-flex.justify-content-center a, .pagination a"
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "mfukowamisitu.go.tz/announcements/*"
      - "mfukowamisitu.go.tz/uploads/*"
      - "mfukowamisitu.go.tz/download-center*"
      - "mfukowamisitu.go.tz/*.pdf"
    ...
    document_notes: |
      Announcements (Matangazo) listing at /announcements. Each item links to /announcements/{slug}. Download center at /download-center (Vipeperushi). Images use uploads/news/ with hash filenames. Tender announcements (zabuni) may embed documents in page content—follow all PDF links from detail pages.
...
social_media:
  facebook: "mfukomisitu"
  twitter: "mfukowamisitu"

notes: |
  Mfuko wa Misitu Tanzania | MFUKO WA MISITU TANZANIA - Mwanzo
---

# TaFF | MFUKO WA MISITU TANZANIA - Mwanzo

**Category:** Government Agency
**Website:** https://mfukowamisitu.go.tz/
**Tender Page:** https://mfukowamisitu.go.tz/announcements/announcement-of-the-tender-of-the-guidance-consultant
...
**Strategy:** Scrape https://mfukowamisitu.go.tz/announcements/announcement-of-the-tender-of-the-guidance-consultant for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> <div class="calendar-pad-2 position-relative p-1 overflow-hidden bg-seco

### Known Tender URLs

- https://mfukowamisitu.go.tz/announcements/announcement-of-the-tender-of-the-guidance-consultant
...
```json
{{
  "tender_id": "MFUKOWAMISITU-2026-001",
  "institution": "mfukowamisitu",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MFUKOWAMISITU/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://mfukowamisitu.go.tz/announcements/announcement-of-the-tender-of-the-guidance-consultant",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://mfukowamisitu.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MFUKOWAMISITU-2026-001/original/tender_document.pdf",
...
- **Active Tenders:** 1 (Guidance Consultant for construction drawings)
