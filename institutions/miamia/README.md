---
institution:
  name: "Miamia - Starting & Managing Business in Tanzania"
  slug: "miamia"
  category: "Commercial"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://miamia.co.tz"
  tender_url: "https://miamia.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "No tender/procurement page found. Site is a business consultancy blog (company registration, licensing, investment articles). No tender listings or document links. Keywords 'tender' may refer to general business content."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender documents found. Site is business consultancy (BRELA, TRA, company setup). Disabled until dedicated tender section exists.
...
# Starting & Managing Business in Tanzania

**Category:** Commercial
**Website:** https://miamia.co.tz
**Tender Page:** https://miamia.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://miamia.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MIAMIA-2026-001/original/tender_document.pdf",
