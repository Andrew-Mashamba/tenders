...
website:
  homepage: "https://equitygroupholdings.com/tz/"
  tender_url: "null"

scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. Uses Mabumbe and online pre-qualification portal."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
  ...
  documents:
    ...
    url_patterns:
      - "equitygroupholdings.com/tz/*.pdf"
      - "equitygroupholdings.com/tz/*.docx"
      - "equitygroupholdings.com/tz/*.xlsx"
...
notes: |
  No dedicated tender page. Uses mabumbe.com. Has online pre-qualification portal.
---

# Equity Bank Tanzania

**Category:** Commercial Bank  
**Website:** https://equitygroupholdings.com/tz/  
**Tender Page:** null  
