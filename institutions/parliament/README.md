...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "parliament.go.tz"

website:
  homepage: "https://parliament.go.tz/"
  tender_url: "https://parliament.go.tz/"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape parliament.go.tz. Bunge la Tanzania - Zabuni in nav. Documents in news, order paper, bills, hansard sections. Follow Zabuni/Ajira link for tender-specific page. Documents at parliament.go.tz/uploads/ and polis.bunge.go.tz/uploads/."
  selectors:
    container: "main, .content, section, .news-list"
    tender_item: "article, .news-item, .card, li"
    title: "h2, h3, h4, a"
    date: ".date, time"
    document_link: 'a[href$=".pdf"], a[href*="/uploads/"]'
    pagination: "a[href*='news'], a[href*='order_paper'], .pagination a"
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      ...
      - "/uploads/documents/"
    url_patterns:
      - "parliament.go.tz/uploads/*/*.pdf"
      - "polis.bunge.go.tz/uploads/*/*.pdf"
    ...
    document_notes: |
      Documents at parliament.go.tz/uploads/bills/, uploads/documents/ and polis.bunge.go.tz/uploads/. Mix of bills, order papers, hansard - follow Zabuni link for procurement tenders.
...
**Category:** Government Agency
**Website:** https://parliament.go.tz/
**Tender Page:** https://parliament.go.tz/
...
**Strategy:** Scrape https://parliament.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> si Zabuni Ajira <a class='nav-link' href='https://parliament.go.t

### Document Links Found

- https://parliament.go.tz/uploads/documents/sw-1773217633-Ratiba za Kamati, Machi 2026.pdf
- https://parliament.go.tz/uploads/documents/sw-1739284411-JARIDA LA BUNGE TOLEO LA NANE.pdf
...
- https://parliament.go.tz/uploads/documents/sw-1769449466-RATIBA YA MKUTANO WA 2 SIKU 9 kuanzia 27 January mpk 6 Februari 2026.pdf
...
- https://polis.bunge.go.tz/uploads/documents/1772800869-BJT04FEBRUARI2026.pdf
...
```json
{{
  "tender_id": "PARLIAMENT-2026-001",
  "institution": "parliament",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "PARLIAMENT/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://parliament.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://parliament.go.tz/storage/tender.pdf",
      "local_path": "./downloads/PARLIAMENT-2026-001/original/tender_document.pdf",
