---
institution:
  name: "African Fair Safaris Ltd"
  slug: "afrifairsafaris"
  category: "Commercial"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://afrifairsafaris.co.tz"
  tender_url: "https://afrifairsafaris.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "No dedicated tender page. Site is safari/tourism company. Homepage has blog posts (Latest Safaris News) but no tender/procurement content."
  selectors:
    container: ".elementor-posts-container, .elementor-widget-posts"
    tender_item: "article.elementor-post"
    title: ".elementor-post__title a, h3.elementor-post__title"
    date: ".elementor-post__meta-data .elementor-post-date"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[download]'
    pagination: ".elementor-pagination, .nav-links a"
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/wp-content/uploads/"
    document_notes: |
      No tender content found. Site is safari operator with blog posts only. Document paths use WordPress /wp-content/uploads/. Scraping disabled until tender page exists.
...
notes: |
  Category: Commercial. Safari/tourism company - no tender page. Homepage has blog posts only. Scraping disabled. Emails: info@afrifairsafaris.co.tz. Discovered by crawler on 2026-03-15.
---

# Wildlife Safaris

**Category:** Commercial
**Website:** https://afrifairsafaris.co.tz
**Tender Page:** https://afrifairsafaris.co.tz
...
```json
{{
  "tender_id": "AFRIFAIRSAFARIS-2026-001",
  "institution": "afrifairsafaris",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://afrifairsafaris.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/AFRIFAIRSAFARIS-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "info@afrifairsafaris.co.tz",
    "phone": "",
    "address": ""
  }},
