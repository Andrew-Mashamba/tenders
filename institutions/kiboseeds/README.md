...
website:
  homepage: "https://kiboseeds.co.tz"
  tender_url: "https://kiboseeds.co.tz"
...
scraping:
  ...
  selectors:
    ...
    title: ".page_header, .page_content p strong, td"
    date: ".page_content, td"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href*="/forms/"]'
  ...
  documents:
    ...
    url_patterns:
      - "kiboseeds.co.tz/forms/*.doc"
      - "kiboseeds.co.tz/forms/*.pdf"
    ...
    document_notes: |
      Documents found under /forms/. Check for additional paths during scraping.
...
**Category:** Commercial
**Website:** https://kiboseeds.co.tz
**Tender Page:** https://kiboseeds.co.tz
...
```json
{{
  "tender_id": "KIBOSEEDS-2026-001",
  "institution": "kiboseeds",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://kiboseeds.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KIBOSEEDS-2026-001/original/tender_document.pdf",
