...
website:
  homepage: "https://itilimadc.go.tz"
  tender_url: "https://itilimadc.go.tz/tenders"
...
scraping:
  ...
  strategy: |
    ...
    Check GET https://itilimadc.go.tz/api/announcements and /api/from-tamisemi for Zabuni category items.
    Local announcements may include training/interview notices — reject non-procurement.
    Documents on minio paths. Use curl -k for SSL.
  selectors:
    container: ".right-sidebar-content, .middle-content-wrapper"
    tender_item: "table.table.table-striped tbody tr"
    title: "td:first-child a, td a"
  ...
  documents:
    ...
    known_document_paths:
      - "/storage/app/uploads/public/58d/661/a23/"
      - "/storage/app/uploads/public/58d/bc1/dfb/"
      - "/storage/app/uploads/public/59a/ff2/825/"
      - "/storage/app/uploads/public/5f3/387/e7e/"
      - "/storage/app/uploads/public/60b/f51/018/"

    url_patterns:
      - "itilimadc.go.tz/storage/app/uploads/public/58d/661/a23/*.pdf"
      - "itilimadc.go.tz/storage/app/uploads/public/58d/bc1/dfb/*.pdf"
      - "itilimadc.go.tz/storage/app/uploads/public/59a/ff2/825/*.pdf"
      - "itilimadc.go.tz/storage/app/uploads/public/5f3/387/e7e/*.pdf"
      - "itilimadc.go.tz/storage/app/uploads/public/60b/f51/018/*.pdf"
    ...
    document_notes: |
      Documents found under /storage/app/uploads/public/58d/661/a23/, /storage/app/uploads/public/58d/bc1/dfb/, /storage/app/uploads/public/59a/ff2/825/. Check for additional paths during scraping.
...
notes: |
  Category: Government. Keywords found: procurement, tender, zabuni, tenders.
  Emails: info@itilimadc.go.tz.
...
**Category:** Government
**Website:** https://itilimadc.go.tz
**Tender Page:** https://itilimadc.go.tz
...
Keywords found on site: procurement, tender, zabuni, tenders
...
Known document paths: /storage/app/uploads/public/58d/661/a23/, /storage/app/uploads/public/58d/bc1/dfb/, /storage/app/uploads/public/59a/ff2/825/, /storage/app/uploads/public/5f3/387/e7e/, /storage/app/uploads/public/60b/f51/018/
...
```json
{{
  "tender_id": "ITILIMADC-2026-001",
  "institution": "itilimadc",
  ...
  "category": "Government",
  "status": "active",
  "source_url": "https://itilimadc.go.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/ITILIMADC-2026-001/original/tender_document.pdf",
