---
institution:
  name: "Lodhia Industries Limited"
  slug: "lodhiagroup"
  category: "Commercial"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://lodhiagroup.co.tz"
  tender_url: "https://lodhiagroup.co.tz"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Site redirects to lodhiaindustries.com. No tender-specific structure found. WordPress/Elementor. Documents likely in /wp-content/uploads/ if any.
...
notes: |
  ...
  Emails: info@lodhiagroup.co.tz, solutions@example.com, %20solutions@example.com.
  Discovered by crawler on 2026-03-15.
---

# Steel & Plastic Manufacturers & Suppliers in Tanzania

**Category:** Commercial
**Website:** https://lodhiagroup.co.tz
**Tender Page:** https://lodhiagroup.co.tz
...
```json
{{
  "tender_id": "LODHIAGROUP-2026-001",
  "institution": "lodhiagroup",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://lodhiagroup.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/LODHIAGROUP-2026-001/original/tender_document.pdf",
