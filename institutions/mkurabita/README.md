---
institution:
  name: "Mpango wa Kurasimisha Rasilimali na Biashara za Wanyonge Tanzania (MKURABITA)"
  slug: "mkurabita"
  category: "Government"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://mkurabita.go.tz"
  tender_url: "https://mkurabita.go.tz/pages/tenders"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://mkurabita.go.tz/pages/tenders for tender listings. Page shows 'No Tenders at present' when empty. Also check news (mkurabita.go.tz/news), events (mkurabita.go.tz/events) for procurement-related documents."
  selectors:
    container: "main, .content, .page-content, .entry-content, article, .news-section, .events-section"
    tender_item: "article, .news-item, .event-item, .row, tr, li"
    title: "h2, h3, h4, .tender-title, .elementor-heading-title, a"
    date: ".date, .closing-date, .published, time"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[download]'
    pagination: ".pagination a, a.next, .nav-links a, a[href*='news.html']"
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "mkurabita.go.tz/uploads/publications/*.pdf"
    ...
    document_notes: |
      Documents found under /uploads/publications/. Homepage has no dedicated tender list; scrape news (View All) and events pages for procurement-related content. Check linked pages for document downloads.
...
**Category:** Government
**Website:** https://mkurabita.go.tz
**Tender Page:** https://mkurabita.go.tz
...
Known document paths: /uploads/publications/
...
```json
{{
  "tender_id": "MKURABITA-2026-001",
  "institution": "mkurabita",
  ...
  "category": "Government",
  "status": "active",
  "source_url": "https://mkurabita.go.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MKURABITA-2026-001/original/tender_document.pdf",
