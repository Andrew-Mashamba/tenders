...
website:
  homepage: "https://bukobadiocese.co.tz"
  tender_url: "https://bukobadiocese.co.tz/tenders"
...
scraping:
  ...
  selectors:
    ...
    title: "h2, h3, h4, .tender-title, a, td:first-child"
    date: ".date, .closing-date, .published, time, td:nth-child(2), td:nth-child(3)"
  ...
  documents:
    ...
    document_notes: |
      Page may use CDN/bot protection—fetch returns tracking pixel. Document paths TBD after successful scrape. Likely /storage/ or /uploads/ if same CMS as other dioceses.
...
**Category:** Commercial
**Website:** https://bukobadiocese.co.tz
**Tender Page:** https://bukobadiocese.co.tz/tenders
...
```json
{{
  "tender_id": "BUKOBADIOCESE-2026-001",
  "institution": "bukobadiocese",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://bukobadiocese.co.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/BUKOBADIOCESE-2026-001/original/tender_document.pdf",
