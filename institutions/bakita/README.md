...
institution:
  name: "Mwanzo
 | BAKITA - Baraza la Kiswahili la Taifa (BAKITA)"
  slug: "bakita"
...
**Category:** Government Agency
**Website:** https://bakita.go.tz/
**Tender Page:** https://bakita.go.tz/
...
> Kitengo cha Ununuzi TEHAMA na Takwimu <a class='drop-item' href= 'h
...
```json
{{
  "tender_id": "BAKITA-2026-001",
  "institution": "bakita",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "BAKITA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://bakita.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://bakita.go.tz/storage/tender.pdf",
      "local_path": "./downloads/BAKITA-2026-001/original/tender_document.pdf",
