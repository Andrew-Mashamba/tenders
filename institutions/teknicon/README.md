---
institution:
  name: "TEKNICON Limited – Consulting Engineers and Project Managers"
  slug: "teknicon"
  category: "Commercial / Private Sector"
  status: "active"
  country: "Tanzania"
  domain: "teknicon.co.tz"

website:
  homepage: "https://teknicon.co.tz/"
  tender_url: "https://teknicon.co.tz/"

contact:
  email: "info@teknicon.co.tz"
  phone: "+255 767 602 349 "

scraping:
  enabled: false
  method: "http_get"
  strategy: "Consulting engineers firm. Homepage shows portfolio/projects (MSD, bridges, etc.). No dedicated tender page. Scrape homepage and /portfolio/ for any tender/RFI links. Documents in /wp-content/uploads/."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "teknicon.co.tz/wp-content/uploads/*"
    ...
    document_notes: |
      WordPress site. Documents in /wp-content/uploads/. Portfolio/projects only; no tender listing. Tender Documentation mentioned in services—check for dedicated page.
...
notes: |
  Organization website at teknicon.co.tz. Tender keywords detected: bid, rfi, supply, tender.
---

# TEKNICON Limited &#8211; Consulting Engineers and Project Managers

**Category:** Commercial / Private Sector
**Website:** https://teknicon.co.tz/
**Tender Page:** https://teknicon.co.tz/
...
- Phone: +255 767 602 349 
- Phone: 01							
- Phone: +255 767 061 110 
- Phone: +255 222 700 403 
- Phone: 02							

## Scraping Instructions

**Strategy:** Scrape https://teknicon.co.tz/ for tender/procurement notices.
**Method:** http_get
...
> href="#">PROJECT MANAGEMENT Contract Administration and Management, Tender Documentation and Evaluation, Project Planning and Appraisal, Project Implementation, Construction Supervision, Project Closeout <
...
```json
{{
  "tender_id": "TEKNICON-2026-001",
  "institution": "teknicon",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TEKNICON/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://teknicon.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://teknicon.co.tz/storage/tender.pdf",
      "local_path": "./downloads/TEKNICON-2026-001/original/tender_document.pdf",
