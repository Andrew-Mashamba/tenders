---
institution:
  name: "Ideal Office Supplies – Everything for the office"
...
scraping:
  enabled: false
  method: "http_get"
  strategy: "Ideal Office Supplies is a WooCommerce e-commerce site selling office furniture, stationery, electronics. Homepage shows product listings (chairs, punch machines, shredders)—no tender/procurement notices. Re-enable if a dedicated tender/RFI page is added."
  selectors:
