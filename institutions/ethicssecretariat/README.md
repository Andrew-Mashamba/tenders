---
institution:
  name: "Ofisi ya Rais – Sekretarieti ya Maadili ya Viongozi wa Umma"
  slug: "ethicssecretariat"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "ethicssecretariat.go.tz"

website:
  homepage: "https://www.maadili.go.tz/"
  tender_url: "https://www.maadili.go.tz/"

contact:
  email: "ec@maadili.go.tz"
  phone: "0 25 0 0 43"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://www.maadili.go.tz/ homepage. Focus on 'Fomu' (Forms) and 'Machapisho' (Publications) sections. Documents at /uploads/documents/ with sw-*-*.pdf and .doc naming. Also check /publications/forms and /announcements for procurement-related notices."
  selectors:
    container: ".col-lg-6.col-md-12, .container.py-5, .home-page-bodyyyy"
    tender_item: "a.show-more-content-value_chain, a[href*='/uploads/documents/']"
    title: ".hover-text-primary, div.col-9.col-md-8.pl-3 div:last-child"
    date: ".small.text-faded, span.text-faded"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href*="/uploads/documents/"]'
    pagination: ".btn.btn-primary, a[href*='/publications']" 
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "www.maadili.go.tz/uploads/documents/*"
      - "maadili.go.tz/uploads/documents/*"
    ...
    document_notes: |
      Documents stored at https://www.maadili.go.tz/uploads/documents/ with naming pattern sw-{timestamp}-{filename}.pdf or .doc. Fomu (Forms) section has direct links. Machapisho links may point to folder - follow to get individual files.
...
social_media:
  ...
  instagram: "sekretarieti_ya_maadili_"

notes: |
  Government Website
Ethics Secretariat | Tovuti ya Serikali
tovuti ya Maadili ya Viongozi wa Umma
---

# MAADILI |   JAMHURI YA MUUNGANO WA TANZANIA - Mwanzo

**Category:** Government Agency
**Website:** https://www.maadili.go.tz/
**Tender Page:** https://www.maadili.go.tz/
...
**Strategy:** Scrape https://www.maadili.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> egal-services-unit'>Huduma za Sheria Usimamizi wa Manunuzi Mawasiliano Serikalini <li

### Document Links Found

- https://www.maadili.go.tz/uploads/documents/sw-1699269069-sw1612251589-REJESTA YA ZAWADI.doc
- https://www.maadili.go.tz/uploads/documents/sw-1702284048-sw-1698603950-Fomu ya Tamko ya Rasilimali na Madeni kwa Viongozi wa Umma.pdf
- https://www.maadili.go.tz/uploads/documents/sw-1711522461-FOMU D.pdf
- https://www.maadili.go.tz/uploads/documents/sw-1701427075-AHADI YA UADILIFU COPY1.pdf
...
```json
{{
  "tender_id": "ETHICSSECRETARIAT-2026-001",
  "institution": "ethicssecretariat",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ETHICSSECRETARIAT/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.maadili.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://www.maadili.go.tz/storage/tender.pdf",
      "local_path": "./downloads/ETHICSSECRETARIAT-2026-001/original/tender_document.pdf",
