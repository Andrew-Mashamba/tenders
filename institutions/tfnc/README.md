...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Tender page unreachable during analysis. Previous config had incorrect muhas.ac.tz paths. Check tfnc.go.tz structure when accessible for actual document paths.
...
notes: |
  Category: Government. Keywords found: tenders, tender, zabuni.
  Emails: info@tfnc.go.tz.
...
**Category:** Government
**Website:** https://tfnc.go.tz
**Tender Page:** https://tfnc.go.tz
...
Keywords found on site: tenders, tender, zabuni
...
Known document paths: /https://muhas.ac.tz/wp-content/uploads/2025/08/, /wp-content/uploads/2025/08/
...
{{
  ...
  "category": "Government",
  "status": "active",
  "source_url": "https://tfnc.go.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/TFNC-2026-001/original/tender_document.pdf",
