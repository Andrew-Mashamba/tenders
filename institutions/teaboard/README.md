---
institution:
  name: "Bodi ya Chai Tanzania (Tea Board of Tanzania)"
  slug: "teaboard"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "teaboard.go.tz"
...
scraping:
  ...
  selectors:
    ...
    title: ".text-uppercase, .home-news-read-more, a"
    date: ".item-date, .item-date.text-secondary"
    document_link: 'a[href$=".pdf"], a[href*="/uploads/documents/"], a[href*="/publications"]'
    pagination: ".pagination a, a[href*='Tazama Zaidi']"
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "teaboard.go.tz/uploads/documents/*"
      - "teaboard.go.tz/publications"
    ...
    document_notes: |
      Documents in /uploads/documents/ (e.g. sw-1763014962-TEA INDUSTRY DEVELOPMENT_compressed (1).pdf). Publications at /publications. Matangazo (announcements) at /announcements. Zabuni menu links to #.
...
social_media:
  ...
  instagram: "bodi_ya_chai"

notes: |
  Bodi ya Chai Tanzania |     BODI YA CHAI TANZANIA - Mwanzo
---

# TEABOARD |     BODI YA CHAI TANZANIA - Mwanzo
...
**Strategy:** Scrape https://teaboard.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> href= '#'>Uzalishaji wa chai Zabuni Mawasiliano <div class="position-absolut

### Document Links Found

- https://teaboard.go.tz/uploads/documents/sw-1763014962-TEA INDUSTRY DEVELOPMENT_compressed (1).pdf
...
```json
{{
  "tender_id": "TEABOARD-2026-001",
  "institution": "teaboard",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TEABOARD/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://teaboard.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://teaboard.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TEABOARD-2026-001/original/tender_document.pdf",
