---
institution:
  name: "CEELS - Community Economic Empowerment and Legal Support"
  slug: "ceelstz"
...
website:
  homepage: "https://www.ceelstz.or.tz"
  tender_url: "https://www.ceelstz.or.tz"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape www.ceelstz.or.tz (WordPress/OceanWP). No dedicated tender page found; check homepage and linked pages for procurement/tender content. Use wp-content/uploads for documents."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      WordPress site. Document paths typically under /wp-content/uploads/. No dedicated tender listing page found; scraper should discover document links during first run.
...
notes: |
  Category: NGO/Non-Profit. Keywords found: tenders, tender.
  Emails: info@ceelstz.or.tz.
...
**Category:** NGO/Non-Profit
**Website:** https://ceelstz.or.tz
**Tender Page:** https://ceelstz.or.tz
...
{{
  ...
  "category": "NGO/Non-Profit",
  "status": "active",
  "source_url": "https://ceelstz.or.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/CEELSTZ-2026-001/original/tender_document.pdf",
