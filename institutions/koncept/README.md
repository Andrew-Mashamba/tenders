...
website:
  homepage: "https://koncept.co.tz"
  tender_url: "https://koncept.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Account suspended. Hosting provider has suspended koncept.co.tz. No content reachable. Disable until site is restored."
  selectors:
...
notes: |
  Category: Commercial. Site shows 'Account Suspended' — hosting suspended. Disable scraping. Re-enable when site is restored.
---

# Account Suspended

**Category:** Commercial
**Website:** https://koncept.co.tz
**Tender Page:** https://koncept.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://koncept.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KONCEPT-2026-001/original/tender_document.pdf",
