...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape the /tenders/ page for active tender listings with closing dates and downloadable documents."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "azaniabank.co.tz/*.pdf"
      - "azaniabank.co.tz/uploads/*.pdf"
    ...
    document_notes: |
      Check tender listing page for embedded PDF links.
...
notes: |
  Has a dedicated /tenders/ page.
---

# Azania Bank Tanzania
