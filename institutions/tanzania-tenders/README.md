---
institution:
  name: "Tanzania Tenders"
  slug: "tanzania-tenders"
  category: "Tender Aggregator"
  status: "active"
  country: "Tanzania"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Private tender aggregator website. Scrape listing pages for tenders from financial institutions. Filter by category (banking, finance). DCB Commercial Bank publishes tenders here."
  selectors:
    container: ".tenders, .content, main, .listing"
    tender_item: "article, .tender-item, .card, .post"
    title: "h2, h3, .title, a"
    date: ".date, .deadline, .closing-date"
    institution: ".org, .company, .institution"
    category_filter: "banking, finance, financial services"
  ...
  documents:
    ...
    url_patterns:
      - "tanzaniatenders.com/*.pdf"
      - "tanzaniatenders.com/uploads/*.pdf"
    ...
    document_notes: |
      Private aggregator. Download tender documents for financial institutions.
...
notes: |
  Private Tanzanian tender aggregator. Used by DCB Commercial Bank and other institutions
  that don't maintain their own tender pages. Good secondary source to cross-reference
  with Mabumbe and Zabuni.
---

# Tanzania Tenders

**Category:** Tender Aggregator
**Website:** https://tanzaniatenders.com/
**Tender Page:** https://tanzaniatenders.com/

## Scraping Instructions

**Strategy:** Scrape listing pages for financial institution tenders. Filter by banking/finance category.
**Method:** http_get

## Institutions That Publish Here

- DCB Commercial Bank
- Various other banks and institutions without dedicated tender pages

## Coverage

Covers tenders from both public and private sector institutions across Tanzania.
