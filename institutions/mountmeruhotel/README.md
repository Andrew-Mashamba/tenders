...
website:
  homepage: "https://mountmeruhotel.co.tz"
  tender_url: "https://mountmeruhotel.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Hotel site. No tender/procurement section found. Content is accommodation, conferencing, services. Re-enable if tender page is added."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Static HTML hotel site. No tender/procurement content found. Content boxes (.content-boxes, .hotel-services-bxs) contain accommodation and services info only.
...
notes: |
  ...
  Emails: info@mountmeruhotel.co.tz.
...
**Category:** Commercial
**Website:** https://mountmeruhotel.co.tz
**Tender Page:** https://mountmeruhotel.co.tz
...
```json
{{
  "tender_id": "MOUNTMERUHOTEL-2026-001",
  "institution": "mountmeruhotel",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://mountmeruhotel.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MOUNTMERUHOTEL-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "info@mountmeruhotel.co.tz",
    "phone": "",
    "address": ""
  }},
