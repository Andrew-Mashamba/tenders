...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "pepsitanzania.co.tz"

website:
  homepage: "https://www.sbctanzania.co.tz/"
  tender_url: "https://www.sbctanzania.co.tz/"
...
scraping:
  enabled: false
  method: "http_get"
  strategy: "SBC Tanzania (Pepsi) homepage has no tender section — only Company Profile, Brands, News, Careers. No tender listing or procurement page found. Disabled until tender page is identified."
  selectors:
...
notes: |
  Organization website at pepsitanzania.co.tz. Tender keywords detected: eoi, rfi, tender, tenders.
---

# SBC - Pepsi

**Category:** Commercial / Private Sector
**Website:** https://www.sbctanzania.co.tz/
**Tender Page:** https://www.sbctanzania.co.tz/
...
**Strategy:** Scrape https://www.sbctanzania.co.tz/ for tender/procurement notices.
**Method:** http_get
...
```json
{{
  "tender_id": "PEPSITANZANIA-2026-001",
  "institution": "pepsitanzania",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "PEPSITANZANIA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.sbctanzania.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://www.sbctanzania.co.tz/storage/tender.pdf",
      "local_path": "./downloads/PEPSITANZANIA-2026-001/original/tender_document.pdf",
