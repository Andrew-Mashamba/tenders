...
website:
  homepage: "https://tawiri.or.tz"
  tender_url: "https://www.tawiri.or.tz/procurement_management_unit/"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Procurement page may timeout. Increase timeout_seconds if needed. Document paths to be discovered on first successful scrape.
...
notes: |
  Category: NGO/Non-Profit. Keywords found: procurement, tender.
  Emails: barua@tawiri.or.tz, dg@tawiri.or.tz, barua@tawiri.or.tz, dg@tawiri.or.tz.
...
**Category:** NGO/Non-Profit
**Website:** https://tawiri.or.tz
**Tender Page:** https://tawiri.or.tz/procurement

## Scraping Instructions

**Strategy:** Scrape /procurement page for tender listings, download all linked documents.
**Method:** http_get

Keywords found on site: procurement, tender
...
{{
  ...
  "category": "NGO/Non-Profit",
  "status": "active",
  "source_url": "https://tawiri.or.tz/procurement",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/TAWIRI-2026-001/original/tender_document.pdf",
