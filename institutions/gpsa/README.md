---
institution:
  name: "GPSA (Government Procurement Services Agency)"
  slug: "gpsa"
  category: "Government"
  status: "active"
  country: "Tanzania"
...
scraping:
  ...
  documents:
    ...
    url_patterns:
      - "gpsa.go.tz/uploads/tenders/*.pdf"
...
Known document paths: /uploads/tenders/
...
{{
  ...
  "category": "Government",
  "status": "active",
  "source_url": "https://gpsa.go.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/GPSA-2026-001/original/tender_document.pdf",
