...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Documents found under /wp-content/uploads/2025/03/. Check for additional paths during scraping.
...
**Category:** Government
**Website:** https://pura.go.tz
**Tender Page:** http://pura.go.tz
...
Known document paths: /wp-content/uploads/2025/03/
...
{{
  ...
  "category": "Government",
  "status": "active",
  "source_url": "http://pura.go.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/PURA-2026-001/original/tender_document.pdf",
