...
social_media:
  facebook: "tvla.go.tz"
  twitter: "TVLA_Official"
  instagram: "tvla_official"

notes: |
  Tanzania Veterinary Laboratory Agency | Wakala ya Maabara ya Veterinari Tanzania
---

# TVLA |   Mwanzo

**Category:** Government Agency
**Website:** https://tvla.go.tz/
**Tender Page:** https://tvla.go.tz/
**Keywords Found:** bid

## Contact Information
- Email: info@tvla.go.tz
- Phone: +255 22 2861152
- Phone: +255 22 2864369
- Phone: 022-2023 
...
```json
{{
  "tender_id": "TVLA-2026-001",
  "institution": "tvla",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TVLA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://tvla.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://tvla.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TVLA-2026-001/original/tender_document.pdf",
