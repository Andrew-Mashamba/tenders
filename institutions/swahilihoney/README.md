---
institution:
  name: "Central Park Bees (Swahili Honey)"
  slug: "swahilihoney"
  category: "Commercial"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://swahilihoney.co.tz"
  tender_url: "https://swahilihoney.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Scraping disabled. /about-us/tender shows company info (About Us, team, services, mission/vision) — no tender listings. Central Park Bees (Swahili Honey) is a honey/beeswax supplier. Re-enable when a dedicated tender/procurement page is identified."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender documents on /about-us/tender. Page contains company profile, team bios, services. Re-enable when tender page exists.
...
notes: |
  ...
  Emails: buzzin@swahilihoney.co.tz, buzzin@swahilihoney.co.tz.
...
**Category:** Commercial
**Website:** https://swahilihoney.co.tz
**Tender Page:** https://swahilihoney.co.tz/about-us/tender

## Scraping Instructions

**Strategy:** Scrape /about-us/tender page for tender listings, download all linked documents.
**Method:** http_get
...
```json
{{
  "tender_id": "SWAHILIHONEY-2026-001",
  "institution": "swahilihoney",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://swahilihoney.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/SWAHILIHONEY-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "buzzin@swahilihoney.co.tz",
    "phone": "",
    "address": ""
  }},
