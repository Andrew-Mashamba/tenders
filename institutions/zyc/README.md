---
institution:
  name: "Baraza la Vijana Zanzibar"
  slug: "zyc"
...
website:
  homepage: "https://zyc.go.tz/"
  tender_url: "https://eprocurement.zppda.go.tz/"

# NOTE: tender_url points to national eprocurement portal (requires login). zyc.go.tz has no tender page - shows news (Habari).
...
scraping:
  ...
  method: "http_get"
  strategy: |
    DISABLED: tender_url https://eprocurement.zppda.go.tz/ requires login (redirects to /esop/guest/login.do).
    zyc.go.tz (Baraza la Vijana Zanzibar - Zanzibar Youth Council) has no tender listing - homepage shows news (Habari), view_news.php.
    Re-enable when: (a) ZYC adds tender page to own site, or (b) eprocurement guest access available.
  selectors:
  ...
  documents:
    ...
    document_notes: |
      eprocurement portal requires login. zyc.go.tz has no tender content - news site only.
...
social_media:
  facebook: "ZanzibarCouncil"
  instagram: "reel"

notes: |
  Organization website at zyc.go.tz (Baraza la Vijana Zanzibar - Zanzibar Youth Council).
  Tender keywords detected: manunuzi, procurement. Scraping disabled: no tender page, eprocurement requires login.
---

# Responsive One Page

**Category:** Government Agency
**Website:** https://zyc.go.tz/
...
> BaruaPepe Mfumo wa Manunuzi Ofisi Mtandao
...
{{
  ...
  "documents": [
    {{
      ...
      "original_url": "https://zyc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/ZYC-2026-001/original/tender_document.pdf",
