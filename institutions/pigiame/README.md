...
website:
  homepage: "https://pigiame.co.tz"
  tender_url: "https://pigiame.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Pigiame is a classifieds site. Cloudflare challenge requires JavaScript to load. No dedicated tender section — 'procurement' keyword found but site is general classifieds. Disabled — requires JS, not a primary tender source."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "pigiame.co.tz/assets/pi-site/img/*.pdf"
    ...
    document_notes: |
      Documents found under /assets/pi-site/img/. Check for additional paths during scraping.
...
**Category:** Commercial
**Website:** https://pigiame.co.tz
**Tender Page:** https://pigiame.co.tz
...
Known document paths: /assets/pi-site/img/
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://pigiame.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/PIGIAME-2026-001/original/tender_document.pdf",
