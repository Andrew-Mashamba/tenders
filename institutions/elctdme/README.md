---
institution:
  name: "ELCT DME (Account Suspended)"
  slug: "elctdme"
...
website:
  homepage: "https://elctdme.or.tz"
  tender_url: "https://elctdme.or.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "DISABLED: elctdme.or.tz returns 'Account Suspended' - site unreachable. Re-enable when hosting is restored."
  selectors:
...
notes: |
  Category: NGO/Non-Profit. Keywords found: rfp.
...
**Category:** NGO/Non-Profit
**Website:** https://elctdme.or.tz
**Tender Page:** https://elctdme.or.tz
...
{{
  ...
  "category": "NGO/Non-Profit",
  "status": "active",
  "source_url": "https://elctdme.or.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/ELCTDME-2026-001/original/tender_document.pdf",
