...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "babatidc.go.tz"

website:
  homepage: "https://babatidc.go.tz/"
  tender_url: "https://babatidc.go.tz/tenders"

contact:
  email: "ded@babatidc.go.tz"
  alternate_emails:
    - "info@babatidc.go.tz"
  phone: "027-2531011 "
...
scraping:
  ...
  selectors:
    ...
    title: "h4, .page-title, .home-page-title, a"
    date: "span"
    document_link: 'a[href*="/storage/app/uploads/"], a[href$=".pdf"], a[href$=".doc"], a[href$=".xls"]'
    pagination: ".pagination a, a.next, .nice-select" 
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "babatidc.go.tz/storage/app/uploads/public/*/*/*/*"
    ...
    document_notes: |
      October CMS; documents in /storage/app/uploads/public/ with hash-based paths (e.g. 5a1/d4c/9d3/filename). Supports PDF, XLS. Page may default to Kiswahili; use locale=en for English. TISS form at /how-do-i-single/jinsi-ya-kupata-fomu-ya-taarifa-za-kibenki-kwa-wateja-wazabuni-tiss-form.
...
# Home &#124; Babati District Council

**Category:** Local Government Authority
**Website:** https://babatidc.go.tz/
**Tender Page:** https://babatidc.go.tz/tenders
**Keywords Found:** procurement, tender, tenders, zabuni

## Contact Information
- Email: ded@babatidc.go.tz
- Email: info@babatidc.go.tz
- Phone: 027-2531011 
- Phone: 025
...
**Strategy:** Scrape https://babatidc.go.tz/tenders for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://babatidc.go.tz/tenders
- https://babatidc.go.tz/how-do-i-single/jinsi-ya-kupata-fomu-ya-taarifa-za-kibenki-kwa-wateja-wazabuni-tiss-form
- https://babatidc.go.tz/procurement

### Document Links Found

- https://babatidc.go.tz/storage/app/uploads/public/5a1/d4c/9d3/5a1d4c9d33266322550818.xls
- https://babatidc.go.tz/storage/app/uploads/public/62f/a48/36a/62fa4836a086e721006099.pdf
- https://babatidc.go.tz/storage/app/uploads/public/5b7/a73/1d4/5b7a731d4a219854852253.pdf
- https://babatidc.go.tz/storage/app/uploads/public/5b7/a74/64c/5b7a7464cab95848883850.pdf
- https://babatidc.go.tz/storage/app/uploads/public/631/aff/b3a/631affb3a1750725048728.pdf
...
Known document paths: /storage/app/uploads/public/5a1/d4c/9d3/5a1d4c9d33266322550818.xls, /storage/app/uploads/public/5b7/a73/1d4/5b7a731d4a219854852253.pdf, /storage/app/uploads/public/62f/a48/36a/62fa4836a086e721006099.pdf
...
```json
{{
  "tender_id": "BABATIDC-2026-001",
  "institution": "babatidc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "BABATIDC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://babatidc.go.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://babatidc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/BABATIDC-2026-001/original/tender_document.pdf",
