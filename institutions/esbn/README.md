---
institution:
  name: "ESBN (Society Love & Support)"
  slug: "esbn"
...
website:
  homepage: "https://esbn.or.tz"
  tender_url: "https://esbn.or.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "NGO site. Homepage shows programs (Health, Lobbying, Youth Empowerment, Research, Community Support, Awareness). Recent News section. No dedicated tender page. 'Tender' keyword found in crawler but no tender listing."
  selectors:
    container: "main, .wp-block-group, .entry-content, article"
    tender_item: "article, .wp-block-column, .card"
    title: "h2, h3, h4, h5, .wp-block-heading"
    date: ".date, time"
  ...
  documents:
    ...
    document_notes: |
      No tender page found. NGO programs and news only. Check /donate/, /contact-us/ for any procurement notices. Document paths to be discovered if tender page is added.
...
notes: |
  Category: NGO/Non-Profit. Keywords found: tender. No dedicated tender page. Scraping disabled. Emails: info@esbn.or.tz.
---

# Esbn

**Category:** NGO/Non-Profit
**Website:** https://esbn.or.tz
**Tender Page:** https://esbn.or.tz
...
{{
  ...
  "category": "NGO/Non-Profit",
  "status": "active",
  "source_url": "https://esbn.or.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/ESBN-2026-001/original/tender_document.pdf",
