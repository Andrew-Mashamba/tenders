---
institution:
  name: "MOEVT-Ministry of Education and Vocational Training &#8211; Ministry of Education and Vocational Training"
  slug: "moez"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "MOEZ tender_url points to eprocurement.zppda.go.tz (Zanzibar e-procurement). Platform may require JavaScript. Scrape eprocurement.zppda.go.tz for Zanzibar MoEVT tenders. Filter by institution if possible."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      eprocurement.zppda.go.tz is shared Zanzibar e-procurement platform. May require JS/browser. Documents typically in tender detail views. Filter results for MoEVT/MOEZ institution.
...
notes: |
  Organization website at moez.go.tz. Tender keywords detected: procurement, rfi.
---

# MOEVT-Ministry of Education and Vocational Training &#8211; Ministry of Education and Vocational Training

**Category:** Government Agency
**Website:** https://moez.go.tz/
...
> <svg aria-hidden="true" class="e-font-icon-svg e-fas-chevron-circle-right" viewBox="0 0 512 512" x
...
{{
  ...
  "documents": [
    {{
      ...
      "original_url": "https://moez.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MOEZ-2026-001/original/tender_document.pdf",
