---
institution:
  name: "Letshego Tanzania (Microfinance)"
  slug: "letshego-microfinance"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. Has supplier registration form."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
  ...
  documents:
    ...
    url_patterns:
      - "www.letshego.com/tanzania-1/*.pdf"
      - "www.letshego.com/tanzania-1/*.docx"
      - "www.letshego.com/tanzania-1/*.xlsx"
...
notes: |
  Microfinance arm of Letshego. Supplier Registration & Pre-Qualification Form available for download.
---

# Letshego Tanzania (Microfinance)

**Category:** Microfinance Institution  
**Website:** https://www.letshego.com/tanzania-1  
**Tender Page:** null  
...
{{
  ...
  "institution": "letshego-microfinance",
