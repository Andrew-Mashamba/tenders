...
website:
  homepage: "https://tanzania.accessbankplc.co.tz/"
  tender_url: "null"

scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. Monitor homepage and news section for occasional procurement notices."
  selectors:
    container: "body"
    tender_list: "unknown"
    tender_item: "unknown"
  ...
  documents:
    ...
    url_patterns:
      - "tanzania.accessbankplc.co.tz/*.pdf"
      - "tanzania.accessbankplc.co.tz/*.docx"
      - "tanzania.accessbankplc.co.tz/*.xlsx"
...
notes: |
  Formerly Standard Chartered retail arm. No tender page found. Check TANePS and Mabumbe for tenders.
---

# Access Bank Tanzania

**Category:** Commercial Bank  
**Website:** https://tanzania.accessbankplc.co.tz/  
**Tender Page:** null  
