...
website:
  homepage: "https://kingsfm.co.tz"
  tender_url: "https://kingsfm.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Radio station (Kings FM). Homepage shows program schedules, news, team. No dedicated tender/procurement page in navigation (Home, About Us, Programs, Projects, Marketing, Updates, Contact Us). Re-enable if tender page is added."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender page found. Site is a radio station with program schedules and news. Document paths unknown.
...
**Category:** Commercial
**Website:** https://kingsfm.co.tz
**Tender Page:** https://kingsfm.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://kingsfm.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KINGSFM-2026-001/original/tender_document.pdf",
