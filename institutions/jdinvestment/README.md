...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "jdinvestment.co.tz"

website:
  homepage: "https://jdinvestment.co.tz/"
  tender_url: "https://jdinvestment.co.tz/"

contact:
  email: "info@jdinvestment.co.tz"
  phone: "025-04-30-19-1"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    WordPress/Elementor site. Homepage shows company profile (services, testimonials, projects) — no tender or procurement listings. Scraping disabled until a dedicated tender page exists.
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender page — site is company profile only. wp-content/uploads/ used for images; no tender documents found.
...
social_media:
  instagram: "jdinvestmentltd"

notes: |
  Organization website at jdinvestment.co.tz. Tender keywords detected: procurement, rfi, supply.
---

# JD Investment &#8211; Procurement Partner

**Category:** Investment / Securities
**Website:** https://jdinvestment.co.tz/
**Tender Page:** https://jdinvestment.co.tz/
...
- Phone: 025833500129
- Phone: 059 256 71
- Phone: +255 22 266 4951
- Phone: 0666666666667

## Scraping Instructions

**Strategy:** Scrape https://jdinvestment.co.tz/ for tender/procurement notices.
**Method:** http_get
...
> itial-scale=1"> JD Investment &#8211; Procurement Partner <link rel="alternate" type="application/rss+xml" title="J
...
```json
{{
  "tender_id": "JDINVESTMENT-2026-001",
  "institution": "jdinvestment",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "JDINVESTMENT/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://jdinvestment.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://jdinvestment.co.tz/storage/tender.pdf",
      "local_path": "./downloads/JDINVESTMENT-2026-001/original/tender_document.pdf",
