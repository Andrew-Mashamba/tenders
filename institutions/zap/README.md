...
website:
  homepage: "https://zap.co.tz"
  tender_url: "https://zap.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "zap.co.tz is a wedding/destination photography studio. Homepage has no tender content—only portfolio, packages, Indian wedding photography. RFP keyword found in crawler but no procurement tenders posted. Main content links to external Pixieset for galleries."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender documents. Site is photography studio; packages and galleries hosted on zapstudioportraits.mypixieset.com.
...
**Category:** Commercial
**Website:** https://zap.co.tz
**Tender Page:** https://zap.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://zap.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/ZAP-2026-001/original/tender_document.pdf",
