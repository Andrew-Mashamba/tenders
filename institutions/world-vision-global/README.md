---
institution:
  name: "World Vision International - Global Suppliers Portal"
  slug: "world-vision-global"
  category: "NGO / Development Organization"
  status: "active"
  country: "International"

website:
  homepage: "https://www.wvi.org/"
  tender_url: "https://www.wvi.org/suppliers/tenders"
...
scraping:
  ...
  selectors:
    ...
    date: ".views-field-field-date, .date, time"
    country_filter: "Tanzania"
    location: ".views-field-field-location, .location, .country"
  ...
  documents:
    ...
    document_notes: |
      Global supplier portal. Filter downloads for Tanzania-relevant documents.
...
alternative_sources:
  - name: "World Vision Tanzania Tenders"
    url: "https://www.wvi.org/tanzania/tenders"

notes: |
  Global supplier portal for all World Vision offices worldwide. Filter for Tanzania.
  Some large procurement may only appear on the global page, not the Tanzania-specific one.
  Check both this and the Tanzania-specific page (wvi.org/tanzania/tenders).
  Related institution folders: visionfund, world-vision-tanzania
---

# World Vision International - Global Suppliers Portal

**Category:** NGO / Development Organization
**Website:** https://www.wvi.org/
**Tender Page:** https://www.wvi.org/suppliers/tenders

## Scraping Instructions

**Strategy:** Scrape global supplier tender listings, filter for Tanzania.
**Method:** http_get

## Relationship to Other Sources

- **world-vision-tanzania** — Tanzania-specific tenders
- **visionfund** — VisionFund Tanzania (subsidiary)
- This portal — Global tenders, may include Tanzania items not on country page

## Notes

Some high-value or multi-country procurement may only appear on this global page.
...
{{
  ...
  "institution": "world-vision-global",
