---
institution:
  name: "NFQCL | National Fish Quality Control Laboratory"
  slug: "nfqclab"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "nfqclab.go.tz"

website:
  homepage: "https://nfqclab.go.tz/"
  tender_url: "https://nfqclab.go.tz/uploads/tenders/en1467355179-PSW.pdf"

contact:
  email: "Info@nfqclab.go.tz"
  phone: "+255 717 041 676"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Tender_url points to a single PDF. No HTML tender listing - fetch homepage (nfqclab.go.tz) for links to /uploads/tenders/ and /uploads/publications/. Also fetch tender_url PDF directly. Documents use pattern /uploads/tenders/en*.pdf and /uploads/publications/en*.pdf."
  selectors:
    container: ".services-wrapper, .home-services-listing, main, .content"
    tender_item: "li, a[href*='/uploads/tenders/'], a[href*='/uploads/publications/']"
    title: "h4, h2, a"
  ...
  documents:
    ...
    url_patterns:
      - "nfqclab.go.tz/uploads/tenders/*.pdf"
      - "nfqclab.go.tz/uploads/publications/*.pdf"
    ...
    document_notes: |
      No tender listing page. Tender_url is direct PDF. Scrape homepage for links to /uploads/tenders/ and /uploads/publications/. Files use en{timestamp}-{name}.pdf pattern. Site may expose PHP debug output - ignore.
...
social_media:
  facebook: "National-Fish-Quality-Control-Laboratory-1684189725222885"

notes: |
  Organization website at nfqclab.go.tz. Tender keywords detected: tender, tenders, zabuni.
---

# NFQCL | National Fish Quality Control Laboratory

**Category:** Government Agency
**Website:** https://nfqclab.go.tz/
**Tender Page:** https://nfqclab.go.tz/uploads/tenders/en1467355179-PSW.pdf
...
**Strategy:** Scrape https://nfqclab.go.tz/uploads/tenders/en1467355179-PSW.pdf for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> Tender Announcement Tarehe ya Mwisho&nbsp; 2016-07-31 <a href="https://nfqclab.go.tz/uploads/tenders/en1467355179-P

### Known Tender URLs

- https://nfqclab.go.tz/uploads/tenders/en1467355179-PSW.pdf

### Document Links Found

- https://nfqclab.go.tz/uploads/tenders/en1467355179-PSW.pdf
- https://nfqclab.go.tz/uploads/publications/en1497347751-Mbinu-Bora-za-Uhudumiaji.pdf
- https://nfqclab.go.tz/uploads/publications/en1497420570-NFQCLAB Brochure.pdf
- https://nfqclab.go.tz/uploads/publications/en1497348107-Utayarishaji-na-Uhifadhi-wa-Mazao-ya-Uvuvi.pdf
- https://nfqclab.go.tz/uploads/publications/en1497347872-Sheria-na-Kanuni-za-Uvuvi.pdf
- https://nfqclab.go.tz/uploads/publications/en1497348373-Brochure-English-version.pdf
...
Known document paths: /uploads/publications/en1497347872-Sheria-na-Kanuni-za-Uvuvi.pdf, /uploads/publications/en1497348107-Utayarishaji-na-Uhifadhi-wa-Mazao-ya-Uvuvi.pdf, /uploads/tenders/en1467355179-PSW.pdf
...
```json
{{
  "tender_id": "NFQCLAB-2026-001",
  "institution": "nfqclab",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "NFQCLAB/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://nfqclab.go.tz/uploads/tenders/en1467355179-PSW.pdf",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://nfqclab.go.tz/storage/tender.pdf",
      "local_path": "./downloads/NFQCLAB-2026-001/original/tender_document.pdf",
