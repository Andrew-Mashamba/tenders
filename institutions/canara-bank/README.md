...
website:
  homepage: "https://canarabank.co.tz/"
  tender_url: "null"

scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. Small branch operation."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
  ...
  documents:
    ...
    url_patterns:
      - "canarabank.co.tz/*.pdf"
      - "canarabank.co.tz/*.docx"
      - "canarabank.co.tz/*.xlsx"
...
**Category:** Commercial Bank  
**Website:** https://canarabank.co.tz/  
**Tender Page:** null  
