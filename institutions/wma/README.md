---
institution:
  name: "Wakala wa Vipimo (WMA) - Weight and Measurement Agency"
  slug: "wma"
...
scraping:
  ...
  selectors:
    ...
    title: "td:first-child, h2, h3, h4, .tender-title"
    date: "td:nth-child(2), .date, .closing-date, time"
    document_link: 'td a[href$=".pdf"], a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[href*="Download"]'
    pagination: ".pagination ul li a, .pagination a, a.next"
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/uploads/documents/sw/"
      - "/uploads/documents/"

    url_patterns:
      - "wma.go.tz/uploads/documents/**/*.pdf"
      - "wma.go.tz/publications/*"
    ...
    document_notes: |
      Documents at wma.go.tz/uploads/documents/sw/ (e.g. 1582716367-MKATABA WA HUDUMA KWA MTEJA.pdf).
      Publications table has Download links. Tenders page /tenders currently under construction — use /publications/40 for Mpango wa Manunuzi (Annual Procurement Plan).
...
social_media:
  facebook: "Weights-and-Measures-Agency-Tanzania-WMA-1379267282334120"
  twitter: "vipimotz"
  instagram: "wakalawavipimotanzania"

notes: |
  Organization website at wma.go.tz. Tender keywords detected: bid, manunuzi, tender, tenders, zabuni.
---

# Home | Weight and Measurement Agency - WMA

**Category:** Government Agency
**Website:** https://www.wma.go.tz/
**Tender Page:** https://www.wma.go.tz/
**Keywords Found:** bid, manunuzi, tender, tenders, zabuni

## Contact Information
- Email: info@wma.go.tz
- Phone: 020 - 2021
- Phone: 0810600 172162
- Phone: 007-1002000598
- Phone: 022 - 2023
- Phone: 0800 110097
...
**Strategy:** Scrape https://www.wma.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> https://www.wma.go.tz/publications/22>Jarida Zabuni Ofisi za Mikoa <a href=https://www.wma.go.tz/publications/44?sb=1&mid=256&mna=256 class='dropdown-toggle'
...
```json
{{
  "tender_id": "WMA-2026-001",
  "institution": "wma",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "WMA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.wma.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://www.wma.go.tz/storage/tender.pdf",
      "local_path": "./downloads/WMA-2026-001/original/tender_document.pdf",
