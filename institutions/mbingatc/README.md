...
website:
  homepage: "https://mbingatc.go.tz"
  tender_url: "https://mbingatc.go.tz/api/from-tamisemi"
...
scraping:
  ...
  documents:
    ...
    known_document_paths:
      - "/storage/app/uploads/public/58d/38a/133/"
      - "/storage/app/uploads/public/58d/397/568/"
      - "/storage/app/uploads/public/617/a65/8dd/"
      - "/storage/app/uploads/public/653/a3c/a89/"

    url_patterns:
      - "mbingatc.go.tz/storage/app/uploads/public/58d/38a/133/*.pdf"
      - "mbingatc.go.tz/storage/app/uploads/public/58d/397/568/*.pdf"
      - "mbingatc.go.tz/storage/app/uploads/public/617/a65/8dd/*.pdf"
      - "mbingatc.go.tz/storage/app/uploads/public/653/a3c/a89/*.pdf"
    ...
    document_notes: |
      Documents found under /storage/app/uploads/public/58d/38a/133/, /storage/app/uploads/public/58d/397/568/, /storage/app/uploads/public/617/a65/8dd/. Check for additional paths during scraping.
...
notes: |
  Category: Government. Keywords found: tender, ununuzi, tenders, manunuzi, zabuni.
  Emails: td@mbingatc.go.tz.
...
**Category:** Government
**Website:** https://mbingatc.go.tz
**Tender Page:** http://mbingatc.go.tz

## Scraping Instructions

**Strategy:** Scrape homepage and linked pages for tender/procurement documents. 4 document links discovered.
**Method:** http_get

Keywords found on site: tender, ununuzi, tenders, manunuzi, zabuni
...
Known document paths: /storage/app/uploads/public/58d/38a/133/, /storage/app/uploads/public/58d/397/568/, /storage/app/uploads/public/617/a65/8dd/, /storage/app/uploads/public/653/a3c/a89/
...
```json
{{
  "tender_id": "MBINGATC-2026-001",
  "institution": "mbingatc",
  ...
  "category": "Government",
  "status": "active",
  "source_url": "http://mbingatc.go.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/MBINGATC-2026-001/original/tender_document.pdf",
