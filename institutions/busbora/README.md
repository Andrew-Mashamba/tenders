...
website:
  homepage: "https://busbora.co.tz"
  tender_url: "https://busbora.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: "DISABLED: /about-us/tender is the 'About Us' page for a bus ticketing platform. No tender listings found. URL path contains 'tender' but content is company info only."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Scraping disabled. Page is About Us content, not tender listings (verified 2026-03-15).
...
**Category:** Commercial
**Website:** https://busbora.co.tz
**Tender Page:** https://busbora.co.tz/about-us/tender
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://busbora.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/BUSBORA-2026-001/original/tender_document.pdf",
