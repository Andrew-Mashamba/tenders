...
website:
  homepage: "https://glenfarmshop.co.tz"
  tender_url: "https://glenfarmshop.co.tz/tenders"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Tender page shows 'Website Under Maintenance' / 'Coming Soon'. No scrapable tender content."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Tender page is under maintenance (Coming Soon). No tender listings to scrape until site is live.
...
**Category:** Commercial
**Website:** https://glenfarmshop.co.tz
**Tender Page:** https://glenfarmshop.co.tz/tenders
...
```json
{{
  "tender_id": "GLENFARMSHOP-2026-001",
  "institution": "glenfarmshop",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://glenfarmshop.co.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/GLENFARMSHOP-2026-001/original/tender_document.pdf",
