---
institution:
  name: "Taifa Mining Civils Limited"
  slug: "taifamining"
  category: "Energy / Mining"
  status: "active"
  country: "Tanzania"
  domain: "taifamining.co.tz"
...
scraping:
  ...
  method: "http_get"
  strategy: |
    Corporate site: mining/civil services, news, compliance certificates. No tender listings.
    Documents at /wp-content/uploads/ (certificates only). No procurement/tender page.
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "taifamining.co.tz/wp-content/uploads/2025/03/taifa-mining-health-and-safety-certificate.pdf"
      - "taifamining.co.tz/wp-content/uploads/2025/03/taifa-mining-wcf-certificate-of-registration.pdf"
      - "taifamining.co.tz/wp-content/uploads/2025/03/taifa-mining-civils-limited-iso9001-certificate.pdf"
    ...
    document_notes: |
      /wp-content/uploads/ for compliance certificates only. No tender documents.
      Enable only if a tender/procurement page is added.
...
notes: |
  Organization website at taifamining.co.tz. Tender keywords detected: procurement, supply.
---
...
Known document paths: /wp-content/uploads/2025/03/taifa-mining-health-and-safety-certificate.pdf, /wp-content/uploads/2025/03/taifa-mining-wcf-certificate-of-registration.pdf, /wp-content/uploads/2025/03/taifa-mining-civils-limited-iso9001-certificate.pdf
...
```json
{{
  "tender_id": "TAIFAMINING-2026-001",
  "institution": "taifamining",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TAIFAMINING/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://taifamining.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://taifamining.co.tz/storage/tender.pdf",
      "local_path": "./downloads/TAIFAMINING-2026-001/original/tender_document.pdf",
