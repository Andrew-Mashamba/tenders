---
institution:
  name: "Wizara ya Elimu, Sayansi na Teknolojia (MoEST)"
  slug: "moe"
...
website:
  homepage: "https://moe.go.tz/"
  tender_url: "https://moe.go.tz/sw/manunuzi-na-ugavi"

contact:
  email: "complaints@moe.go.tz"
  alternate_emails:
    - "info@moe.go.tz"
  phone: "+255 26 216 0270 "

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://moe.go.tz/sw/manunuzi-na-ugavi (Manunuzi na Ugavi - Procurement). Page contains procurement unit info and duties. Tenders are posted on NeST (nest.go.tz). Extract document links from Miongozo (guidelines) section and linked pages. Check for matangazo (announcements) links."
  selectors:
    container: "main, .content, .entry-content, .page-content, article, section"
    tender_item: "article, .tender-item, .card, .row, li, tr, a[href*='matangazo']"
    title: "h2, h3, h4, .tender-title, a"
    date: ".date, .closing-date, .published, time"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[download], a[href*="moe.go.tz"]'
  ...
  documents:
    ...
    document_notes: |
      Manunuzi na Ugavi page is informational. Actual tenders posted on NeST (nest.go.tz). Extract links from Miongozo (guidelines) and matangazo (announcements). Check moe.go.tz/sw/matangazo for tender notices.
...
social_media:
  facebook: "moestvt"
  twitter: "wizara_elimuTz"
  instagram: "wizara_elimutanzania"

notes: |
  Organization website at moe.go.tz. Tender keywords detected: eoi, manunuzi, rfi.
---

# Wizara ya Elimu, Sayansi na Teknolojia |

**Category:** Government Agency
**Website:** https://moe.go.tz/
**Tender Page:** https://moe.go.tz/sw/manunuzi-na-ugavi
**Keywords Found:** eoi, manunuzi, rfi
...
- Phone: +255 26 216 0270 
- Phone: 01-01-1998    
- Phone: +255 737 962 965
- Phone: 02122-202526
- Phone: +255262963533

## Scraping Instructions

**Strategy:** Scrape https://moe.go.tz/sw/manunuzi-na-ugavi for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://moe.go.tz/sw/manunuzi-na-ugavi
...
```json
{{
  "tender_id": "MOE-2026-001",
  "institution": "moe",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MOE/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://moe.go.tz/sw/manunuzi-na-ugavi",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://moe.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MOE-2026-001/original/tender_document.pdf",
...
- **Signal Strength:** Strong (eoi, manunuzi)
