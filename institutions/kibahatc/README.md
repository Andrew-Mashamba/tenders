...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "kibahatc.go.tz"

website:
  homepage: "https://kibahatc.go.tz/"
  tender_url: "https://kibahatc.go.tz/tenders"

contact:
  phone: "07720928447189"

scraping:
  enabled: true
  method: "http_get"
  strategy: |
    October CMS site. Scrape https://kibahatc.go.tz/tenders - Zabuni page. Tenders in table.table-striped.
    Each row: Jina la Zabuni (title), Tarehe Iliyoongezwa (date), document link in last column (Pakua).
    Documents at /storage/app/uploads/public/{hash}/. Follow document links to download PDFs.
  selectors:
    container: ".right-sidebar-content"
    tender_item: "table.table.table-striped tbody tr"
    title: "td:first-child"
    date: "td:nth-child(2)"
    document_link: 'td:last-child a[href*="/storage/"]'
  ...
  documents:
    ...
    url_patterns:
      - "kibahatc.go.tz/storage/app/uploads/public/*"
    ...
    document_notes: |
      October CMS. Documents in /storage/app/uploads/public/{hash}/{filename}.pdf. Hash is 3 segments
      (e.g. 5bd/851/a68). Download links in table last column (Pakua). May need -k for SSL on .go.tz.
...
# Home &#124; Kibaha Town Council

**Category:** Local Government Authority
**Website:** https://kibahatc.go.tz/
**Tender Page:** https://kibahatc.go.tz/tenders
...
**Strategy:** Scrape https://kibahatc.go.tz/tenders for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://kibahatc.go.tz/tenders
- https://kibahatc.go.tz/procurement-and-supply

### Document Links Found

- https://kibahatc.go.tz/storage/app/uploads/public/5bd/851/a68/5bd851a68bb04995883573.pdf
- https://kibahatc.go.tz/storage/app/uploads/public/59c/837/467/59c8374670cd7258952613.pdf
- http://www.kibahatc.go.tz/storage/app/uploads/public/58d/6e4/b4e/58d6e4b4ef77c840744305.pdf
- https://kibahatc.go.tz/storage/app/uploads/public/629/710/e85/629710e85d0bd369568079.pdf
- https://kibahatc.go.tz/storage/app/uploads/public/58e/d43/bee/58ed43bee6b30147280779.pdf
- https://kibahatc.go.tz/storage/app/uploads/public/629/70f/cb7/62970fcb72903884861180.pdf
- https://kibahatc.go.tz/storage/app/uploads/public/5ba/9ea/d71/5ba9ead71b189089077534.pdf
- https://kibahatc.go.tz/storage/app/uploads/public/5a6/5db/507/5a65db5077209284471898.pdf
...
Known document paths: /storage/app/uploads/public/5bd/851/a68/5bd851a68bb04995883573.pdf, /storage/app/uploads/public/58d/6e4/b4e/58d6e4b4ef77c840744305.pdf, /storage/app/uploads/public/59c/837/467/59c8374670cd7258952613.pdf
...
{{
  ...
  "documents": [
    {{
      ...
      "original_url": "https://kibahatc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/KIBAHATC-2026-001/original/tender_document.pdf",
