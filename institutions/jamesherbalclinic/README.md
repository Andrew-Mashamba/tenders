---
institution:
  name: "James Herbal Clinic"
  slug: "jamesherbalclinic"
  category: "NGO/Non-Profit"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://jamesherbalclinic.or.tz"
  tender_url: "https://jamesherbalclinic.or.tz"

scraping:
  enabled: true
  method: "http_get"
  strategy: |
    WordPress/WooCommerce site. No dedicated tender page found — homepage has Products (cons_light_feature .feature-list .box), Services, Shop, Blog.
    Scrape homepage and blog for any tender/procurement announcements. Check /blog/ for posts. Documents in wp-content/uploads/.
  selectors:
    container: "#content.site-content, main#main, .cons_light_feature .feature-list, .entry-content"
    tender_item: ".feature-list .box, article.post, .woocommerce ul.products li.product"
    title: "h2.section-title, h3 a, .bottom-content h3 a, .woocommerce-loop-product__title"
    date: ".date, .closing-date, .published, time, .entry-date"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[download]'
    pagination: "link[rel='next'], .page-numbers a, a.next, .nav-links a"
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/wp-content/uploads/"
    url_patterns:
      - "jamesherbalclinic.or.tz/wp-content/uploads/*"
    document_notes: |
      WordPress site. Documents in wp-content/uploads/. No dedicated tender listing found — homepage shows products/services. Check blog for announcements.
...
**Category:** NGO/Non-Profit
**Website:** https://jamesherbalclinic.or.tz
**Tender Page:** https://jamesherbalclinic.or.tz
...
```json
{{
  "tender_id": "JAMESHERBALCLINIC-2026-001",
  "institution": "jamesherbalclinic",
  ...
  "category": "NGO/Non-Profit",
  "status": "active",
  "source_url": "https://jamesherbalclinic.or.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/JAMESHERBALCLINIC-2026-001/original/tender_document.pdf",
