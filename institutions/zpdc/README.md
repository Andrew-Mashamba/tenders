---
institution:
  name: "Zanzibar Petroleum Development Company"
  slug: "zpdc"
...
website:
  homepage: "https://zpdc.go.tz/"
  tender_url: "https://zpdc.go.tz/"

contact:
  email: "faabsofttech@gmail.com"
  alternate_emails:
    - "zpdc-info@zpdc.go.tz"
  phone: "024-10-20"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Previous tender_url (ww25.zan-eis.com) returns 503 Service Unavailable. ZPDC main site (zpdc.go.tz) should be checked for procurement/tenders page. Disabled until working tender URL confirmed."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      External tender URL (zan-eis.com) returns 503. ZPDC main site may have procurement section. Document paths unknown until site is reachable.
...
social_media:
  twitter: "themefisher"
  instagram: "themefisher.com"

notes: |
  ZPDC — Zanzibar Petroleum Development Company. External tender URL (zan-eis.com) unreachable (503). Check zpdc.go.tz for procurement section. Disabled 2026-03-15.
---

# Zanzibar Petroleum Development Company

**Category:** Local Government Authority
**Website:** https://zpdc.go.tz/
**Tender Page:** http://ww25.zan-eis.com/?subid1=20241016-2022-5345-bdab-cd7576897292
**Keywords Found:** bid, procurement, rfi, tender, tenders

## Contact Information
- Email: faabsofttech@gmail.com
- Email: zpdc-info@zpdc.go.tz
- Phone: 024-10-20
- Phone: +2552 42941218
- Phone: 0241016-2022-5
- Phone: 025-07-11

## Scraping Instructions

**Strategy:** Scrape http://ww25.zan-eis.com/?subid1=20241016-2022-5345-bdab-cd7576897292 for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> Procurement & tenders Job vacancies Oil and Gas

### Known Tender URLs

- http://ww25.zan-eis.com/?subid1=20241016-2022-5345-bdab-cd7576897292
...
```json
{{
  "tender_id": "ZPDC-2026-001",
  "institution": "zpdc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ZPDC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "http://ww25.zan-eis.com/?subid1=20241016-2022-5345-bdab-cd7576897292",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://zpdc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/ZPDC-2026-001/original/tender_document.pdf",
