...
website:
  homepage: "https://mabumbe.net/"
  tender_url: "https://mabumbe.net/"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Popular Tanzanian tender aggregator. Many banks publish here (DCB, Equity, NMB). Scrape for financial institution tenders."
  selectors:
    container: ".tenders, .content, main"
    tender_item: "article, .tender-item, .card"
    title: "h2, h3, .title, a"
    date: ".date, .deadline"
    institution: ".org, .company"
    category_filter: "financial, banking"
  ...
  documents:
    ...
    document_notes: |
      Popular aggregator. Many banks publish here. Download all financial sector tender documents.
...
notes: |
  Very popular Tanzanian job and tender aggregator. Many banks without dedicated tender pages publish here (DCB, Diamond Trust, Equity, etc). Good secondary source.
---

# Mabumbe

**Category:** Tender Aggregator  
**Website:** https://mabumbe.net/  
**Tender Page:** https://mabumbe.net/  
