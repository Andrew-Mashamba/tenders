...
website:
  homepage: "https://tanzaniaparks.go.tz"
  tender_url: "https://tanzaniaparks.go.tz/tenders"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Tanzania National Parks (TANAPA). Tender URL /tenders. Page unreachable during analysis (SSL/timeout). Keywords: tenders, tender. Re-enable and verify structure when reachable."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Page unreachable during analysis. Document paths to be discovered on first successful scrape. Emails: info@tanzaniaparks.go.tz, cc@tanzaniaparks.go.tz.
...
notes: |
  ...
  Emails: info@tanzaniaparks.go.tz, cc@tanzaniaparks.go.tz.
...
**Tender Page:** https://tanzaniaparks.go.tz
...
```json
{{
  "tender_id": "TANZANIAPARKS-2026-001",
  "institution": "tanzaniaparks",
  ...
  "category": "Government",
  "status": "active",
  "source_url": "https://tanzaniaparks.go.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/TANZANIAPARKS-2026-001/original/tender_document.pdf",
