...
website:
  homepage: "https://shipco.go.tz/"
  tender_url: "https://eprocurement.zppda.go.tz/"

contact:
  email: "info@shipco.go.tz"
  alternate_emails:
    - "support@shipco.go.tz"
  phone: "0599586183"

scraping:
  enabled: false
  method: "http_get"
  strategy: "eprocurement.zppda.go.tz redirects to /esop/guest/login.do - requires authentication. Government eProcurement portal cannot be scraped without login credentials."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      eProcurement portal requires login. Document paths unknown. Site uses meta robots noindex, noarchive.
...
notes: |
  Organization website at shipco.go.tz. Tender keywords detected: procurement.
---

# SHIPCO

**Category:** Government Agency
**Website:** https://shipco.go.tz/
**Tender Page:** https://eprocurement.zppda.go.tz/
**Keywords Found:** procurement

## Contact Information
- Email: info@shipco.go.tz
- Email: support@shipco.go.tz
- Phone: 0599586183
- Phone: +255777438739
...
> t="_blank">Government Mail System eProcurement erms <
...
{{
  ...
  "documents": [
    {{
      ...
      "original_url": "https://shipco.go.tz/storage/tender.pdf",
      "local_path": "./downloads/SHIPCO-2026-001/original/tender_document.pdf",
