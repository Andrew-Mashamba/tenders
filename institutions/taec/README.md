---
institution:
  name: "Tanzania Atomic Energy Commission (TAEC)"
  slug: "taec"
...
website:
  homepage: "https://taec.go.tz/"
  tender_url: "https://nest.go.tz/tenders/published-tenders?peUuid=9b00ebdd-cbe3-4c53-ac43-118dc26fa510"
...
scraping:
  ...
  documents:
    ...
    url_patterns:
      - "taec.go.tz/uploads/publications/68413214b1526.pdf"
      - "taec.go.tz/uploads/publications/6841316210311.pdf"
      - "taec.go.tz/uploads/publications/684130a07d694.pdf"
      - "taec.go.tz/uploads/publications/UFADHILI-WA-MAMA-SAMIA-Updated.pdf"
      - "taec.go.tz/uploads/publications/6790e579da3ef.docx"
    ...
    document_notes: |
      TAEC main site (taec.go.tz) has /uploads/publications/ for PDFs. NeST (nest.go.tz) hosts tenders.
      Re-enable when nest.go.tz is reachable. peUuid=9b00ebdd-cbe3-4c53-ac43-118dc26fa510 filters TAEC tenders.
...
social_media:
  facebook: "benjaminmkapa.hospital.712"

notes: |
  Organization website at taec.go.tz. Tender keywords detected: tender, tenders, zabuni.
---

# Site title short |     Nyumbani

**Category:** Government Agency
**Website:** https://taec.go.tz/
**Tender Page:** https://nest.go.tz/tenders/published-tenders?peUuid=9b00ebdd-cbe3-4c53-ac43-118dc26fa510
**Keywords Found:** tender, tenders, zabuni

## Contact Information
- Email: dg@taec.go.tz
- Email: barua@taec.go.tz
- Phone: 025
...
**Strategy:** Scrape https://nest.go.tz/tenders/published-tenders?peUuid=9b00ebdd-cbe3-4c53-ac43-118dc26fa510 for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> href="https://nest.go.tz/tenders/published-tenders?peUuid=9b00ebdd-cbe3-4c53-ac43-118dc26fa510">Zabuni

### Known Tender URLs

- https://nest.go.tz/tenders/published-tenders?peUuid=9b00ebdd-cbe3-4c53-ac43-118dc26fa510

### Document Links Found

- https://taec.go.tz/uploads/publications/6790e579da3ef.docx
- https://taec.go.tz/uploads/publications/UFADHILI-WA-MAMA-SAMIA-Updated.pdf
- https://taec.go.tz/uploads/publications/68413214b1526.pdf
- https://taec.go.tz/uploads/publications/Measurement-of-Environmental-radiation-and-radioactivity-in-SZ.pdf
- https://taec.go.tz/uploads/publications/6841316210311.pdf
- https://taec.go.tz/uploads/publications/684130a07d694.pdf
...
Known document paths: /uploads/publications/68413214b1526.pdf, /uploads/publications/6841316210311.pdf, /uploads/publications/684130a07d694.pdf
...
```json
{{
  "tender_id": "TAEC-2026-001",
  "institution": "taec",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TAEC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://nest.go.tz/tenders/published-tenders?peUuid=9b00ebdd-cbe3-4c53-ac43-118dc26fa510",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://taec.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TAEC-2026-001/original/tender_document.pdf",
