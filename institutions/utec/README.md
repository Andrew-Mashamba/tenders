...
website:
  homepage: "https://utec.co.tz"
  tender_url: "https://utec.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "IT/security solutions company - no dedicated tender page. Homepage has products (radio, security, solar, ICT). Check /request-quote for RFQ. No tender listing found. Keep generic selectors for future tender page."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender listing on homepage. Commercial IT/security company. Document paths to be discovered if tender page added.
...
notes: |
  ...
  Emails: info@utec.co.tz, md@utec.co.tz.
  Discovered by crawler on 2026-03-15.
---

# Two-Way Comm & Security Solutions

**Category:** Commercial
**Website:** https://utec.co.tz
**Tender Page:** https://utec.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://utec.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/UTEC-2026-001/original/tender_document.pdf",
