...
website:
  homepage: "https://spaide.or.tz"
  tender_url: "https://spaide.or.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Homepage has no tender/procurement content. SPAIDE is an NGO (Sustainable Participatory Intervention for Development). Site shows services, workshops, team. No tender listings or document links. Disable until dedicated tender page is discovered."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender documents. NGO website with capacity-building focus. No procurement section.
...
notes: |
  Category: NGO/Non-Profit. Keywords found: procurement.
  Emails: amwaimu@spaide.or.tz, example@gmail.com, Yoursite@ex.com, Example@gmail.com.
...
**Category:** NGO/Non-Profit
**Website:** https://spaide.or.tz
**Tender Page:** https://spaide.or.tz
...
{{
  ...
  "category": "NGO/Non-Profit",
  "status": "active",
  "source_url": "https://spaide.or.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/SPAIDE-2026-001/original/tender_document.pdf",
