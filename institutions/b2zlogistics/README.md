...
website:
  homepage: "https://b2zlogistics.co.tz"
  tender_url: "https://b2zlogistics.co.tz"
...
scraping:
  ...
  selectors:
    ...
    date: ".date, time"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href*="/media/attachments/"]'
  ...
  documents:
    ...
    url_patterns:
      - "b2zlogistics.co.tz/media/attachments/*/*/*/*.pdf"
    ...
    document_notes: |
      Documents in /media/attachments/YYYY/MM/DD/. Company profile PDF at b2z-logistics-company-profile.pdf. Check /services subpages for tender documents.
...
notes: |
  ...
  Emails: info@b2zlogistics.co.tz.
...
**Category:** Commercial
**Website:** https://b2zlogistics.co.tz
**Tender Page:** https://b2zlogistics.co.tz
...
Known document paths: /media/attachments/2022/12/05/
...
```json
{{
  "tender_id": "B2ZLOGISTICS-2026-001",
  "institution": "b2zlogistics",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://b2zlogistics.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/B2ZLOGISTICS-2026-001/original/tender_document.pdf",
