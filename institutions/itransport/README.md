...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "itransport.co.tz"

website:
  homepage: "https://itransport.co.tz/"
  tender_url: "https://itransport.co.tz/"

contact:
  email: "webmaster@itransport.co.tz"

scraping:
  enabled: true
  method: "http_get"
  strategy: |
    Website unreachable. https://itransport.co.tz/ returns "Account Suspended" - hosting account
    has been suspended. Contact webmaster@itransport.co.tz. Disabled until site is restored.
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Site suspended. No access to documents. Re-enable when itransport.co.tz is restored.
...
notes: |
  Organization website at itransport.co.tz. Tender keywords detected: rfp.
---

# Account Suspended

**Category:** Transport / Logistics
**Website:** https://itransport.co.tz/
**Tender Page:** https://itransport.co.tz/
**Keywords Found:** rfp
...
**Strategy:** Scrape https://itransport.co.tz/ for tender/procurement notices.
**Method:** http_get
...
```json
{{
  "tender_id": "ITRANSPORT-2026-001",
  "institution": "itransport",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ITRANSPORT/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://itransport.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://itransport.co.tz/storage/tender.pdf",
      "local_path": "./downloads/ITRANSPORT-2026-001/original/tender_document.pdf",
