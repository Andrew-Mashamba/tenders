---
institution:
  name: "Drilling and Dam Construction Agency (DDCA)"
  slug: "ddca"
...
website:
  homepage: "https://ddca.go.tz/"
  tender_url: "https://ddca.go.tz/kitengo-cha-manunuzi"

contact:
  email: "info@ddca.go.tz"
  phone: "0603865704602"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Tender page (kitengo-cha-manunuzi) accessible. Page shows PMU structure/org info only; no active tender listings or document links. Matangazo ya Zabuni and mpango wa manunuzi are section headings, not tender items. Check for tender detail pages when agency posts new opportunities.
...
social_media:
  facebook: "Drilling-and-Dam-Construction-Agency-DDCA-1210603865704602"

notes: |
  Organization website at ddca.go.tz. Tender keywords detected: bid, manunuzi, zabuni.
---

# home &#124; DRILLING AND DAM CONSTRUCTION AGENCY(DDCA)

**Category:** Government Agency
**Website:** https://ddca.go.tz/
**Tender Page:** https://ddca.go.tz/kitengo-cha-manunuzi
**Keywords Found:** bid, manunuzi, zabuni
...
> Matangazo ya Zabuni Mpango Manunuzi wa mwaka <

### Known Tender URLs

- https://ddca.go.tz/kitengo-cha-manunuzi
- https://ddca.go.tz/mpango-wa-manunuzi
...
```json
{{
  "tender_id": "DDCA-2026-001",
  "institution": "ddca",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "DDCA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://ddca.go.tz/kitengo-cha-manunuzi",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://ddca.go.tz/storage/tender.pdf",
      "local_path": "./downloads/DDCA-2026-001/original/tender_document.pdf",
