...
website:
  homepage: "https://tilishosafari.co.tz"
  tender_url: "https://tilishosafari.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    Bus booking platform. URL /about-us/tender exists but page content is "About Us"
    (company mission, services) - no tender listing found. May be placeholder for future
    tenders. Scrape for document links; check if tender content appears later.
  selectors:
    container: "main, .content, .page-content, .entry-content, article"
  ...
  documents:
    ...
    document_notes: |
      About-us/tender page has no tender content. No document paths identified.
...
**Category:** Commercial
**Website:** https://tilishosafari.co.tz
**Tender Page:** https://tilishosafari.co.tz/about-us/tender
...
```json
{{
  "tender_id": "TILISHOSAFARI-2026-001",
  "institution": "tilishosafari",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://tilishosafari.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/TILISHOSAFARI-2026-001/original/tender_document.pdf",
