---
institution:
  name: "ITEL East Africa Limited"
  slug: "iteleastafricaltd"
  category: "Commercial"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://iteleastafricaltd.co.tz"
  tender_url: "https://iteleastafricaltd.co.tz/tendering-and-business-representation.html"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    Scrape https://iteleastafricaltd.co.tz and /tendering-and-business-representation.html.
    ITEL has a tendering division but NO dedicated tender listing page. Homepage and tendering page
    are informational/marketing only. Check for document links; no structured tender table found.
  selectors:
    container: "main, .content, .container"
    tender_item: "article, .card, .row, section"
  ...
  documents:
    ...
    document_notes: |
      No tender listing page found. Tendering page is informational. Document paths to be discovered if any appear.
...
notes: |
  ...
  Emails: info@waveslimited.com, 7xthemedemo@gmail.com, sales@iteleastafricaltd.co.tz.
  Discovered by crawler on 2026-03-15.
---

# ITEL East Africa Limited

**Category:** Commercial
**Website:** https://iteleastafricaltd.co.tz
**Tender Page:** https://iteleastafricaltd.co.tz
...
```json
{{
  "tender_id": "ITELEASTAFRICALTD-2026-001",
  "institution": "iteleastafricaltd",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://iteleastafricaltd.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/ITELEASTAFRICALTD-2026-001/original/tender_document.pdf",
