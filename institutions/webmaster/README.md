---
institution:
  name: "Webmaster Tanzania Official Website"
  slug: "webmaster"
  category: "Commercial"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://webmaster.co.tz"
  tender_url: "https://webmaster.co.tz"

scraping:
  enabled: true
  method: "http_get"
  strategy: |
    Scrape https://webmaster.co.tz. Divi/WordPress site. Homepage is hosting services; check for
    /tenders, /procurement, /rfq, /rfp subpages. Main content in #main-content, .entry-content.
    et_pb_section/et_pb_row for layout. Document links may be in et_pb_button or a tags.
  selectors:
    container: "#main-content, .entry-content, .et_pb_section"
    tender_item: "article.hentry, .et_pb_section, .et_pb_row"
    title: "h2.et_pb_slide_title, h2, h3, .et_pb_slide_content"
  ...
  documents:
    ...
    document_notes: |
      Homepage is hosting-focused. Tender/RFQ/RFP page not yet confirmed. Crawl site for /tenders,
      /procurement paths. Document paths to be discovered on first run.
...
notes: |
  Category: Commercial. Keywords found: rfq, rfp.
  Emails: info@webmaster.co.tz.
  Discovered by crawler on 2026-03-15.
---

# Webmaster Tanzania Official Website

**Category:** Commercial
**Website:** https://webmaster.co.tz
**Tender Page:** https://webmaster.co.tz
...
Keywords found on site: rfq, rfp
...
```json
{{
  "tender_id": "WEBMASTER-2026-001",
  "institution": "webmaster",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://webmaster.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/WEBMASTER-2026-001/original/tender_document.pdf",
