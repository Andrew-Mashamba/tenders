...
website:
  homepage: "https://cloudsense.co.tz"
  tender_url: "https://cloudsense.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    WordPress/Elementor site. Homepage has Products, Contact Us. No dedicated tender page.
    Uses Porto theme, MasterSlider, WooCommerce. Documents in wp-content/uploads/.
  selectors:
    container: ".elementor, main, .e-con, .elementor-widget-wrap"
    tender_item: ".elementor-element, .elementor-widget, article"
    title: "h2, h3, .elementor-heading-title, .porto-u-main-heading"
    date: ".date, time"
    document_link: 'a[href$=".pdf"], a[href*="/wp-content/uploads/"]'
    pagination: ".pagination a, .elementor-nav-menu a"
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/wp-content/uploads/"
    url_patterns:
      - "cloudsense.co.tz/wp-content/uploads/*"
    document_notes: |
      WordPress site. Documents in wp-content/uploads/. No tender listing on homepage; check Products/Contact pages.
...
notes: |
  ...
  Emails: ajax-loader@2x.gif, info@cloudsense.co.tz.
...
**Category:** Commercial
**Website:** https://cloudsense.co.tz
**Tender Page:** https://cloudsense.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://cloudsense.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/CLOUDSENSE-2026-001/original/tender_document.pdf",
