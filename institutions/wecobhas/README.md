---
institution:
  name: "West Evan College of Business, Health and Allied Sciences (WECOBHAS)"
  slug: "wecobhas"
  category: "Academic"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://wecobhas.ac.tz"
  tender_url: "https://wecobhas.ac.tz"
...
scraping:
  ...
  selectors:
    ...
    title: "h4, h5, h6, a[href*='.pdf']"
    date: "Posted on, .date, .updated"
    document_link: 'a[href*="/www/100/news/"], a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"]'
    pagination: ".pagination a, a.next, a[href*='news-and-events']"
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "wecobhas.ac.tz/www/100/news/*.pdf"
      - "wecobhas.ac.tz/www/100/news/*"
    ...
    document_notes: |
      Documents in /www/100/news/ with hashed filenames (e.g. a05fbf1d4cfilename-Joining%20Instructions...).
      LATEST DOWNLOADS = academic docs; LATEST NEWS links to job ads. Procurement-related content in news.
...
notes: |
  Category: Academic. Keywords found: procurement.
  Emails: info@wecobhas.ac.tz.
...
**Category:** Academic
**Website:** https://wecobhas.ac.tz
**Tender Page:** https://wecobhas.ac.tz
...
Known document paths: /www/100/news/
...
```json
{{
  "tender_id": "WECOBHAS-2026-001",
  "institution": "wecobhas",
  ...
  "category": "Academic",
  "status": "active",
  "source_url": "https://wecobhas.ac.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/WECOBHAS-2026-001/original/tender_document.pdf",
