...
scraping:
  ...
  selectors:
    ...
    title: "h1, h2.sppb-addon-title, .sppb-addon-title"
    date: ".date, .published, .sppb-addon-content"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[href*="/images/"], a[href*="/documents/"]'
  ...
  documents:
    ...
    url_patterns:
      - "web.ku.ac.tz/images/*.pdf"
      - "web.ku.ac.tz/images/documents/*.pdf"
    ...
    document_notes: |
      Joomla + SP Page Builder. RFP content in article body. Documents in /images/, /documents/, downloads.ku.ac.tz. Check IREC for procurement. Single RFP per article; follow category links for more.
...
notes: |
  Organization website at ku.ac.tz. Tender keywords detected: request for proposal, rfi, rfp.
---
