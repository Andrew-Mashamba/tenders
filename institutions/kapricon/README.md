...
website:
  homepage: "https://kapricon.co.tz"
  tender_url: "https://kapricon.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    Bus booking platform (Kapricon/Busbora). /about-us/tender is About Us page, not tender listings.
    Page shows "please wait" preloader; content loads via JavaScript. No tender section.
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Bus ticketing site; no tender content. /about-us/tender is About Us, not procurement.
...
**Category:** Commercial
**Website:** https://kapricon.co.tz
**Tender Page:** https://kapricon.co.tz/about-us/tender
...
```json
{{
  "tender_id": "KAPRICON-2026-001",
  "institution": "kapricon",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://kapricon.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KAPRICON-2026-001/original/tender_document.pdf",
