---
institution:
  name: "Kibaha College of Medicine and Allied Sciences (KCMUCO)"
  slug: "kcmuco"
  category: "Academic"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://kcmuco.ac.tz"
  tender_url: "https://kcmuco.ac.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "kcmuco.ac.tz returns 'Account Suspended' page. Hosting account is suspended. Scraping disabled until site is restored."
  selectors:
...
notes: |
  Category: Academic. Keywords found: rfp. Site returns 'Account Suspended' (verified 2026-03-15). Scraping disabled.
---
...
**Tender Page:** https://kcmuco.ac.tz
...
{{
  ...
  "category": "Academic",
  "status": "active",
  "source_url": "https://kcmuco.ac.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KCMUCO-2026-001/original/tender_document.pdf",
