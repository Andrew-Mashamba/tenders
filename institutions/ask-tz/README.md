...
website:
  homepage: "https://ask.tz"
  tender_url: "https://ask.tz/tenders"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Site offline—'board temporarily unavailable, undergoing maintenance'. Disable until ask.tz/tenders is back online."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Site offline. Document paths unknown. Appears to be phpBB-style forum. Re-check when site returns.
...
**Category:** Commercial
**Website:** https://ask.tz
**Tender Page:** https://ask.tz/tenders
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://ask.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/ASK-TZ-2026-001/original/tender_document.pdf",
