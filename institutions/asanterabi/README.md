...
website:
  homepage: "https://asanterabi.co.tz"
  tender_url: "https://asanterabi.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Page shows 'Please wait' and OTP form—content is JS-rendered (SPA). Tender content not accessible via HTTP GET. Disable until headless browser (Puppeteer/Playwright) is used or page structure changes."
  selectors:
    container: ".content, main, .page-content, .entry-content, article"
  ...
  documents:
    ...
    document_notes: |
      Page requires JavaScript. Shows 'Please wait' and OTP form—content likely loads dynamically. Document paths unknown until JS-rendered content is scraped.
...
**Category:** Commercial
**Website:** https://asanterabi.co.tz
**Tender Page:** https://asanterabi.co.tz/about-us/tender
...
```json
{{
  "tender_id": "ASANTERABI-2026-001",
  "institution": "asanterabi",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://asanterabi.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/ASANTERABI-2026-001/original/tender_document.pdf",
