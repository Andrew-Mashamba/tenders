---
institution:
  name: "Mwanzo - Wizara ya Fedha na Mipango-Zanzibar"
  slug: "mofzanzibar"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "mofzanzibar.go.tz"

website:
  homepage: "https://mofzanzibar.go.tz/"
  tender_url: "https://eprocurement.zppda.go.tz"

contact:
  email: "info@mofzanzibar.go.tz"
  phone: "00 408 258 167"

scraping:
  enabled: true
  method: "http_get"
  strategy: "MOF Zanzibar tender_url points to eprocurement.zppda.go.tz (Zanzibar e-procurement). Platform may require JavaScript. Scrape for Wizara ya Fedha na Mipango Zanzibar tenders. Filter by institution."
  selectors:
    container: ".tender-list, .content, main, .entry-content, .page-content, article, .procurement-list"
  ...
  documents:
    ...
    document_notes: |
      eprocurement.zppda.go.tz is shared Zanzibar e-procurement platform. May require JS. Documents in tender detail views. Filter for MoF Zanzibar. Also check mofzanzibar.go.tz/kuhusu-sisi/orfp-muundo/ for RFP templates.
...
social_media:
  facebook: "wemaznz"
  instagram: "moevt_zanzibar"

notes: |
  Organization website at mofzanzibar.go.tz. Tender keywords detected: procurement, rfp.
---

# Mwanzo - Wizara ya Fedha na Mipango-Zanzibar

**Category:** Government Agency
**Website:** https://mofzanzibar.go.tz/
**Tender Page:** https://eprocurement.zppda.go.tz
**Keywords Found:** procurement, rfp
...
> i> e-PROZ <li class="elementor-icon-list-item elementor-inline-i

### Known Tender URLs

- https://eprocurement.zppda.go.tz
- https://mofzanzibar.go.tz/kuhusu-sisi/orfp-muundo/
...
```json
{{
  "tender_id": "MOFZANZIBAR-2026-001",
  "institution": "mofzanzibar",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MOFZANZIBAR/T/2026/001",
  ...
  "documents": [
    {{
      ...
      "original_url": "https://mofzanzibar.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MOFZANZIBAR-2026-001/original/tender_document.pdf",
