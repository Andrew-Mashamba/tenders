---
institution:
  name: "Investment"  # Site suspended; name from domain
  slug: "investment"
  category: "Investment / Securities"
  status: "active"
  country: "Tanzania"
  domain: "investment.co.tz"

website:
  homepage: "https://investment.co.tz/"
  tender_url: "https://investment.co.tz/"

contact:
  email: "webmaster@investment.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Account suspended. Tender page unreachable. Disabled until site is restored."
  selectors:
...
notes: |
  Organization website at investment.co.tz. Tender keywords detected: rfp.
---

# Investment

**Category:** Investment / Securities
**Website:** https://investment.co.tz/
**Tender Page:** https://investment.co.tz/
**Keywords Found:** rfp
...
**Strategy:** Scrape https://investment.co.tz/ for tender/procurement notices.
**Method:** http_get
...
```json
{{
  "tender_id": "INVESTMENT-2026-001",
  "institution": "investment",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "INVESTMENT/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://investment.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://investment.co.tz/storage/tender.pdf",
      "local_path": "./downloads/INVESTMENT-2026-001/original/tender_document.pdf",
