---
institution:
  name: "Swissport International AG - Tanzania"
  slug: "swissport"
  category: "Commercial / Private Sector"
  status: "active"
  country: "Tanzania"
  domain: "swissport.co.tz"

website:
  homepage: "https://www.swissport.com/"
  tender_url: "https://www.swissport.com/en/sustainability/policy/sustainable-procurement"
...
scraping:
  ...
  method: "http_get"
  strategy: |
    The tender_url points to a Sustainable Procurement POLICY page (Code of Conduct, Sustainable Sourcing Policy).
    No tender listings or individual tender items exist on this page. It is policy content only.
    If Swissport Tanzania posts tenders, they may use a different URL (not yet identified).
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender page found. The sustainable-procurement URL shows policy documents only (Code of Conduct, SSP).
      No document paths identified. Enable scraping only when a dedicated tender page is discovered.
...
social_media:
  facebook: "tr"
  twitter: "swissportnews"
  linkedin: "swissport"
  instagram: "swissport_intl"

notes: |
  description
---

# Swissport International AG - Tanzania

**Category:** Commercial / Private Sector
**Website:** https://www.swissport.com/
**Tender Page:** https://www.swissport.com/en/sustainability/policy/sustainable-procurement
...
**Strategy:** Scrape https://www.swissport.com/en/sustainability/policy/sustainable-procurement for tender/procurement notices.
**Method:** http_get
...
> <a href="https://www.swissport.com/en/sustainability/policy/sustainable-procurement" target="_self" class="header__thirdlev

### Known Tender URLs

- https://www.swissport.com/en/sustainability/policy/sustainable-procurement
...
```json
{{
  "tender_id": "SWISSPORT-2026-001",
  "institution": "swissport",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "SWISSPORT/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.swissport.com/en/sustainability/policy/sustainable-procurement",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://www.swissport.com/storage/tender.pdf",
      "local_path": "./downloads/SWISSPORT-2026-001/original/tender_document.pdf",
