---
institution:
  name: "Kibong'oto Infectious Disease Hospital (KIDH)"
  slug: "kidh"
...
website:
  homepage: "https://kidh.go.tz/"
  tender_url: "https://kidh.go.tz/opportunity/opportunity/opportunity-tender/"

contact:
  email: "info@kidh.go.tz"
  phone: "07253255335731"
...
scraping:
  ...
  selectors:
    ...
    title: ".card-title"
    date: ".card-subtitle.text-muted"
    document_link: 'form[action*="download-opportunity-file"] button, a.btn[href*="view-opportunity"]'
  ...
  documents:
    ...
    document_notes: |
      Documents require POST to download-opportunity-file with CSRF. Visit /opportunity/opportunity/view-opportunity/{uuid}/
      for each tender, then submit the download form. No direct PDF links - form-based download.
...
notes: |
  Organization website at kidh.go.tz. Tender keywords detected: tender.
---

# Home  | Kibong'oto Infectious Disease Hospital

**Category:** Government Agency
**Website:** https://kidh.go.tz/
**Tender Page:** https://kidh.go.tz/opportunity/opportunity/opportunity-tender/
...
**Strategy:** Scrape https://kidh.go.tz/opportunity/opportunity/opportunity-tender/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://kidh.go.tz/opportunity/opportunity/opportunity-tender/
...
{{
  ...
  "reference_number": "KIDH/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://kidh.go.tz/opportunity/opportunity/opportunity-tender/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://kidh.go.tz/storage/tender.pdf",
      "local_path": "./downloads/KIDH-2026-001/original/tender_document.pdf",
