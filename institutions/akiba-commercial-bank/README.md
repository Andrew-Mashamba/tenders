...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Check for PDF links within tender listing cards.
...
notes: |
  Has a dedicated /tenders/ page. Expect HTML content with tender listings.
---
...
{{
  ...
  "institution": "akiba-commercial-bank",
