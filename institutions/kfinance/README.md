...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "kfinance.co.tz"

website:
  homepage: "https://kfinance.co.tz/"
  tender_url: "https://kfinance.co.tz/tender-loan/"

contact:
  phone: "+255 739 799 115  "

scraping:
  enabled: false
  method: "http_get"
  strategy: |
    DISABLED: The tender-loan page (https://kfinance.co.tz/tender-loan/) is a LOAN PRODUCT page
    (Mkopo wa Tender - business loans TZS 5M-50M), NOT a procurement tenders page. No zabuni/manunuzi
    content. Re-enable if K-FINANCE adds a procurement tenders section.
  selectors:
...
social_media:
  facebook: "kfinancetz"
  twitter: "KFinancetz"
  instagram: "kfinance_tz"

notes: |
  Financing | Insuring | Training K-FINANCE Mikopo wa Haraka Riba Nafuu, Dhamana Gari Ada ya Shule Mkopo wa Wafanyakazi, Mkopo wa Biashara,
---

# home - K-FINANCE

**Category:** Microfinance / Financial Services
**Website:** https://kfinance.co.tz/
**Tender Page:** https://kfinance.co.tz/tender-loan/
...
- Phone: 025-05-23
- Phone: 015-12-14
- Phone: +255 715 799 115  
- Phone: 0 0 1024 1024

## Scraping Instructions

**Strategy:** Scrape https://kfinance.co.tz/tender-loan/ for tender/procurement notices.
**Method:** http_get
...
> ult stm_mega_cols_inside_default stm_mega_col_width_banner_default"> Tender Loan Se

### Known Tender URLs

- https://kfinance.co.tz/tender-loan/
...
```json
{{
  "tender_id": "KFINANCE-2026-001",
  "institution": "kfinance",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "KFINANCE/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://kfinance.co.tz/tender-loan/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://kfinance.co.tz/storage/tender.pdf",
      "local_path": "./downloads/KFINANCE-2026-001/original/tender_document.pdf",
