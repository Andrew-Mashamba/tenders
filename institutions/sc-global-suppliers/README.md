---
institution:
  name: "Standard Chartered Global Suppliers Portal"
  slug: "sc-global-suppliers"
  category: "Global Procurement Portal"
  status: "active"
  country: "International"

website:
  homepage: "https://www.sc.com/"
  tender_url: "https://www.sc.com/en/suppliers/"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Global supplier portal. Reduced Tanzania activity after retail divestiture.
...
notes: |
  Global supplier portal for Standard Chartered Bank. The Tanzania retail arm was transferred
  to Access Bank in May 2025, so only corporate/institutional banking remains in Tanzania.
  Local procurement volume likely reduced. Filter by region for Tanzania/Africa.
  Related institution folder: standard-chartered
---

# Standard Chartered Global Suppliers Portal

**Category:** Global Procurement Portal
**Website:** https://www.sc.com/
**Tender Page:** https://www.sc.com/en/suppliers/

## Scraping Instructions

**Strategy:** Scrape global suppliers page, filter for Tanzania/Africa.
**Method:** http_get (may require JavaScript)

## Relationship to Standard Chartered Tanzania

- SC Tanzania (see `standard-chartered` folder) transferred retail to Access Bank (May 2025)
- Only corporate/institutional operations remain
- Local procurement now goes through this global portal

## Notes

Expect reduced Tanzania-specific procurement after retail arm divestiture.
...
{{
  ...
  "institution": "sc-global-suppliers",
