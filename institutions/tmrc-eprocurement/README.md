---
institution:
  name: "TMRC e-Procurement Portal"
  slug: "tmrc-eprocurement"
  category: "Institutional e-Procurement"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://eprocurement.tmrc.co.tz"
  tender_url: "https://eprocurement.tmrc.co.tz"
...
scraping:
  ...
  selectors:
    ...
    title: "td, h3, .title, .tender-title"
    date: "td, .deadline, .closing-date, .submission-date"
    status: ".status, .badge, td"
  ...
  documents:
    ...
    document_notes: |
      Dedicated e-procurement portal. Registration likely required for document downloads.
...
alternative_sources:
  - name: "TMRC Website Tenders"
    url: "https://www.tmrc.co.tz/resources/category/tenders-and-vacancies"
  - name: "TANePS"
    url: "https://www.taneps.go.tz/"

notes: |
  Separate online e-procurement portal for Tanzania Mortgage Refinance Company.
  This is a dedicated system distinct from the tender listings on the main TMRC website
  (tmrc.co.tz/resources/category/tenders-and-vacancies). May have more structured
  bid submission and tracking features. Registration likely required.
  Related institution folder: tmrc
---

# TMRC e-Procurement Portal

**Category:** Institutional e-Procurement
**Website:** https://eprocurement.tmrc.co.tz
**Tender Page:** https://eprocurement.tmrc.co.tz

## Scraping Instructions

**Strategy:** Scrape e-procurement portal for active tenders. Registration may be required.
**Method:** http_get_with_auth

## Relationship to TMRC Main Site

- **tmrc.co.tz/resources/category/tenders-and-vacancies** — Static tender listings (see `tmrc` folder)
- **eprocurement.tmrc.co.tz** — This interactive e-procurement portal

## Notes

Dedicated procurement system. Likely requires account registration. Check for both open tenders and contract awards.
