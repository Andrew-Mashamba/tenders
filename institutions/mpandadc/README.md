...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "mpandadc.go.tz"

website:
  homepage: "https://mpandadc.go.tz/"
  tender_url: "https://mpandadc.go.tz/tenders"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Fetch https://mpandadc.go.tz/tenders. October CMS with table.table.table-striped. Each tbody tr = one tender. Columns: Tender Name, dates, Pakua (document link). /ugavi-na-manunuzi has no table."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "mpandadc.go.tz/storage/app/uploads/public/*"
    ...
    document_notes: |
      October CMS. Documents in /storage/app/uploads/public/{hash}/ (PDF, ZIP). Table has 'Pakua' or similar download links. Resolve relative hrefs.
...
**Category:** Local Government Authority
**Website:** https://mpandadc.go.tz/
**Tender Page:** https://mpandadc.go.tz/ugavi-na-manunuzi
...
**Strategy:** Scrape https://mpandadc.go.tz/ugavi-na-manunuzi for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://mpandadc.go.tz/ugavi-na-manunuzi
- https://mpandadc.go.tz/tenders
- https://mpandadc.go.tz/event/kukabidhi-mfano-wa-hundi-kwa-vijiji-8-vya-mradi-wa-hewa-ukaa

### Document Links Found

- https://mpandadc.go.tz/storage/app/uploads/public/66e/d26/1f3/66ed261f38ba3110041798.pdf
- https://mpandadc.go.tz/storage/app/uploads/public/631/d8f/dc8/631d8fdc812af219494722.pdf
- https://mpandadc.go.tz/storage/app/uploads/public/66e/d25/9de/66ed259def58f168603966.pdf
- https://mpandadc.go.tz/storage/app/uploads/public/604/0f5/95c/6040f595cbeb7395959353.pdf
- https://mpandadc.go.tz/storage/app/uploads/public/5c0/28d/df4/5c028ddf4881c226704437.pdf
- https://mpandadc.go.tz/storage/app/uploads/public/5b7/13c/45a/5b713c45a9442963672313.pdf
...
Known document paths: /storage/app/uploads/public/5b7/13c/45a/5b713c45a9442963672313.pdf, /storage/app/uploads/public/631/d8f/dc8/631d8fdc812af219494722.pdf, /storage/app/uploads/public/66e/d25/9de/66ed259def58f168603966.pdf
...
```json
{{
  "tender_id": "MPANDADC-2026-001",
  "institution": "mpandadc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MPANDADC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://mpandadc.go.tz/ugavi-na-manunuzi",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://mpandadc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MPANDADC-2026-001/original/tender_document.pdf",
