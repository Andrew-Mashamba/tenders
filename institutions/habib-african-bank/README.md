---
institution:
  name: "Habib African Bank Tanzania"
  slug: "habib-african-bank"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. Small bank with limited public procurement."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
  ...
  documents:
    ...
    url_patterns:
      - "habibafricanbank.co.tz/*.pdf"
      - "habibafricanbank.co.tz/*.docx"
      - "habibafricanbank.co.tz/*.xlsx"
...
notes: |
  No tender page found. Small operation.
---

# Habib African Bank Tanzania

**Category:** Commercial Bank  
**Website:** https://habibafricanbank.co.tz/  
**Tender Page:** null  
...
{{
  ...
  "institution": "habib-african-bank",
