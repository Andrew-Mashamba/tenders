---
institution:
  name: "FINCA Microfinance Bank Tanzania"
  slug: "finca-bank"
...
scraping:
  ...
  documents:
    ...
    url_patterns:
      - "finca.co.tz/*.pdf"
      - "finca.co.tz/wp-content/uploads/*.pdf"
    ...
    document_notes: |
      International microfinance org. Tender docs may follow FINCA global procurement standards.
...
notes: |
  International microfinance bank. Has dedicated tenders page. Part of FINCA Impact Finance global network.
---
