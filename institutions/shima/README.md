---
institution:
  name: "Prisons Corporation Sole (PCS)"
  slug: "shima"
...
website:
  homepage: "https://shima.go.tz/"
  tender_url: "https://shima.go.tz/"

contact:
  email: "corpsole@prisons.go.tz"
  phone: "096869883"
...
notes: |
  Prison Corporate Sole Website
---

# PCS |   Prisons Corporation Sole (PCS) - Mwanzo

**Category:** Government Agency
**Website:** https://shima.go.tz/
**Tender Page:** https://shima.go.tz/
...
**Strategy:** Scrape https://shima.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> o.tz/pages/joint-venture-project-jvp'>Miradi ya Ubia Zabuni Ajira Machapisho <ul class=
...
```json
{{
  "tender_id": "SHIMA-2026-001",
  "institution": "shima",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "SHIMA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://shima.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://shima.go.tz/storage/tender.pdf",
      "local_path": "./downloads/SHIMA-2026-001/original/tender_document.pdf",
