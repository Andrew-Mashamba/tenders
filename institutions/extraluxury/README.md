...
website:
  homepage: "https://extraluxury.co.tz"
  tender_url: "https://extraluxury.co.tz/about-us/tender"

scraping:
  enabled: false
  method: "http_get"
  strategy: "URL /about-us/tender exists but page shows only About Us content (Extra Luxury Coach bus company). No tender listing found (verified 2026-03-15). Disable until tender content is added."
  selectors:
...
notes: |
  ...
  Emails: info@extraluxury.co.tz, info@extraluxury.co.tz.
...
**Category:** Commercial
**Website:** https://extraluxury.co.tz
**Tender Page:** https://extraluxury.co.tz/about-us/tender
...
```json
{{
  "tender_id": "EXTRALUXURY-2026-001",
  "institution": "extraluxury",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://extraluxury.co.tz/about-us/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/EXTRALUXURY-2026-001/original/tender_document.pdf",
