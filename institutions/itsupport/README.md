...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "itsupport.co.tz"

website:
  homepage: "https://itsupport.co.tz/"
  tender_url: "https://itsupport.co.tz/"

contact:
  email: "webmaster@itsupport.co.tz"

scraping:
  enabled: true
  method: "http_get"
  strategy: |
    Website unreachable. https://itsupport.co.tz/ returns "Account Suspended" - hosting account
    has been suspended. Contact webmaster@itsupport.co.tz. Disabled until site is restored.
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Site suspended. No access to documents. Re-enable when itsupport.co.tz is restored.
...
notes: |
  Organization website at itsupport.co.tz. Tender keywords detected: rfp.
---

# Account Suspended

**Category:** Commercial / Private Sector
**Website:** https://itsupport.co.tz/
**Tender Page:** https://itsupport.co.tz/
**Keywords Found:** rfp
...
**Strategy:** Scrape https://itsupport.co.tz/ for tender/procurement notices.
**Method:** http_get
...
```json
{{
  "tender_id": "ITSUPPORT-2026-001",
  "institution": "itsupport",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ITSUPPORT/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://itsupport.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://itsupport.co.tz/storage/tender.pdf",
      "local_path": "./downloads/ITSUPPORT-2026-001/original/tender_document.pdf",
