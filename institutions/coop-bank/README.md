...
website:
  homepage: "https://coopbank.co.tz/"
  tender_url: "https://coopbank.co.tz/tenders/"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape /tenders/ page. Formed from merger of Kilimanjaro Cooperative Bank and Tandahimba Community Bank (2024)."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "coopbank.co.tz/*.pdf"
      - "coopbank.co.tz/wp-content/uploads/*.pdf"
    ...
    document_notes: |
      Formerly Kilimanjaro Cooperative Bank. Check for tender PDFs on the /tenders/ page.
...
notes: |
  Formerly Kilimanjaro Cooperative Bank (KCBL). Merged with Tandahimba Community Bank in 2024. Has dedicated tenders page.
---

# Coop Bank Tanzania

**Category:** Community Bank  
**Website:** https://coopbank.co.tz/  
**Tender Page:** https://coopbank.co.tz/tenders/  
