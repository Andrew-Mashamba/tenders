---
institution:
  name: "Smiles Medicstomatology"
  slug: "smilesmedicstomatology"
  category: "Commercial"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://smilesmedicstomatology.co.tz"
  tender_url: "https://smilesmedicstomatology.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Dental/medical equipment supplier catalog. No tender page. 'Procurement' in testimonials only. Disable until tender page exists."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender content. Product catalog only. Procurement mentioned in customer testimonials.
...
notes: |
  ...
  Emails: sales@smilesmedicstomatology.co.tz.
  Discovered by crawler on 2026-03-15.
---

# Smiles Medicstomatology

**Category:** Commercial
**Website:** https://smilesmedicstomatology.co.tz
**Tender Page:** https://smilesmedicstomatology.co.tz
...
```json
{{
  "tender_id": "SMILESMEDICSTOMATOLOGY-2026-001",
  "institution": "smilesmedicstomatology",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://smilesmedicstomatology.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/SMILESMEDICSTOMATOLOGY-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "sales@smilesmedicstomatology.co.tz",
    "phone": "",
    "address": ""
  }},
