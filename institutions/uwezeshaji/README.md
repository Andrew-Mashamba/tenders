---
institution:
  name: "Baraza la Taifa la Uwezeshaji Wananchi Kiuchumi (NEEC)"
  slug: "uwezeshaji"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "uwezeshaji.go.tz"

website:
  homepage: "https://www.uwezeshaji.go.tz/"
  tender_url: "https://www.uwezeshaji.go.tz/"

contact:
  email: "barua@uwezeshaji.go.tz"
  phone: "0 0 1916 200"
...
scraping:
  ...
  selectors:
    ...
    title: ".bold-600, .section-heading, div"
    date: ".item-date, .date-day, .date-month, .text-muted"
    document_link: 'a[href$=".pdf"], a[href*="/uploads/"], a[href*="/documents/"]'
    pagination: ".pagination a, a.next, .view-all" 
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "uwezeshaji.go.tz/uploads/*"
      - "uwezeshaji.go.tz/uploads/news/*"
      - "uwezeshaji.go.tz/uploads/gallery/*"
      - "uwezeshaji.go.tz/*.pdf"
    ...
    document_notes: |
      Documents at /uploads/news/, /uploads/gallery/. Mfumo wa Manunuzi (NeST) procurement system linked in footer. suppliers.uwezeshaji.go.tz for supplier registry. News/events structure; tender-specific page may need discovery.
...
**Category:** Government Agency
**Website:** https://www.uwezeshaji.go.tz/
**Tender Page:** https://www.uwezeshaji.go.tz/
**Keywords Found:** manunuzi
...
**Strategy:** Scrape https://www.uwezeshaji.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
```json
{{
  "tender_id": "UWEZESHAJI-2026-001",
  "institution": "uwezeshaji",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "UWEZESHAJI/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.uwezeshaji.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://www.uwezeshaji.go.tz/storage/tender.pdf",
      "local_path": "./downloads/UWEZESHAJI-2026-001/original/tender_document.pdf",
