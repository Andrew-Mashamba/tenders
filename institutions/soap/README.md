...
website:
  homepage: "https://soap.co.tz"
  tender_url: "https://soap.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Tarmal Industries soap/detergent manufacturer. Product catalog and projects. No tender page. Disable until tender page exists."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender content. Product catalog (Jet, Tarmol, Zap, Lit brands) and completed projects.
...
**Category:** Commercial
**Website:** https://soap.co.tz
**Tender Page:** https://soap.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://soap.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/SOAP-2026-001/original/tender_document.pdf",
