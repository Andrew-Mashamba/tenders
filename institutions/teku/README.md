...
website:
  homepage: "https://teku.ac.tz"
  tender_url: "https://teku.ac.tz"
...
scraping:
  ...
  selectors:
    ...
    title: "h4 a, a[href*='files/']"
    date: "small, .text-muted, on:"
    document_link: 'a[href*="files/"], a[href$=".pdf"], a[href*="downloadcentre"]'
  ...
  documents:
    ...
    document_notes: |
      Documents found under /files/. Check for additional paths during scraping.
...
**Category:** Academic
**Website:** https://teku.ac.tz
**Tender Page:** https://teku.ac.tz
...
{{
  ...
  "category": "Academic",
  "status": "active",
  "source_url": "https://teku.ac.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/TEKU-2026-001/original/tender_document.pdf",
