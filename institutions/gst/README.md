...
website:
  homepage: "https://gst.go.tz/"
  tender_url: "https://gst.go.tz/announcements"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://gst.go.tz/announcements for Matangazo (announcements). Each announcement links to detail page. Also check homepage for Fursa Zabuni dropdown. Follow announcement links to get full tender docs."
  selectors:
    container: "main, .content, .announcements, .list-group"
    tender_item: "a[href*='/announcements/'], .list-group-item, .announcement-item, li"
    title: "a, .title, h2, h3, h4"
    date: ".date, .published, time, small"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[href*="/storage/"], a[download]'
  ...
  documents:
    ...
    document_notes: |
      Announcements at /announcements. Tender-related items include Tangazo la Kutafuta Wakala, Mabadiliko ya Sheria. Documents may be on announcement detail pages. Check /publications for PDFs.
...
social_media:
  facebook: "GeologicalSurveyOfTanzania"
  linkedin: "geological-survey-tz-gst-aa685b287"
  instagram: "gst_tanzania"

notes: |
  Geological Survey of Tanzania | Taasisi ya Jiolojia na Utafiti wa Madini
---

# GST |     Mwanzo

**Category:** Government Agency
**Website:** https://gst.go.tz/
**Tender Page:** https://gst.go.tz/
...
**Strategy:** Scrape https://gst.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> dropdown'>Fursa Zabuni Ajira <a class='dropdown-item' href= 'https://gst.go.tz/publications/
...
```json
{{
  "tender_id": "GST-2026-001",
  "institution": "gst",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "GST/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://gst.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://gst.go.tz/storage/tender.pdf",
      "local_path": "./downloads/GST-2026-001/original/tender_document.pdf",
