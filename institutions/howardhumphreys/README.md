---
institution:
  name: "Howard Humphreys / AtkinsRéalis"
  slug: "howardhumphreys"
  category: "Commercial"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://howardhumphreys.co.tz"
  tender_url: "http://howardhumphreys.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Tender page unreachable (fetch timeout). Site may be down or blocking requests. Re-enable when accessible."
  selectors:
  ...
  documents:
    ...
    known_document_paths:
      - "/~/media/Files/A/atkinsrealis/download-centre/en/report/"

    url_patterns:
      - "howardhumphreys.co.tz/~/media/Files/A/atkinsrealis/download-centre/en/report/*.pdf"
    ...
    document_notes: |
      Tender page unreachable as of 2026-03-15. Known path from prior crawl: /~/media/Files/A/atkinsrealis/download-centre/en/report/. Re-verify when site is accessible.
...
**Category:** Commercial
**Website:** https://howardhumphreys.co.tz
**Tender Page:** http://howardhumphreys.co.tz
...
Known document paths: /~/media/Files/A/atkinsrealis/download-centre/en/report/
...
```json
{{
  "tender_id": "HOWARDHUMPHREYS-2026-001",
  "institution": "howardhumphreys",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "http://howardhumphreys.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/HOWARDHUMPHREYS-2026-001/original/tender_document.pdf",
