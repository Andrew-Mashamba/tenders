...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "bukobamc.go.tz"

website:
  homepage: "https://bukobamc.go.tz/"
  tender_url: "https://bukobamc.go.tz/tenders"

contact:
  email: "md@bukobamc.go.tz"
  phone: "025-07-01 --- "

scraping:
  enabled: true
  method: "http_get"
  strategy: "Site migrated to GWF CORE React SPA (2026-06). /tenders renders client-side; scrape JSON APIs instead: /api/announcements (local zabuni) and /api/from-tamisemi (TAMISEMI feed). Filter category=Zabuni. Documents at /minio/bukobamc.go.tz/attachments/ and /minio/tamisemi.go.tz/attachments/. Legacy /storage/app/uploads/public/ paths now return SPA shell."
  selectors:
    container: "#root"
  ...
  documents:
    ...
    known_document_paths:
      - "/minio/bukobamc.go.tz/attachments/"
      - "/minio/tamisemi.go.tz/attachments/"
    url_patterns:
      - "bukobamc.go.tz/minio/bukobamc.go.tz/attachments/*"
      - "bukobamc.go.tz/minio/tamisemi.go.tz/attachments/*"
    ...
    document_notes: |
      GWF CORE SPA as of 2026-06. Use REST APIs for tender data. Local docs at /minio/bukobamc.go.tz/attachments/; TAMISEMI syndicated docs at /minio/tamisemi.go.tz/attachments/. Legacy /storage/app/uploads/public/ paths no longer serve files.
...
# Home &#124; Bukoba Municipal Council

**Category:** Local Government Authority
**Website:** https://bukobamc.go.tz/
**Tender Page:** https://bukobamc.go.tz/procurement-and-supply-management
...
**Strategy:** Scrape https://bukobamc.go.tz/procurement-and-supply-management for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://bukobamc.go.tz/procurement-and-supply-management
- https://bukobamc.go.tz/tenders

### Document Links Found

- https://bukobamc.go.tz/storage/app/uploads/public/5b9/8be/97d/5b98be97de625706862676.pdf
...
- https://bukobamc.go.tz/storage/app/uploads/public/5b9/62a/caf/5b962acaf2f42320386236.pdf
- https://bukobamc.go.tz/storage/app/uploads/public/5a9/813/2c8/5a98132c85210825079871.pdf
- https://bukobamc.go.tz/storage/app/uploads/public/5b9/8b4/99c/5b98b499c5acc351575867.pdf
...
Known document paths: /storage/app/uploads/public/5a9/813/2c8/5a98132c85210825079871.pdf, /storage/app/uploads/public/5b9/8b4/99c/5b98b499c5acc351575867.pdf, /storage/app/uploads/public/68d/b93/b16/68db93b165c51601904779.pdf
...
```json
{{
  "tender_id": "BUKOBAMC-2026-001",
  "institution": "bukobamc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "BUKOBAMC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://bukobamc.go.tz/procurement-and-supply-management",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://bukobamc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/BUKOBAMC-2026-001/original/tender_document.pdf",
...
- **Signal Strength:** Strong (GWF API; local Ajira only on /api/announcements)
