...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "smartfinance.co.tz"

website:
  homepage: "https://smartfinance.co.tz/"
  tender_url: "https://smartfinance.co.tz/"

contact:
  email: "info@safco.co.tz"
  phone: "+255 747 762 244"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Microfinance software product site. No tender listings. 'Procurement' refers to software features, not RFPs. Disable until tender page exists."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender content. Site sells SmartFinance software for SACCOS/microfinance. Procurement mentioned in product features only.
...
social_media:
  instagram: "safco_academytz"

notes: |
  Organization website at smartfinance.co.tz. Tender keywords detected: bid, manunuzi, procurement, rfi.
---

# SmartFinance

**Category:** Microfinance / Financial Services
**Website:** https://smartfinance.co.tz/
**Tender Page:** https://smartfinance.co.tz/
**Keywords Found:** bid, manunuzi, procurement, rfi
...
**Strategy:** Scrape https://smartfinance.co.tz/ for tender/procurement notices.
**Method:** http_get
...
> Uwezo wa kufanya mipango ya manunuzi na uidhinishaji (Digital Procurement approval process) Automated procurement planning and approval processes. Uwezo wa kuidhinisha nyaraka za malipo kw
...
```json
{{
  "tender_id": "SMARTFINANCE-2026-001",
  "institution": "smartfinance",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "SMARTFINANCE/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://smartfinance.co.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://smartfinance.co.tz/storage/tender.pdf",
      "local_path": "./downloads/SMARTFINANCE-2026-001/original/tender_document.pdf",
