...
website:
  homepage: "https://postanasimusaccos.co.tz/"
  tender_url: "null"
...
scraping:
  ...
  documents:
    ...
    url_patterns:
      - "postanasimusaccos.co.tz/*.pdf"
      - "postanasimusaccos.co.tz/*.docx"
      - "postanasimusaccos.co.tz/*.xlsx"
...
notes: |
  No tender page found. Past tenders found on zabuni.co.tz.
---

# Posta na Simu SACCOS

**Category:** SACCO  
**Website:** https://postanasimusaccos.co.tz/  
**Tender Page:** null  
