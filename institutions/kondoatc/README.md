...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "kondoatc.go.tz"

website:
  homepage: "https://kondoatc.go.tz/"
  tender_url: "https://kondoatc.go.tz/tenders"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "As of June 2026 site migrated to GWF CORE React SPA. https://kondoatc.go.tz/tenders returns empty SPA shell. Legacy /storage/ PDF URLs no longer served. Requires JavaScript rendering. Previously: October CMS table-striped with title, Date Added, Expire Date, Pakua columns."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "kondoatc.go.tz/storage/app/uploads/public/*/*/*/*.pdf"
    ...
    document_notes: |
      Path pattern /storage/app/uploads/public/{3-char}/{3-char}/{3-char}/{hash}.pdf. Table may be empty; structure same as kondoadc/kinondonimc.
...
# Home &#124; Kondoa Town Council

**Category:** Local Government Authority
**Website:** https://kondoatc.go.tz/
**Tender Page:** https://kondoatc.go.tz/tenders
...
**Strategy:** Scrape https://kondoatc.go.tz/tenders for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
- https://kondoatc.go.tz/tenders

### Document Links Found

- https://kondoatc.go.tz/storage/app/uploads/public/671/f71/122/671f7112266ea403697255.pdf
- https://kondoatc.go.tz/storage/app/uploads/public/671/f6f/325/671f6f3258576284615590.pdf
- https://kondoatc.go.tz/storage/app/uploads/public/671/f6f/fb0/671f6ffb01f62497655586.pdf
- https://kondoatc.go.tz/storage/app/uploads/public/671/f70/9f9/671f709f91a4f311747326.pdf
- https://kondoatc.go.tz/storage/app/uploads/public/673/757/97a/67375797a438c199162451.pdf
...
Known document paths: /storage/app/uploads/public/671/f71/122/671f7112266ea403697255.pdf, /storage/app/uploads/public/671/f6f/325/671f6f3258576284615590.pdf, /storage/app/uploads/public/671/f6f/fb0/671f6ffb01f62497655586.pdf
...
```json
{{
  "tender_id": "KONDOATC-2026-001",
  "institution": "kondoatc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "KONDOATC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://kondoatc.go.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://kondoatc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/KONDOATC-2026-001/original/tender_document.pdf",
