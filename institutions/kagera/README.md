---
institution:
  name: "Kagera Regional Government"
  slug: "kagera"
  category: "Government"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://kagera.go.tz"
  tender_url: "https://kagera.go.tz/tenders"
...
scraping:
  ...
  selectors:
    ...
    pagination: "a.view-more, .pagination a"
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/storage/app/uploads/public/62f/f68/e35/"
      - "/storage/app/uploads/public/631/712/68a/"
      - "/storage/app/uploads/public/631/719/78c/"
      - "/storage/app/uploads/public/677/d11/b66/"
      - "/storage/app/uploads/public/677/d13/8a8/"

    url_patterns:
      - "kagera.go.tz/storage/app/uploads/public/*/*.pdf"
      - "kagera.go.tz/storage/app/uploads/public/*/*/*.pdf"
    ...
    document_notes: |
      Octolize CMS. Documents at /storage/app/uploads/public/{hash}/. Table columns: title, published
      date, closing date, Pakua (download) link. Sidebar lists news items. Tender table may be empty.
...
notes: |
  ...
  Emails: ras.kagera@tamisemi.go.tz.
  Discovered by crawler on 2026-03-15.
---

# Kagera Regional Government

**Category:** Government
**Website:** https://kagera.go.tz
**Tender Page:** https://kagera.go.tz/tenders
...
Known document paths: /storage/app/uploads/public/62f/f68/e35/, /storage/app/uploads/public/631/712/68a/, /storage/app/uploads/public/631/719/78c/, /storage/app/uploads/public/677/d11/b66/, /storage/app/uploads/public/677/d13/8a8/
...
{{
  ...
  "category": "Government",
  "status": "active",
  "source_url": "https://kagera.go.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KAGERA-2026-001/original/tender_document.pdf",
