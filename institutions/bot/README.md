...
website:
  homepage: "https://www.bot.go.tz/"
  tender_url: "https://www.bot.go.tz/CallsforTender"

contact:
  email: "botcommunications@bot.go.tz"
  alternate_emails:
    - "info@bot.go.tz"
  phone: "+255 22 2232541"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://www.bot.go.tz/CallsforTender. Tender content in .col-md-12.col-lg-12. When tenders exist, page uses DataTables (jquery.dataTables). Check for table.tenders or list-group. 'No open tenders' message in p when empty."
  selectors:
    container: ".col-md-12.col-lg-12[style*='min-height'], table.dataTable, .list-group"
    tender_item: "table.dataTable tbody tr, .list-group-item"
    title: "td:first-child, a, .list-group-item"
    date: ".date, td:nth-child(2), time"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[href$=".xlsx"], a[download]'
    pagination: ".dataTables_paginate a, .pagination a, a.next" 
  schedule: "daily"
  ...
  documents:
    ...
    known_document_paths:
      - "/Adverts/PressRelease/"
      - "/webdocs/"
      - "/Publications/NPS/"
      - "/Publications/Filter/"
    url_patterns:
      - "www.bot.go.tz/*.pdf"
      - "www.bot.go.tz/webdocs/*"
      - "www.bot.go.tz/Adverts/*"
      - "www.bot.go.tz/Publications/*"
      - "www.bot.go.tz/BOTAct2006.pdf"
    ...
    document_notes: |
      BOT stores documents in /Adverts/PressRelease/, /webdocs/, /Publications/NPS/. Tender page shows 'No open tenders' when empty. DataTables used when tenders exist. Follow document links from tender rows.
...
social_media:
  facebook: "BankOfTanzaniaOfficial"
  twitter: "BankOfTanzania"
  instagram: "bankoftanzania_"

notes: |
  Organization website at bot.go.tz. Tender keywords detected: tender, zabuni.
---
...
**Tender Page:** https://www.bot.go.tz/CallsforTender
...
- Phone: +255 22 2232541
- Phone: 02307051602090
- Phone: +255 26 2963189

## Scraping Instructions

**Strategy:** Scrape https://www.bot.go.tz/CallsforTender for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> nu-bg" style="width:auto;min-width:200px"> Zabuni <a href="/CareerOpportunities" class="list-group-item list-group-item-action drop

### Known Tender URLs

- https://www.bot.go.tz/CallsforTender

### Document Links Found

- https://www.bot.go.tz/Adverts/PressRelease/sw/2023070516020902.pdf
- https://www.bot.go.tz/webdocs/NPS/CLEARING TRANSACTIONS.xlsx
- https://www.bot.go.tz/webdocs/Other/PUBLIC HOLIDAYS 2025.pdf
- https://www.bot.go.tz/webdocs/NPS/CARD TRANSACTIONS.xlsx
- https://www.bot.go.tz/Publications/NPS/BankSortCodes.xlsx
- https://www.bot.go.tz/webdocs/MONEY REMITTANCES.xlsx
- https://www.bot.go.tz/BOTAct2006.pdf
- https://www.bot.go.tz/Publications/NPS/ListofMtos.pdf
- https://www.bot.go.tz/webdocs/NPS/MOBILE TRANSACTIONS.xlsx
- https://www.bot.go.tz/webdocs/NPS/INTERNET BANKING.xlsx
...
```json
{{
  "tender_id": "BOT-2026-001",
  "institution": "bot",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "BOT/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.bot.go.tz/CallsforTender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://www.bot.go.tz/storage/tender.pdf",
      "local_path": "./downloads/BOT-2026-001/original/tender_document.pdf",
...
- **Active Tenders:** 0 (page states "There are no open tenders currently")
