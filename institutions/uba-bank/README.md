---
institution:
  name: "United Bank for Africa (UBA) Tanzania"
  slug: "uba-bank"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. Nigerian parent bank."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
  ...
  documents:
    ...
    url_patterns:
      - "www.ubatanzania.co.tz/*.pdf"
      - "www.ubatanzania.co.tz/*.docx"
      - "www.ubatanzania.co.tz/*.xlsx"
...
notes: |
  No tender page found. Nigerian-owned, procurement may be centralized.
---

# United Bank for Africa (UBA) Tanzania

**Category:** Commercial Bank  
**Website:** https://www.ubatanzania.co.tz/  
**Tender Page:** null  
