---
institution:
  name: "MOA |     Wizara ya Kilimo - Mwanzo"
  slug: "kilimo"
...
scraping:
  ...
  documents:
    ...
    url_patterns:
      - "kilimo.go.tz/uploads/documents/*.pdf"
      - "kilimo.go.tz/*.pdf"
    ...
    document_notes: |
      Documents stored at /uploads/documents/ with naming pattern sw-{timestamp}-{filename}.pdf. Example: /uploads/documents/sw-1773408108-Mwenendo wa Bei za Mazao tarehe 09 - 13 Machi, 2026 (1).pdf. Check zabuni listing pages and dropdown (galleries/listing/videos) for document links.
...
social_media:
  facebook: "tzagriculture"
  twitter: "tzagriculture"
  instagram: "wizara_ya_kilimo"

notes: |
  WIZARA YA KILIMO |     Wizara ya Kilimo - Mwanzo
---

# MOA |     Wizara ya Kilimo - Mwanzo

**Category:** Government Agency
**Website:** https://kilimo.go.tz/
**Tender Page:** https://kilimo.go.tz/
**Keywords Found:** eoi, zabuni
...
**Strategy:** Scrape https://kilimo.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> zi Zabuni Habari Picha <a class='dropdown-item' href= 'https://kilimo.go.tz/galleries/listing/videos

### Document Links Found

- https://kilimo.go.tz/uploads/documents/sw-1773408108-Mwenendo wa Bei za Mazao tarehe 09 - 13 Machi, 2026 (1).pdf
...
```json
{{
  "tender_id": "KILIMO-2026-001",
  "institution": "kilimo",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "KILIMO/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://kilimo.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://kilimo.go.tz/storage/tender.pdf",
      "local_path": "./downloads/KILIMO-2026-001/original/tender_document.pdf",
