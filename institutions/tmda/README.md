---
institution:
  name: "Tanzania Medicines and Medical Devices Authority (TMDA)"
  slug: "tmda"
...
website:
  homepage: "https://www.tmda.go.tz/"
  tender_url: "https://www.tmda.go.tz/pages/general-procurement-notice-gpn"

contact:
  email: "medicaldevices@tmda.go.tz"
  alternate_emails:
    - "info@tmda.go.tz"
    - "medicines@tmda.go.tz"
    - "clinicaltrials@tmda.go.tz"
    - "enforcement@tmda.go.tz"
  phone: "+255 22 262961989 "

scraping:
  enabled: true
  method: "http_get"
  strategy: |
    Scrape https://www.tmda.go.tz/pages/general-procurement-notice-gpn. Tenders are in two Bootstrap tab panes:
    (1) "List of available tenders" (#v-pills-home) - active tenders table
    (2) "Annual Procurement Plan" (#v-pills-profile) - full procurement plan table.
    Parse table.table.table-bordered tbody tr (skip header row). Columns: NS, Procurement Category, Tender No, Description.
    Apply for tenders via TANEPS (taneps.go.tz). Documents may be in /uploads/.
  selectors:
    container: ".zazibona-container, .tab-content#v-pills-tabContent, section.main-content .content-border"
    tender_item: "table.table.table-bordered tbody tr"
    title: "td:nth-child(4)"
    date: null
    document_link: 'a[href$=".pdf"], a[href*="/uploads/"], a[href*="taneps"]'
    pagination: null
  schedule: "daily"
  ...
  documents:
    ...
    document_notes: |
      Documents in /uploads/ (e.g. uploads/1753100356-*.pdf). Tender applications go through TANEPS (taneps.go.tz/epps/home.do).
      Table has no dates; closing dates are on TANEPS. Extract Tender No from td:nth-child(3), Description from td:nth-child(4).
...
social_media:
  facebook: "tmda.tanzania.5"
  twitter: "tmda_tanzania"
  instagram: "tmda_tanzania"
...
**Tender Page:** https://www.tmda.go.tz/pages/general-procurement-notice-gpn
**Keywords Found:** procurement, rfi, tender, tenders

## Contact Information
- Email: medicaldevices@tmda.go.tz
- Email: info@tmda.go.tz
- Email: medicines@tmda.go.tz
- Email: clinicaltrials@tmda.go.tz
- Email: enforcement@tmda.go.tz
- Phone: +255 22 262961989 
- Phone: 043 0 0 1 
- Phone: 0800 110 084
- Phone: 053-1626790766
- Phone: 043 0 0 1-

## Scraping Instructions

**Strategy:** Scrape https://www.tmda.go.tz/pages/general-procurement-notice-gpn for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> class="list-inline-item sm-hide"> Tenders Training Opportuni

### Known Tender URLs

- https://www.tmda.go.tz/pages/general-procurement-notice-gpn
- https://www.tmda.go.tz/tenders

### Document Links Found

- https://www.tmda.go.tz/uploads/1753100356-lalamiko website (1).pdf
- https://www.tmda.go.tz/uploads/1753100427-complaints form eng web (1).pdf
...
```json
{{
  "tender_id": "TMDA-2026-001",
  "institution": "tmda",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TMDA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.tmda.go.tz/pages/general-procurement-notice-gpn",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://www.tmda.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TMDA-2026-001/original/tender_document.pdf",
