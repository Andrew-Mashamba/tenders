---
institution:
  name: "Mwanza Urban Water Supply and Sanitation Authority (MWAUWASA)"
  slug: "mwauwasa"
  category: "Water Utility"
  status: "active"
  country: "Tanzania"
  domain: "mwauwasa.go.tz"

website:
  homepage: "https://mwauwasa.go.tz/"
  tender_url: "https://mwauwasa.go.tz/tenders"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://mwauwasa.go.tz/tenders. Tenders listed as p.download with a[download] links. Title and deadline in link text. Documents at /uploads/tenders/."
  selectors:
    container: ".sub-main-content"
    tender_item: "p.download"
    title: "a"
    date: "a"
    document_link: 'a[href*="/uploads/tenders/"], a[download], a[href$=".pdf"]'
    pagination: "nav.nav-pagination ul.pagination a" 
  schedule: "daily"
  ...
  documents:
    ...
    url_patterns:
      - "mwauwasa.go.tz/uploads/tenders/*.pdf"
      - "mwauwasa.go.tz/uploads/tenders/*.doc"
      - "mwauwasa.go.tz/uploads/tenders/*.docx"
    ...
    document_notes: |
      Each tender is p.download with a single a[download] link. Example: en-1710229599-PQ-FOR MWANZA SEWER CONNECTION DOCUMENT.pdf. Deadline in link text (e.g. Deadline 2024-04-08).
...
**Category:** Water Utility
**Website:** https://mwauwasa.go.tz/
**Tender Page:** https://mwauwasa.go.tz/tenders
...
**Strategy:** Scrape https://mwauwasa.go.tz/tenders for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
```json
{{
  "tender_id": "MWAUWASA-2026-001",
  "institution": "mwauwasa",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MWAUWASA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://mwauwasa.go.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://mwauwasa.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MWAUWASA-2026-001/original/tender_document.pdf",
