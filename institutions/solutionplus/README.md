...
website:
  homepage: "https://solutionplus.co.tz"
  tender_url: "https://solutionplus.co.tz"

scraping:
  enabled: false
  method: "http_get"
  strategy: "Homepage has no tender/procurement content. Site is commercial (industrial equipment). No tender listings or document links found. Disable until dedicated tender page is discovered."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender documents found. Homepage is WordPress (Elementor) with product/services content only. No procurement section.
...
**Category:** Commercial
**Website:** https://solutionplus.co.tz
**Tender Page:** https://solutionplus.co.tz
...
```json
{{
  "tender_id": "SOLUTIONPLUS-2026-001",
  "institution": "solutionplus",
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://solutionplus.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/SOLUTIONPLUS-2026-001/original/tender_document.pdf",
