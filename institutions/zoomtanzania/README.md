---
institution:
  name: "Zoom Tanzania - The #1 Jobs and Careers Platform in Tanzania"
  slug: "zoomtanzania"
  category: "Commercial / Private Sector"
  status: "active"
  country: "Tanzania"
  domain: "zoomtanzania.co.tz"

website:
  homepage: "https://www.zoomtanzania.net/"
  tender_url: "https://www.zoomtanzania.net/"
...
scraping:
  enabled: false
  method: "http_get"
  strategy: "Zoom Tanzania is a JOBS and careers platform (5,632+ job vacancies), not a tender/procurement site. Content: job listings (civi-jobs, ff-item), companies directory, candidates. No tender notices. Disabled — wrong content type."
  selectors:
...
social_media:
  facebook: "zoomtanzania"
  twitter: "zoomintanzania"
  linkedin: "zoomtanzania"
  instagram: "zoomtanzania"

notes: |
  Zoom Tanzania is the leading jobs and careers website in Tanzania. Search and apply for the latest jobs across top industries. No tender/procurement content — jobs platform only. Disabled 2026-03-15.
---

# Zoom Tanzania - The #1 Jobs and Careers Platform in Tanzania

**Category:** Commercial / Private Sector
**Website:** https://www.zoomtanzania.net/
**Tender Page:** https://www.zoomtanzania.net/
...
**Strategy:** Scrape https://www.zoomtanzania.net/ for tender/procurement notices.
**Method:** http_get

Zoom Tanzania is the leading jobs and careers website in Tanzania. Search and apply for the latest jobs across top industries.

### Tender Content Preview

> ","Non-profit","Nursing","Officer","Oil Pipeline","Operations","Other","Painter","Pilot","Plumber","Procurement","Project Management","Public Relations","Radiology","Ranger","Real Estate","Reception","Reporter","Research","Safety","Sales","Scholarships","Scientist","Secretary","Security","Service","
...
```json
{{
  "tender_id": "ZOOMTANZANIA-2026-001",
  "institution": "zoomtanzania",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "ZOOMTANZANIA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://www.zoomtanzania.net/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://www.zoomtanzania.net/storage/tender.pdf",
      "local_path": "./downloads/ZOOMTANZANIA-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    ...
    "email": "tenders@zoomtanzania.co.tz",
    "phone": "039870559",
    "address": "..."
  }},
