...
website:
  homepage: "https://crb.go.tz/"
  tender_url: "https://crb.go.tz/"

contact:
  email: "crbhq@crbtz.org"
  alternate_emails:
    - "crbhq@crb.go.tz"
  phone: "025-04-23 06"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape homepage for Notice Board (zabuni, contractor notices). Notice Board section has links to /notice/ID pages. Follow each notice link to detail page for full content and documents. Carousel shows From The Press; Notice Board table has contractor lists, workshops, procurement regulations."
  selectors:
    container: ".contentPart, .homePage, .col-sm-8, table"
    tender_item: "table tr, a[href*='/notice/']"
    title: "a[href*='/notice/'], td a"
    date: ".date, time, td"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[href*="/notice/"]'
  ...
  documents:
    ...
    document_notes: |
      Notice Board links to /notice/ID (e.g. /notice/73, /notice/72). Follow notice detail pages for documents. Government site may have SSL certificate issues — use retry/backoff.
...
notes: |
  Organization website at crb.go.tz. Tender keywords detected: zabuni.
---
...
**Tender Page:** https://crb.go.tz/
**Keywords Found:** zabuni

## Contact Information
- Email: crbhq@crbtz.org
- Email: crbhq@crb.go.tz
- Phone: 025-04-23 06
- Phone: +255 26 2962404
- Phone: 025-08-13 06
- Phone: 00089642245040
- Phone: +255 26 2962403

## Scraping Instructions

**Strategy:** Scrape https://crb.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> shauri Serikali kupitia CRB ihakikishe kuwa inafanya uhakiki wa kina kutambua kampuni za wazawa ili zabuni za miradi zinazotolewa ziwanufaishe wazawa husika na si vinginevyo. Photo by:Admin, 202
...
```json
{{
  "tender_id": "CRB-2026-001",
  "institution": "crb",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "CRB/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://crb.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://crb.go.tz/storage/tender.pdf",
      "local_path": "./downloads/CRB-2026-001/original/tender_document.pdf",
