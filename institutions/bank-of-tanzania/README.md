---
institution:
  name: "Bank of Tanzania (BOT)"
  slug: "bank-of-tanzania"
...
scraping:
  ...
  selectors:
    ...
    title: "h2, h3, td, a, .title"
    date: ".date, td, .deadline"
  ...
  documents:
    ...
    document_notes: |
      Central bank. High-value formal tenders. Documents include TOR, specifications, bid forms.
...
notes: |
  Central bank of Tanzania. High-value tenders. Formal procurement with strict deadlines. Also publishes on TANePS.
---
