---
institution:
  name: "Flex Corporate Services Limited | AI-Powered Contact Center, Fléx ERP &amp; Payment Gateway"
  slug: "flex"
...
website:
  homepage: "https://flex.co.tz/"
  tender_url: "https://flex.co.tz/"
...
scraping:
  enabled: false
  method: "http_get"
  strategy: "Homepage promotes Fléx Contact Center and ERP products. No tender listings or procurement notices. Flex is a B2B software vendor, not a tender publisher."
  selectors:
...
**Category:** Commercial / Private Sector
**Website:** https://flex.co.tz/
**Tender Page:** https://flex.co.tz/
...
**Strategy:** Scrape https://flex.co.tz/ for tender/procurement notices.
**Method:** http_get
