...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://korogwedc.go.tz/tenders. OctCMS site with same structure as kongwadc - table/list under .home-page-title (Zabuni). Documents at /storage/app/uploads/public/{hash}/."
  selectors:
