...
institution:
  ...
  status: "active"
  country: "Tanzania"
  domain: "korogwedc.go.tz"

website:
  homepage: "https://korogwedc.go.tz/"
  tender_url: "https://korogwedc.go.tz/tenders"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "As of June 2026 site migrated to GWF CORE React SPA. https://korogwedc.go.tz/tenders returns empty SPA shell. Legacy /storage/ PDF URLs no longer served. Requires JavaScript rendering. Previously: OctCMS Zabuni table under .home-page-title."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "korogwedc.go.tz/storage/app/uploads/public/590/053/570/5900535705b34669237287.pdf"
      - "korogwedc.go.tz/storage/app/uploads/public/5ad/867/1ae/5ad8671ae942b908744671.pdf"
      - "korogwedc.go.tz/storage/app/uploads/public/590/052/2c3/5900522c3c809783400125.pdf"
      - "korogwedc.go.tz/storage/app/uploads/public/691/c6b/ba9/691c6bba9eea8801372200.pdf"
      - "korogwedc.go.tz/storage/app/uploads/public/590/052/9c4/5900529c4ee6c738871352.pdf"
    ...
    document_notes: |
      OctCMS. Documents at /storage/app/uploads/public/{hash}/{filename}.pdf. Follow tender detail pages for document links. Same platform as kongwadc.
...
# Home &#124; Korogwe District Council

**Category:** Local Government Authority
**Website:** https://korogwedc.go.tz/
**Tender Page:** https://korogwedc.go.tz/tenders
...
**Strategy:** Scrape https://korogwedc.go.tz/tenders for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> ome-page-title">Zabuni More Tender Name

### Known Tender URLs

- https://korogwedc.go.tz/tenders

### Document Links Found

- https://korogwedc.go.tz/storage/app/uploads/public/5ad/867/1ae/5ad8671ae942b908744671.pdf
- https://korogwedc.go.tz/storage/app/uploads/public/590/052/9c4/5900529c4ee6c738871352.pdf
- https://korogwedc.go.tz/storage/app/uploads/public/590/052/2c3/5900522c3c809783400125.pdf
- https://korogwedc.go.tz/storage/app/uploads/public/691/c6b/ba9/691c6bba9eea8801372200.pdf
- https://korogwedc.go.tz/storage/app/uploads/public/590/053/570/5900535705b34669237287.pdf
...
Known document paths: /storage/app/uploads/public/590/053/570/5900535705b34669237287.pdf, /storage/app/uploads/public/5ad/867/1ae/5ad8671ae942b908744671.pdf, /storage/app/uploads/public/590/052/2c3/5900522c3c809783400125.pdf
...
```json
{{
  "tender_id": "KOROGWEDC-2026-001",
  "institution": "korogwedc",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "KOROGWEDC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://korogwedc.go.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://korogwedc.go.tz/storage/tender.pdf",
      "local_path": "./downloads/KOROGWEDC-2026-001/original/tender_document.pdf",
