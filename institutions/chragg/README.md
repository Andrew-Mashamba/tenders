...
website:
  homepage: "https://chragg.go.tz/"
  tender_url: "https://chragg.go.tz/pages/procurement-management-unit"

contact:
  email: "info@chragg.go.tz"
  phone: "+255 738  279744"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape chragg.go.tz/pages/procurement-management-unit (Kitengo cha Ununuzi na Ugavi). Commission for Human Rights and Good Governance. Check procurement unit page and /publications, /documents for tender notices. Documents may be at /uploads/."
  selectors:
    container: ".container, .rich-text, .content, main"
    tender_item: "article, .publication-item, .document-item, li, tr"
    title: "h2, h3, h4, .title, a"
    date: ".date, .published, time"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href*="uploads/"]'
  ...
  documents:
    ...
    document_notes: |
      Commission site. Procurement unit at /pages/procurement-management-unit. Documents may be in /uploads/ or /publications/. Tender listing structure to be confirmed on first run.
...
**Category:** Government Agency
**Website:** https://chragg.go.tz/
**Tender Page:** https://chragg.go.tz/news/utumishi-wa-umma-unahitaji-uwajibikaji-na-bidiii-ya-kazi
...
**Strategy:** Scrape https://chragg.go.tz/news/utumishi-wa-umma-unahitaji-uwajibikaji-na-bidiii-ya-kazi for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> tengo cha Fedha na Uhasibu Kitengo cha Ununuzi na Ugavi Kitengo cha Ukaguzi wa Ndani <a class

### Known Tender URLs

- https://chragg.go.tz/news/utumishi-wa-umma-unahitaji-uwajibikaji-na-bidiii-ya-kazi
...
```json
{{
  "tender_id": "CHRAGG-2026-001",
  "institution": "chragg",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "CHRAGG/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://chragg.go.tz/news/utumishi-wa-umma-unahitaji-uwajibikaji-na-bidiii-ya-kazi",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://chragg.go.tz/storage/tender.pdf",
      "local_path": "./downloads/CHRAGG-2026-001/original/tender_document.pdf",
