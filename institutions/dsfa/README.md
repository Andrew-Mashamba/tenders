---
institution:
  name: "Mamlaka ya Kusimamia Uvuvi wa Bahari Kuu (DSFA) - Deep Sea Fishing Authority"
  slug: "dsfa"
...
website:
  homepage: "https://dsfa.go.tz/"
  tender_url: "https://dsfa.go.tz/announcements"

contact:
  email: "info@dsfa.go.tz"
  phone: "0 25 0 0 43"
...
scraping:
  ...
  selectors:
    ...
    title: "h4, h5, .text-bold, .hover-text-primary"
    date: ".small.text-faded, span"
  ...
  documents:
    ...
    document_notes: |
      DSFA = Deep Sea Fishing Authority. Matangazo (announcements) at /announcements - may be empty. Procurement unit: Kitengo cha Usimamizi wa Manunuzi. Documents at /uploads/. Use curl -k for SSL. Swahili content.
...
social_media:
  ...
  twitter: "DsfaFishing"
  instagram: "dsfa.authority"

notes: |
  Mamlaka ya Kusimamia Uvuvi wa Bahari Kuu |     Mamlaka ya Kusimamia Uvuvi wa Bahari Kuu - Mwanzo
---

# DSFA |     Mamlaka ya Kusimamia Uvuvi wa Bahari Kuu - Mwanzo

**Category:** Government Agency
**Website:** https://dsfa.go.tz/
**Tender Page:** https://dsfa.go.tz/
**Keywords Found:** manunuzi

## Contact Information
- Email: info@dsfa.go.tz
- Phone: 0 25 0 0 43
- Phone: 00089474071021
- Phone: 026
...
**Strategy:** Scrape https://dsfa.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
```json
{{
  "tender_id": "DSFA-2026-001",
  "institution": "dsfa",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "DSFA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://dsfa.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://dsfa.go.tz/storage/tender.pdf",
      "local_path": "./downloads/DSFA-2026-001/original/tender_document.pdf",
