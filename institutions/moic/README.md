---
institution:
  name: "Wizara ya Ujenzi Mawasiliano na Uchukuzi (WUMU)"
  slug: "moic"
...
scraping:
  ...
  selectors:
    ...
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[href*="attachments"], a[download]'
  ...
  documents:
    ...
    known_document_paths:
      - "/panel/web-resources/attachments/"

    url_patterns:
      - "moic.go.tz/panel/web-resources/attachments/*.pdf"
    ...
    document_notes: |
      Documents in /panel/web-resources/attachments/. Example: HOTUBA MAWASILIANO, ZAN_ICT_Policy. URLs may have percent-encoded spaces. Decode before download.
...
**Category:** Government Agency
**Website:** https://moic.go.tz/
**Tender Page:** https://moic.go.tz/zabuni.html
...
- Phone: 05-06-2023 07
- Phone: 03-2022 16
- Phone: +255 24 294 1139
- Phone: +255 24 294 1140

## Scraping Instructions

**Strategy:** Scrape https://moic.go.tz/zabuni.html for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> ZABUNI <a href="#" onclick="windo

### Known Tender URLs

- https://moic.go.tz/zabuni.html

### Document Links Found

- https://moic.go.tz/panel/web-resources/attachments/HOTUBA%20MAWASILIANO%20%202023-2024%20PRESS%20KITABU.pdf
- https://moic.go.tz/panel/web-resources/attachments/ZAN_ICT_Policy_%20JUNE_2013.pdf
...
```json
{{
  "tender_id": "MOIC-2026-001",
  "institution": "moic",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MOIC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://moic.go.tz/zabuni.html",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://moic.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MOIC-2026-001/original/tender_document.pdf",
