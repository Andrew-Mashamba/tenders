---
institution:
  name: "Mwanza Region (Mkoa wa Mwanza)"
  slug: "mwanza"
...
website:
  homepage: "https://mwanza.go.tz/"
  tender_url: "https://mwanza.go.tz/tenders"

contact:
  email: "ras@mwanza.go.tz"
  phone: "023-07-13 --- "

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape https://mwanza.go.tz/tenders for zabuni. Parse table.table-striped: each tr = tender; td[1]=Jina la Zabuni, td[2]=Date Added, td[3]=Expire Date, td[4]=doc link."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "mwanza.go.tz/storage/app/uploads/public/*.pdf"
      - "mwanza.go.tz/storage/app/uploads/public/*.doc"
      - "mwanza.go.tz/storage/app/uploads/public/*.docx"
    ...
    document_notes: |
      Documents in table 4th column. Path: /storage/app/uploads/public/{hash}.pdf. Same structure as mwangadc/mwanzacc (October CMS).
...
**Category:** Government Agency
**Website:** https://mwanza.go.tz/
**Tender Page:** https://mwanza.go.tz/tenders
...
**Strategy:** Scrape https://mwanza.go.tz/tenders for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> ="home-page-title">Zabuni soma zaidi Jina la Zabuni

### Known Tender URLs

- https://mwanza.go.tz/tenders
- https://mwanza.go.tz/procurement-and-supply

### Document Links Found

- http://www.mwanza.go.tz/storage/app/uploads/public/58a/43c/3a6/58a43c3a6ab2f552832025.pdf
- http://www.mwanza.go.tz/storage/app/uploads/public/58a/43c/dbd/58a43cdbd60d5670808049.pdf
- https://mwanza.go.tz/storage/app/uploads/public/676/3bd/61b/6763bd61be628005087875.pdf
- https://mwanza.go.tz/storage/app/uploads/public/5aa/a6d/663/5aaa6d663a58c292124448.pdf
- https://mwanza.go.tz/storage/app/uploads/public/5aa/a6e/f5d/5aaa6ef5d6c7a792121879.pdf
- https://mwanza.go.tz/storage/app/uploads/public/676/3be/045/6763be0451f20126682986.pdf
- https://mwanza.go.tz/storage/app/uploads/public/5aa/a70/04d/5aaa7004db1ba006167965.pdf
...
Known document paths: /storage/app/uploads/public/58a/43c/dbd/58a43cdbd60d5670808049.pdf, /storage/app/uploads/public/5aa/a70/04d/5aaa7004db1ba006167965.pdf, /storage/app/uploads/public/676/3be/045/6763be0451f20126682986.pdf
...
```json
{{
  "tender_id": "MWANZA-2026-001",
  "institution": "mwanza",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MWANZA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://mwanza.go.tz/tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://mwanza.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MWANZA-2026-001/original/tender_document.pdf",
