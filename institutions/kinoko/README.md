---
institution:
  name: "KINOKO GENERAL ENTERPRISES"
  slug: "kinoko"
  category: "Commercial"
  status: "active"
  country: "Tanzania"
...
website:
  homepage: "https://kinoko.co.tz"
  tender_url: "https://kinoko.co.tz"

scraping:
  enabled: true
  method: "http_get"
  strategy: "WordPress/Elementor site. Homepage only — no dedicated tender page. Scrape main content and .elementor-widget-wrap for any procurement/tender announcements. 'Latest News' shows 'No posts found'. Check /contact/ for procurement inquiries. Documents would be in /wp-content/uploads/ if posted."
  selectors:
    container: ".elementor-section-wrap, main, .elementor-widget-wrap, .entry-content"
    tender_item: ".elementor-element, article, .elementor-widget-text-editor"
    title: "h2, h3, h4, .section-heading h2, .elementor-heading-title"
    date: ".date, .elementor-counter-title, time"
  ...
  documents:
    ...
    known_document_paths:
      - "/wp-content/uploads/"
    url_patterns:
      - "kinoko.co.tz/wp-content/uploads/*.pdf"
    document_notes: |
      No dedicated tender page found. Homepage is company info; 'Supplies and Procurement' mentioned in Executive Functions. Documents would use WordPress /wp-content/uploads/ if tenders are posted. Re-check if tender section is added.
...
# KINOKO GENERAL ENTERPRISES

**Category:** Commercial
**Website:** https://kinoko.co.tz
**Tender Page:** https://kinoko.co.tz
...
{{
  ...
  "category": "Commercial",
  "status": "active",
  "source_url": "https://kinoko.co.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/KINOKO-2026-001/original/tender_document.pdf",
