---
institution:
  name: "ASA Microfinance Tanzania"
  slug: "asa-microfinance"
  category: "Microfinance Institution"
  status: "active"
  country: "Tanzania"

website:
  homepage: "https://tanzania.asa-international.com/"
  tender_url: "null"

scraping:
  enabled: true
  method: "http_get"
  strategy: "No dedicated tender page. Part of ASA International (global)."
  selectors:
    container: "body"
    tender_list: "unknown"
  schedule: "weekly"
  ...
  documents:
    ...
    url_patterns:
      - "tanzania.asa-international.com/*.pdf"
      - "tanzania.asa-international.com/*.docx"
      - "tanzania.asa-international.com/*.xlsx"
...
notes: |
  No tender page found. Has Procurement & Logistics dept but no public portal. Part of ASA International group.
---

# ASA Microfinance Tanzania

**Category:** Microfinance Institution  
**Website:** https://tanzania.asa-international.com/  
**Tender Page:** null  
