---
institution:
  name: "Wizara ya Michezo (Ministry of Sports)"
  slug: "michezo"
  category: "Government Agency"
  status: "active"
  country: "Tanzania"
  domain: "michezo.go.tz"

website:
  homepage: "https://michezo.go.tz/"
  tender_url: "https://michezo.go.tz/"

contact:
  email: "km@michezo.go.tz"
  phone: "+255 26 2322 129
 "

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape homepage and procurement/tender sections. Documents at /Uploads/documents/ with sw-{timestamp}-{filename}.pdf pattern. Site may be slow—use rate limiting. Look for dropdown menu items (Ununuzi na Ugavi, Ukaguzi) for procurement links."
  selectors:
  ...
  documents:
    ...
    url_patterns:
      - "michezo.go.tz/Uploads/documents/*"
      - "michezo.go.tz/uploads/documents/*"
      - "michezo.go.tz/*.pdf"
    ...
    document_notes: |
      Documents at /Uploads/documents/ (or /uploads/documents/) with pattern sw-{unix_timestamp}-{filename}.pdf. URLs may use percent-encoding. Site fetch may timeout—retry with longer timeout. Both Uploads (capital U) and uploads exist.
...
**Category:** Government Agency
**Website:** https://michezo.go.tz/
**Tender Page:** https://michezo.go.tz/
...
> dha na Uhasibu Ununuzi na Ugavi Ukaguzi wa Ndani <a class='dropdown-item' href= '

### Document Links Found

- https://michezo.go.tz/Uploads/documents/sw-1744784761-sw1715083638-CamScanner 05-06-2024 18.40.pdf
- https://michezo.go.tz/Uploads/documents/sw-1744784586-sw1715083638-CamScanner 05-06-2024 18.40.pdf
- https://michezo.go.tz/Uploads/documents/sw-1744787538-sw1623309837-HOTUBA - HABARI MBEYA.pdf
- https://michezo.go.tz/Uploads/documents/sw-1770363346-FOMU YA MAOMBI YA MWANDAJI WA MAUDHUI 2.pdf
- https://michezo.go.tz/Uploads/documents/sw-1744787599-sw1623309837-HOTUBA - HABARI MBEYA.pdf
- https://michezo.go.tz/Uploads/documents/sw-1744784415-sw1623309837-HOTUBA - HABARI MBEYA.pdf
- https://michezo.go.tz/Uploads/documents/sw-1770399996-FOMU YA MAOMBI YA MWANDAJI WA MAUDHUI 2.pdf
- https://michezo.go.tz/Uploads/documents/sw-1744784350-sw1623309837-HOTUBA - HABARI MBEYA.pdf
- https://www.michezo.go.tz/uploads/documents/sw-1770363346-FOMU%20YA%20MAOMBI%20YA%20MWANDAJI%20WA%20MAUDHUI%202.pdf
...
Known document paths: /uploads/documents/sw-1770363346-FOMU%20YA%20MAOMBI%20YA%20MWANDAJI%20WA%20MAUDHUI%202.pdf
...
```json
{{
  "tender_id": "MICHEZO-2026-001",
  "institution": "michezo",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MICHEZO/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://michezo.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://michezo.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MICHEZO-2026-001/original/tender_document.pdf",
