---
institution:
  name: "Ministry of Minerals - Republic of Tanzania"
  slug: "madini"
...
website:
  homepage: "https://madini.go.tz/"
  tender_url: "https://madini.go.tz/otherpage/?p=tenders"
...
scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape /otherpage/?p=tenders. Tenders in .list-mom-div. Each item in .video-home-position. Follow /page/{uuid} links for detail pages and documents."
  selectors:
    container: ".list-mom-div, .col-md-8.bg-light"
    tender_item: ".col-md-6 .video-home-position, .m-1.bg-white.p-2"
    title: ".habari-mom-list"
    date: ".habari-mom-date"
    document_link: 'a[href$=".pdf"], a[href$=".doc"], a[href$=".docx"], a[href^="/page/"]'
    pagination: ""
  schedule: "daily"
  ...
  documents:
    ...
    document_notes: |
      Tenders listed with title, date, and /page/{uuid} view link. Detail pages may have document attachments. Policy/act PDFs in /media/.
...
social_media:
  facebook: "wizara.y.madini"
  twitter: "madinitanzania"
  instagram: "wizara_ya_madini_tanzania"

notes: |
  Organization website at madini.go.tz. Tender keywords detected: bid, tender, tenders.
---

# Ministry of Minerals - Republic of Tanzania

**Category:** Government Agency
**Website:** https://madini.go.tz/
**Tender Page:** https://madini.go.tz/otherpage/?p=tenders
...
**Strategy:** Scrape https://madini.go.tz/otherpage/?p=tenders for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> age/?p=vacancy">Vacancy Tenders Training

### Known Tender URLs

- https://madini.go.tz/otherpage/?p=tenders

### Document Links Found

- https://madini.go.tz/media/Mineral_Policy_of_Tanzania_2009_sw.pdf
- https://madini.go.tz/media/The-Mining-Act-1998.pdf
- https://madini.go.tz/media/GN_NO.937_OF_2020_THE_MINING_MINERAL_RIGHTSAMENDMENT_REGULATIONS_2020.pdf
- https://madini.go.tz/media/The-Mining-Act-2010.pdf
- https://madini.go.tz/media/Miscellaneous-amendment-no.-7-of-2017-clean-copy-final-Hansard-CHAPA.pdf
- https://madini.go.tz/media/Explosives_Act_1963_ac5S0O4.pdf
- https://madini.go.tz/media/Explosives_regulations-1964.pdf
- https://madini.go.tz/media/MINING-LOCAL-CONTENT-REGULATIONS-2018.pdf
- https://madini.go.tz/media/Explosives_Act_1963.pdf
- https://madini.go.tz/media/The_Mining_Act_17-1979_sw.pdf
...
Known document paths: /media/Explosives_Act_1963_ac5S0O4.pdf, /media/GN_NO.937_OF_2020_THE_MINING_MINERAL_RIGHTSAMENDMENT_REGULATIONS_2020.pdf, /media/The-Mining-Act-1998.pdf
...
```json
{{
  "tender_id": "MADINI-2026-001",
  "institution": "madini",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "MADINI/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://madini.go.tz/otherpage/?p=tenders",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://madini.go.tz/storage/tender.pdf",
      "local_path": "./downloads/MADINI-2026-001/original/tender_document.pdf",
