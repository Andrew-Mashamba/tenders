---
institution:
  name: "ZPPDA (Zanzibar Procurement)"
  slug: "zppda"
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Zanzibar procurement portal. Download tender documents for all Zanzibar entities.
...
**Category:** Tender Aggregator  
**Website:** http://www.tenders.zppda.go.tz/  
**Tender Page:** http://www.tenders.zppda.go.tz/  
