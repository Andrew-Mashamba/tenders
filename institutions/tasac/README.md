---
institution:
  name: "TASAC - Tanzania Shipping Agencies Corporation"
  slug: "tasac"
...
website:
  homepage: "https://tasac.go.tz/"
  tender_url: "https://tasac.go.tz/publications/tender"

contact:
  email: "dg@tasac.go.tz"
  alternate_emails:
    - "info@tasac.go.tz"
  phone: "0 25 0 0 43"
...
scraping:
  enabled: false
  method: "http_get"
  strategy: "TASAC (maritime agency). Dedicated tender URL /publications/tender. Page unreachable during analysis (timeout). Strong tender signal. Re-verify structure when reachable. Contact: dg@tasac.go.tz."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      Tender page /publications/tender unreachable during analysis. Document paths to be discovered on first successful scrape. Keywords: bid, procurement, tender, zabuni.
...
notes: |
  Shirika la Uwakala wa Meli Tanzania (TASAC) limeanzishwa kwa mujibu wa Sheria ya Uwakala wa Meli Tanzania Sura ya 415 ili kusimamia na kudhibiti sekta ya usafiri wa majini Tanzania Bara. |   Shirika la Uwakala wa Meli Tanzania - Mwanzo
---

# TASAC |   Shirika la Uwakala wa Meli Tanzania - Mwanzo

**Category:** Government Agency
**Website:** https://tasac.go.tz/
**Tender Page:** https://tasac.go.tz/publications/tender
**Keywords Found:** bid, procurement, tender, zabuni

## Contact Information
- Email: dg@tasac.go.tz
- Email: info@tasac.go.tz
- Phone: 0 25 0 0 43
- Phone: +255 22 2127313
- Phone: +255 22 2127314
- Phone: +255 22 2127313 
- Phone: 0800 110 107

## Scraping Instructions

**Strategy:** Scrape https://tasac.go.tz/publications/tender for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> nit'>Kitengo cha Ukaguzi wa Ndani Kitengo cha Ununuzi na Ugavi Kitengo cha Tehama na T

### Known Tender URLs

- https://tasac.go.tz/publications/tender
...
```json
{{
  "tender_id": "TASAC-2026-001",
  "institution": "tasac",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "TASAC/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://tasac.go.tz/publications/tender",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://tasac.go.tz/storage/tender.pdf",
      "local_path": "./downloads/TASAC-2026-001/original/tender_document.pdf",
