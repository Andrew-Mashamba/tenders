...
scraping:
  enabled: false
  method: "http_get"
  strategy: "Homepage is marketing/agribusiness content only. No tender listing or procurement page found. Check /tenders or /procurement if added later."
  selectors:
  ...
  documents:
    ...
    document_notes: |
      No tender page found. agricom.co.tz homepage has no tender/procurement listing structure. Disabled until tender page exists.
