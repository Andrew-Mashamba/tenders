---
institution:
  name: "Wakala wa Taifa wa Utafiti wa Nyumba Bora na Vifaa vya Ujenzi"
  slug: "nhbra"
...
website:
  homepage: "https://nhbra.go.tz/"
  tender_url: "https://nhbra.go.tz/tenders"

contact:
  email: "dg@nhbra.go.tz"
  alternate_emails:
...
scraping:
  ...
  documents:
    ...
    document_notes: |
      Tender page at /tenders may show 'No valid tender' when empty. Documents at /uploads/news/, /uploads/events/. Check publications and tender detail pages for PDFs.
...
**Category:** Government Agency
**Website:** https://nhbra.go.tz/
**Tender Page:** https://nhbra.go.tz/
**Keywords Found:** bid, procurement, tender, tenders

## Contact Information
- Email: dg@nhbra.go.tz
- Email: dawatilamsaada@nhbra.go.tz
- Phone: 00 1538729337
- Phone: 019
...
**Strategy:** Scrape https://nhbra.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> down left'> Tenda General Procurement Not
...
```json
{{
  "tender_id": "NHBRA-2026-001",
  "institution": "nhbra",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "NHBRA/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://nhbra.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://nhbra.go.tz/storage/tender.pdf",
      "local_path": "./downloads/NHBRA-2026-001/original/tender_document.pdf",
