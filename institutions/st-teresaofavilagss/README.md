---
institution:
  name: "St. Teresa of Avila Girls Secondary School"
  slug: "st-teresaofavilagss"
  category: "Academic"
  status: "active"
  country: "Tanzania"
  domain: "st-teresaofavilagss.ac.tz"

website:
  homepage: "https://st-teresaofavilagss.ac.tz"
  tender_url: "https://st-teresaofavilagss.ac.tz"

scraping:
  enabled: true
  method: "http_get"
  strategy: "Scrape st-teresaofavilagss.ac.tz. Bootstrap/AdminLTE site. Main content in .row, .card, .card-body. No dedicated tender listing - school site with NECTA results, Admission (Application.php), Library. Check Application.php and matokeo.php for forms/documents. Documents may be in image/, images/ or linked from Admission page."
  selectors:
    container: "#container, .row, .card .card-body"
    tender_item: ".col-xl-3 .card, .col-xl-4 .card, .col-xl-9 .card"
    title: "h1, h2, .text_academic, .text-xs.font-weight-bold"
  ...
  documents:
    ...
    document_notes: |
      School site. Check Application.php (Admission) for enrollment forms. NECTA results at matokeo.php, results.php. No formal tender listing; documents may appear in card bodies or modal content.
...
notes: |
  Category: Academic. Catholic girls secondary school in Mwanga, Kilimanjaro. No formal tender listing; site has NECTA results, Admission forms, Library.
---

# St. Teresa of Avila Girls Secondary School

**Category:** Academic
**Website:** https://st-teresaofavilagss.ac.tz
**Tender Page:** https://st-teresaofavilagss.ac.tz
...
Keywords found on site: NECTA, admission, matokeo
...
```json
{{
  "tender_id": "ST-TERESAOFAVILAGSS-2026-001",
  "institution": "st-teresaofavilagss",
  ...
  "category": "Academic",
  "status": "active",
  "source_url": "https://st-teresaofavilagss.ac.tz",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "",
      "local_path": "./downloads/ST-TERESAOFAVILAGSS-2026-001/original/tender_document.pdf",
  ...
  "contact": {{
    "name": "School Manager",
    "email": "st.teresaofavilagss@gmail.com",
    "phone": "+255 754 324 118",
    "address": "P.O. Box 26, MWANGA, TANZANIA"
  }},
