---
institution:
  name: "Agricultural Inputs Trust Fund (AGITF)"
  slug: "agitf"
...
scraping:
  ...
  selectors:
    ...
    title: "a[href$='.pdf'], h4, h5, h6"
    date: ".date, time"
    document_link: 'a[href*="/uploads/documents/"], a[href$=".pdf"]'
  ...
  documents:
    ...
    known_document_paths:
      - "/uploads/documents/"
    url_patterns:
      - "agitf.go.tz/uploads/documents/sw-*.pdf"
      - "agitf.go.tz/announcements/*"
      - "agitf.go.tz/news/*"
    ...
    document_notes: |
      Documents at /uploads/documents/ with filename pattern sw-{unix_timestamp}-{Document Name}.pdf. Includes loan forms, CAG reports, Strategic Plan, Act. Matangazo (announcements) and Habari (news) may contain zabuni/tender notices.
...
notes: |
  Agricultural Inputs Trust Fund | Mfuko wa Pembejeo
---

# AGITF | Mfuko wa Udhamini wa Pembejeo za Kilimo - Mwanzo

**Category:** Government Agency
**Website:** https://agitf.go.tz/
**Tender Page:** https://agitf.go.tz/
**Keywords Found:** zabuni

## Contact Information
- Email: info@agitf.go.tz
- Phone: +255 26 2354166
- Phone: 00094752811211
- Phone: 0844229094
- Phone: +255 262350268
...
**Strategy:** Scrape https://agitf.go.tz/ for government tender notices. Government sites often post zabuni/manunuzi.
**Method:** http_get
...
> video Zabuni <a class='nav-link' href='https://emrejesho.gov.go.tz/tenganisha_aina_za_walalamikaji?KhCZXZnwzb81Zf7aCRBNFbWejfw6LnCIhmdFlbeHJTItgUPbnHGreXfy6VTYJ3iC&to_this_inst
...
- https://agitf.go.tz/uploads/documents/sw-1733212460-Reviewed Strategic Plan-September 2023.pdf
- https://agitf.go.tz/uploads/documents/sw-1750065629-CAG REPORT FOR THE YEAR 2023-24.pdf
- https://agitf.go.tz/uploads/documents/sw-1733124570-The Agricultural Inputs Trust Fund Act, 1994 (1) (1).pdf
...
```json
{{
  "tender_id": "AGITF-2026-001",
  "institution": "agitf",
  "title": "Example Tender Title",
  "description": "Full description of the tender...",
  "reference_number": "AGITF/T/2026/001",
  "published_date": "2026-03-01",
  "closing_date": "2026-04-15",
  "closing_time": "14:00 EAT",
  "category": "General",
  "status": "active",
  "source_url": "https://agitf.go.tz/",
  "documents": [
    {{
      "filename": "tender_document.pdf",
      "original_url": "https://agitf.go.tz/storage/tender.pdf",
      "local_path": "./downloads/AGITF-2026-001/original/tender_document.pdf",
