#!/usr/bin/env python3
"""Scrape batch 46: hellotz through hmattorneys (25 institutions). Run ID: run_20260315_060430_batch46."""
...
RUN_ID = sys.argv[1] if len(sys.argv) > 1 else "run_20260315_060430_batch46"

# slug, tender_url, institution_name (from READMEs)
INSTITUTIONS = [
    ("hellotz", "https://hellotz.co.tz/", "Hellotz"),
    ("heritagefinancing", "https://heritagefinancing.co.tz/", "Heritage Financing Company Ltd"),
    ("heritageinsurance", "https://heritageinsurance.co.tz/", "Heritage Insurance Company Tanzania"),
    ("hertufarms", "https://hertufarms.co.tz/", "Hertu Mushrooms"),
    ("heslb", "https://www.heslb.go.tz/", "HESLB - Higher Education Students' Loans Board"),
    ("hesu", "https://hesu.co.tz/", "Hesu - Integrated Logistics System"),
    ("hexad", "https://hexad.co.tz/", "Hexad - Gold exploration Tanzania"),
    ("hexagon", "https://hexagon.co.tz/", "Hexagon - MEP Engineering"),
    ("hibas", "https://hibas.co.tz/", "Hibas Tanzania"),
    ("hibiscus", "https://hibiscus.co.tz/", "Hibiscus Tours & Safari"),
    ("highmountschools", "https://www.highmountschools.sc.tz/", "High Mount Schools"),
    ("hihs", "https://hihs.ac.tz/", "HIHS - Haydom Institute"),
    ("hillcrestauditors", "https://hillcrestauditors.co.tz/", "Hill Crest Auditors"),
    ("hillsidehotel", "https://www.hillsidehotel.co.tz/", "Hillside Hotel"),
    ("hillviewhotel", "https://hillviewhotel.co.tz/", "Hill View Hotel"),
    ("hilti", "https://www.hilti.co.tz/forms/quotation", "Hilti Tanzania"),
    ("hiltonattorneys", "https://hiltonlawgroup.co.tz/", "Hilton Law Group"),
    ("himd", "https://himd.or.tz/", "HIMD - Promoting Integral Health"),
    ("himizasocialjustice", "https://himizasocialjustice.or.tz/", "Himiza Social Justice"),
    ("himso", "https://himso.or.tz/", "HIMSO - Health & Insurance Management"),
    ("hitholidays", "https://hitholidays.co.tz/", "Hit Holidays Travel & Tours"),
    ("hkmu", "https://web.ku.ac.tz/component/content/article/request-for-proposals-rfp-for-debt-collection-services?catid=9&Itemid=101", "Kairuki University (KU)"),
    ("hlbtanzania", "https://www.hlbtanzania.co.tz/", "HLB Tanzania"),
    ("hlpc", "https://hlpc.go.tz/", "Health Laboratory Practitioners Council"),
    ("hmattorneys", "https://www.hmattorneys.co.tz/", "H&M Attorneys"),
]
...
def process_institution(slug: str, tender_url: str, name: str) -> dict:
    ...
    if tenders_found:
        ...
        if "debt collection" in html.lower() and "hkmu" in slug:
            title = "Request for Proposals (RFP) for Debt Collection Services"
        elif "himso" in slug and "learning hub" in html.lower():
            title = "TENDER ANNOUNCEMENT: Construction of HIMSO Learning Hub"
        ...
        tender_json = {
            ...
            "published_date": "",
            "closing_date": "2025-10-15" if "hkmu" in slug else "",
