#!/usr/bin/env python3
"""Scrape 25 institutions for active tenders. Run ID: run_20260315_060430_batch94"""
import json
import re
import subprocess
import sys
...
RUN_ID = "run_20260315_060430_batch94"

INSTITUTIONS = [
    ("prodesign", "Prodesign", "https://prodesign.co.tz/"),
    ("profininsurance", "ProFin Group", "https://theprofingroup.com/"),
    ("progressgroup", "Progress Group Limited", "https://www.progressgroup.co.tz/"),
    ("projektinspire", "Projektinspire", "https://projektinspire.co.tz/"),
    ("properconsult", "Proper Consult", "https://properconsult.co.tz/"),
    ("prostero", "Postero Investment", "https://prostero.co.tz/"),
    ("protech", "PROLINE TECHNOLOGY HUB", "https://protech.co.tz/"),
    ("prudence", "Prudence Zoe Glorious", "https://www.prudence.co.tz/"),
    ("ps", "Persistent Strategies", "https://ps.co.tz/"),
    ("psc", "PSC Tanzania", "https://psc.go.tz/"),
    ("psptb", "PSPTB", "https://psptb.go.tz/news/psptb-is-urge-to-take-action-against-those-who-violate-the-law-in-the-procurement-sector"),
    ("psrb", "PSRB", "https://psrb.go.tz/"),
    ("psssf", "PSSSF", "https://psssf.go.tz/tender/current"),
    ("pst", "THE PST", "https://www.pst.or.tz/"),
    ("ptf", "Presidential Trust Fund", "https://www.ptf.or.tz/"),
    ("ptl", "PTL", "https://ptl.co.tz/"),
    ("puguhills", "Pugu Hills Eco Cultural Tourism", "https://puguhills.co.tz/"),
    ("punchline", "Punchline Africa", "https://punchline.or.tz/"),
    ("pureafricansafaris", "Pure African Safaris", "https://pureafricansafaris.co.tz/"),
    ("purityattorneys", "Purity Attorneys", "https://purityattorneys.co.tz/"),
    ("pwanimovers", "Pwani Movers", "https://pwanimovers.co.tz/"),
    ("qelatechnologies", "Qela Technologies", "https://qelatechnologies.co.tz/"),
    ("qif", "Q International Furniture", "https://qualityfurnituretz.com/"),
    ("qualityfurniture", "Quality Furniture", "https://qualityfurnituretz.com/"),
    ("qualitywater", "Quality Water & Sanitation", "https://qualitywater.co.tz/"),
]
...
def process_institution(slug: str, name: str, url: str) -> tuple[str, int, int]:
    ...
    if has_tenders:
        ...
        if docs:
            ...
            now = datetime.now(timezone.utc).isoformat().replace("+00:00", "Z")
            document_records = []
            for doc_url, filename in docs[:10]:
