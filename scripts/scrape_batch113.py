...
Run ID: run_20260313_205329_batch113
"""
import json
import re
import subprocess
...
RUN_ID = "run_20260313_205329_batch113"

INSTITUTIONS = [
    "tanea", "tanelec", "taneps", "tanescosaccos", "tanga",
    "tangacc", "tanganyikadc", "tanganyikaschools", "tangatimes", "tanhydro",
    "tanicacafe", "tanoil", "tanpack", "tanroads", "tanscarattorneys",
    "tanserve", "tansheq", "tantrade", "tanwat", "tanzania",
    "tanzania-tenders", "tanzaniabreweries", "tanzaniachoicesafaris", "tanzaniadestination", "tanzaniahotels",
]

# Fix tanicacafe: tender_url in README points to CSS file; use homepage or procurement-portal
URL_OVERRIDES = {
...
def load_readme(slug):
    ...
    if text.startswith("---"):
        ...
        if len(parts) >= 3:
            ...
            elif url and any(x in url.lower() for x in [".css", ".js", ".png", ".jpg"]):
                url = homepage.group(1).strip() if homepage else url
            return (
